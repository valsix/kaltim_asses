...
if($tempTipeUjianId == "7")
{
	...
	$statement.= " AND A.UJIAN_ID IN( SELECT A.UJIAN_ID FROM cat.UJIAN A INNER JOIN cat.UJIAN_TAHAP B ON A.UJIAN_ID = B.UJIAN_ID WHERE CAST(NOW() AS DATE) BETWEEN CAST(A.TGL_MULAI AS DATE) AND CAST(A.TGL_SELESAI AS DATE) GROUP BY A.UJIAN_ID)";
	...
	// echo $tempJumlahSoalPegawai;exit;
...
else
{
	...
	$sOrder= "ORDER BY URUT, A.UJIAN_ID, UP.BANK_SOAL_ID, UP.UJIAN_PEGAWAI_ID";
    ...
    $statementujian= " AND A.PEGAWAI_ID = ".$tempPegawaiId." AND A.UJIAN_ID = ".$tempUjianId." AND UP.UJIAN_TAHAP_ID = ".$reqId;
	$set= new UjianPegawaiDaftar();
	$set->selectByParamsSoalRevisi(array(), -1,-1, $statement, $statementujian, $sOrder);
	// echo $set->query;exit;
	$tempValueRowId= "";
	while($set->nextRow())
	{
...
$index_data=0;
$arrJumlahTahap="";
// $statement= " AND B.PEGAWAI_ID = ".$tempPegawaiId." AND NOW() BETWEEN A.TGL_MULAI AND A.TGL_SELESAI";
// $statement= " AND C.TIPE_UJIAN_ID = ".$reqId."AND B.PEGAWAI_ID = ".$tempPegawaiId." AND NOW() BETWEEN A.TGL_MULAI AND A.TGL_SELESAI";
// $statement.= " AND A.UJIAN_ID IN( SELECT A.UJIAN_ID FROM cat.UJIAN A INNER JOIN cat.UJIAN_TAHAP B ON A.UJIAN_ID = B.UJIAN_ID WHERE NOW() BETWEEN A.TGL_MULAI AND A.TGL_SELESAI GROUP BY A.UJIAN_ID)";

$statement= " AND B.PEGAWAI_ID = ".$tempPegawaiId." AND CAST(NOW() AS DATE) BETWEEN CAST(A.TGL_MULAI AS DATE) AND CAST(A.TGL_SELESAI AS DATE)";
$statement= " AND C.TIPE_UJIAN_ID = ".$reqId."AND B.PEGAWAI_ID = ".$tempPegawaiId." AND CAST(NOW() AS DATE) BETWEEN CAST(A.TGL_MULAI AS DATE) AND CAST(A.TGL_SELESAI AS DATE)";
$statement.= " AND A.UJIAN_ID IN( SELECT A.UJIAN_ID FROM cat.UJIAN A INNER JOIN cat.UJIAN_TAHAP B ON A.UJIAN_ID = B.UJIAN_ID WHERE CAST(NOW() AS DATE) BETWEEN CAST(A.TGL_MULAI AS DATE) AND CAST(A.TGL_SELESAI AS DATE) GROUP BY A.UJIAN_ID)";
...
$tempTipeTahapReset = $ujian_tahap->getField("TIPE_RESET");
...
// $statement= " AND C.UJIAN_TAHAP_ID = ".$reqId." AND B.PEGAWAI_ID = ".$tempPegawaiId." AND NOW() BETWEEN A.TGL_MULAI AND A.TGL_SELESAI";
// $statement.= " AND A.UJIAN_ID IN( SELECT A.UJIAN_ID FROM cat.UJIAN A INNER JOIN cat.UJIAN_TAHAP B ON A.UJIAN_ID = B.UJIAN_ID WHERE NOW() BETWEEN A.TGL_MULAI AND A.TGL_SELESAI GROUP BY A.UJIAN_ID)";

$statement= " AND C.UJIAN_TAHAP_ID = ".$reqId." AND B.PEGAWAI_ID = ".$tempPegawaiId." AND CAST(NOW() AS DATE) BETWEEN CAST(A.TGL_MULAI AS DATE) AND CAST(A.TGL_SELESAI AS DATE)";
$statement.= " AND A.UJIAN_ID IN( SELECT A.UJIAN_ID FROM cat.UJIAN A INNER JOIN cat.UJIAN_TAHAP B ON A.UJIAN_ID = B.UJIAN_ID WHERE CAST(NOW() AS DATE) BETWEEN CAST(A.TGL_MULAI AS DATE) AND CAST(A.TGL_SELESAI AS DATE) GROUP BY A.UJIAN_ID)";
