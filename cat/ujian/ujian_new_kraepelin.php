...
(
	...
	FROM cat_pegawai.UJIAN_KRAEPELIN_N_".$tempUjianPegawaiLowonganId."
...
<script type="text/javascript">
	...
	function settime(id)
	{
		...
		var counter = function () {
			...
			if(now >= end) {     
				...
				$.messager.alert('Info','Pindah lajur!',null,function(){
	...
	$(function(){
		$('#ff').form({
			url:'../json-ujian/ujian_new_kraepelin.php?reqUjianTahapId=<?=$reqUjianTahapId?>&reqTipeUjianId=<?=$reqTipeUjianId?>',
			onSubmit:function(){
				// console.log(totalmelakukanujian+" == <?=$batas_soal?>"); return false;
