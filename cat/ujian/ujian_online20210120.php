				...
				//{
					...
					else
					{
						...
						(
							...
							$tempTipeUjianId == 40 || $tempTipeUjianId == 41 || $tempTipeUjianId == 42 || $tempTipeUjianId == 45
						)
						{
						?>
                ...
                <div id="main-slider" class="liquid-slider">
					...
					?>
                    	<div id="<?=$tempNomor?>" class="area-soal-item">
                            ...
                            <?
							if($tempTipeSoal==1 || $tempTipeSoal==8 || $tempTipeSoal==9 || $tempTipeSoal==10 || $tempTipeSoal==66 || $tempTipeSoal==45)
							{
                            ?>
							...
							?>
                                ...
                                <?
								if($tempTipeSoal==1 || $tempTipeSoal==5 || $tempTipeUjianId == 39 || $tempTipeUjianId == 45)
								{
									if($tempJawaban == "")
									continue;
								?>
