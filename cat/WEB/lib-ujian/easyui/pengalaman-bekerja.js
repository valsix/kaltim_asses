function addPengalamanRow(index)
{
	...
	button.innerHTML = 'Pengalaman '+infoData+' <a style="cursor:pointer; float:right;" onclick="deleteRowDrawTable(\'dataTableRowPengalamanDinamis\', this, 13)">Hapus Pengalaman<img src="../WEB/images/hapus.png" width="15" height="15" border="0" /></a>'
	...
	cell = document.createElement("TD");
	var button = document.createElement('label');
	button.innerHTML = 'Nama Perusahaan&nbsp;<img src="../WEB/images/star.png" width="10" height="10">';
	cell.appendChild(button);
	row.appendChild(cell);
	...
	cell = document.createElement("TD");
	var button = document.createElement('label');
	button.innerHTML = 'Jenis perusahaan&nbsp;<img src="../WEB/images/star.png" width="10" height="10">';
	cell.appendChild(button);
	row.appendChild(cell);
	...
	cell = document.createElement("TD");
	var button = document.createElement('label');
	button.innerHTML = 'Jumlah Karyawan&nbsp;<img src="../WEB/images/star.png" width="10" height="10">';
	cell.appendChild(button);
	row.appendChild(cell);
	...
	cell = document.createElement("TD");
	var button = document.createElement('label');
	button.innerHTML = 'Periode bekerja&nbsp;<img src="../WEB/images/star.png" width="10" height="10">';
	cell.appendChild(button);
	row.appendChild(cell);
	...
	cell = document.createElement("TD");
	var button = document.createElement('label');
	button.innerHTML = 'Jabatan&nbsp;<img src="../WEB/images/star.png" width="10" height="10"><br/>Bidang Kerja';
	cell.appendChild(button);
	row.appendChild(cell);
	...
	cell = document.createElement("TD");
	var button = document.createElement('label');
	button.innerHTML = 'Gaji bersih perbulan (sudah termasuk seluruh tunjangan yang diterima)&nbsp;<img src="../WEB/images/star.png" width="10" height="10">'
