function addPengalamanKonfirmasiRow(index)
{
	...
	button.innerHTML = 'Pihak yang bisa dihubungi '+infoData+' <a style="cursor:pointer; float:right;" onclick="deleteRowDrawTable(\'dataTableRowPengalamanKonfirmasiDinamis\', this, 10)">Hapus Pihak yang bisa dihubungi <img src="../WEB/images/hapus.png" width="15" height="15" border="0" /></a>'
	...
	cell = document.createElement("TD");
	var button = document.createElement('label');
	button.innerHTML = 'Nama&nbsp;<img src="../WEB/images/star.png" width="10" height="10">';
	cell.appendChild(button);
	row.appendChild(cell);
	...
	cell = document.createElement("TD");
	var button = document.createElement('label');
	button.innerHTML = 'Institusi&nbsp;<img src="../WEB/images/star.png" width="10" height="10">';
	cell.appendChild(button);
	row.appendChild(cell);
	...
	cell = document.createElement("TD");
	var button = document.createElement('label');
	button.innerHTML = 'Alamat&nbsp;<img src="../WEB/images/star.png" width="10" height="10">';
	cell.appendChild(button);
	row.appendChild(cell);
	...
	cell = document.createElement("TD");
	var button = document.createElement('label');
	button.innerHTML = 'Jabatan&nbsp;<img src="../WEB/images/star.png" width="10" height="10">';
	cell.appendChild(button);
	row.appendChild(cell);
	...
	cell = document.createElement("TD");
	var button = document.createElement('label');
	button.innerHTML = 'Hubungan dengan Anda&nbsp;<img src="../WEB/images/star.png" width="10" height="10">';
	cell.appendChild(button);
	row.appendChild(cell);
	...
	cell = document.createElement("TD");
	var button = document.createElement('label');
	button.innerHTML = 'Nomor telpon / Hp yang bisa dihubungi&nbsp;<img src="../WEB/images/star.png" width="10" height="10">';
	cell.appendChild(button);
	row.appendChild(cell);
