function addOrganisasiRow(index)
{
	...
	button.innerHTML = 'Organisasi '+infoData+' <a style="cursor:pointer; float:right;" onclick="deleteRowDrawTable(\'dataTableRowPelatihanOrganisasiDinamis\', this, 7)">Hapus Pengalaman <img src="../WEB/images/hapus.png" width="15" height="15" border="0" /></a>'
	...
	cell = document.createElement("TD");
	var button = document.createElement('label');
	button.innerHTML = 'Nama organisasi&nbsp;<img src="../WEB/images/star.png" width="10" height="10">';
	cell.appendChild(button);
	row.appendChild(cell);
	...
	cell = document.createElement("TD");
	var button = document.createElement('label');
	button.innerHTML = 'Lokasi&nbsp;<img src="../WEB/images/star.png" width="10" height="10">';
	cell.appendChild(button);
	row.appendChild(cell);
	...
	cell = document.createElement("TD");
	var button = document.createElement('label');
	button.innerHTML = 'Bidang organisasi&nbsp;<img src="../WEB/images/star.png" width="10" height="10">';
	cell.appendChild(button);
	row.appendChild(cell);
	...
	cell = document.createElement("TD");
	var button = document.createElement('label');
	button.innerHTML = 'Tanggal sertifikat&nbsp;<img src="../WEB/images/star.png" width="10" height="10">';
	cell.appendChild(button);
	row.appendChild(cell);
