function addPengalamanSuksesRow(index)
{
	...
	button.innerHTML = 'Pengalaman Sukses Anda '+infoData+' <a style="cursor:pointer; float:right;" onclick="deleteRowDrawTable(\'dataTableRowPengalamanSuksesDinamis\', this, 6)">Hapus Pengalaman <img src="../WEB/images/hapus.png" width="15" height="15" border="0" /></a>'
	...
	cell = document.createElement("TD");
	var button = document.createElement('label');
	button.innerHTML = 'Situasi yang terjadi&nbsp;<img src="../WEB/images/star.png" width="10" height="10">';
	cell.appendChild(button);
	row.appendChild(cell);
	...
	cell.vAlign="top";
	var button = document.createElement('label');
	button.innerHTML = 'Tindakan yang anda lakukan&nbsp;<img src="../WEB/images/star.png" width="10" height="10">';
	cell.appendChild(button);
	row.appendChild(cell);
	...
	cell.vAlign="top";
	var button = document.createElement('label');
	button.innerHTML = 'Hasil tindakan Anda&nbsp;<img src="../WEB/images/star.png" width="10" height="10">';
	cell.appendChild(button);
	row.appendChild(cell);
