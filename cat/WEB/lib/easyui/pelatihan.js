...
function addPelatihanRow(index)
{
	...
	button.innerHTML = 'Pelatihan / Sertifikasi '+infoData+' <a style="cursor:pointer; float:right;" onclick="deleteRowDrawTable(\'dataTableRowPelatihanDinamis\', this, 6)">Hapus Pelatihan <img src="../WEB/images/hapus.png" width="15" height="15" border="0" /></a>'
	...
	cell = document.createElement("TD");
	var button = document.createElement('label');
	button.innerHTML = 'Nama pelatihan/sertifikasi&nbsp;<img src="../WEB/images/star.png" width="10" height="10">';
	cell.appendChild(button);
	row.appendChild(cell);
	...
	cell = document.createElement("TD");
	var button = document.createElement('label');
	button.innerHTML = 'Bidang pelatihan/sertifikasi&nbsp;<img src="../WEB/images/star.png" width="10" height="10">';
	cell.appendChild(button);
	row.appendChild(cell);
	...
	cell = document.createElement("TD");
	var button = document.createElement('label');
	button.innerHTML = 'Lembaga penyelenggaraan&nbsp;<img src="../WEB/images/star.png" width="10" height="10">';
	cell.appendChild(button);
	row.appendChild(cell);
