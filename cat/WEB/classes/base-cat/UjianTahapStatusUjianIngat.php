...
***************************************************************************************************** */
  ...
  ***/
  ...
  class UjianTahapStatusUjianIngat extends Entity{ 

	var $query;
    /**
    * Class constructor.
    **/
    function UjianTahapStatusUjianIngat()
	{
      $this->Entity(); 
    }
	...
	{
		$str = "SELECT COUNT(1) AS ROWCOUNT FROM cat.UJIAN_TAHAP_STATUS_UJIAN_INGAT A WHERE 1=1 ".$statement;
	...
	{
	   $str = "
	   INSERT INTO cat.ujian_tahap_status_ujian_ingat(
