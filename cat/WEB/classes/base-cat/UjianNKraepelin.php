...
***************************************************************************************************** */
  ...
  ***/
  ...
  class UjianNKraepelin extends Entity{ 

	var $query;
    /**
    * Class constructor.
    **/
    function UjianNKraepelin()
	{
      $this->Entity(); 
    }
	...
	{
		$str = "
		INSERT INTO cat_pegawai.UJIAN_KRAEPELIN_N_".$this->getField("JADWAL_TES_ID")." (
		...
		VALUES (
			...
			(SELECT PAKAI_KRAEPELIN_ID FROM cat.N_KRAEPELIN_PAKAI WHERE COALESCE(NULLIF(STATUS, ''), NULL) IS NULL),
	...
	{
		$str = "
		INSERT INTO cat_pegawai.UJIAN_KRAEPELIN_N_LATIHAN_".$this->getField("LOWONGAN_ID")." (
        UJIAN_PEGAWAI_DAFTAR_ID, JADWAL_TES_ID, FORMULA_ASSESMENT_ID, FORMULA_ESELON_ID, UJIAN_ID
        , UJIAN_TAHAP_ID, TIPE_UJIAN_ID, PEGAWAI_ID
		, PAKAI_KRAEPELIN_ID, X_DATA, Y_DATA, NILAI
		, LAST_CREATE_DATE, LAST_CREATE_USER
