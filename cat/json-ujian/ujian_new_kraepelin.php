...
// echo $reqUjianPegawaiDaftarId.":".$reqJadwalTesId.":".$reqFormulaAssesmentId.":".$reqFormulaEselonId.":".$reqUjianId.":".$reqPegawaiId.":".$reqUjianTahapId.":".$reqTipeUjianId.":";exit();

$reqXdata= $_POST["reqXdata"];
$reqYdata= $_POST["reqYdata"];
$reqXYdataNilai= $_POST["reqXYdataNilai"];

// print_r($reqXdata); exit();
// , UJIAN_KRAEPELIN_ID, 
