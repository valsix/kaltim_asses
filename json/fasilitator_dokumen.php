...
$reqId= $userLogin->userFasilitatorId;
...
$FILE_DIR= $urlfoto."/fasilitatordokumen/".$reqId."/";
makedirs($FILE_DIR);
// echo $urlfoto;exit();
...
$set->setField("FASILITATOR_ID", $reqId);
$set->setField("NAMA", $reqNama);
$set->setField("FASILITATOR_DOKUMEN_ID", $reqRowId);
