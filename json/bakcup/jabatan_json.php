...
$aColumns = array("JABATAN_ID", "KODE", "NAMA", "KETERANGAN", "CABANG_P3_NAMA");
$aColumnsAlias = array("JABATAN_ID", "KODE", "NAMA", "KETERANGAN", "CABANG_P3_NAMA");
...
if ( isset( $_GET['iSortCol_0'] ) )
{
	...
	if ( trim($sOrder) == "ORDER BY JABATAN_ID asc" )
	{
		...
		*/
		$sOrder = " ORDER BY JABATAN_ID ASC";
...
//$statement = " AND CABANG_P3_ID IS NULL ";
...
$allRecord = $jabatan->getCountByParamsMonitoring(array(), $statement);
if($_GET['sSearch'] == "")
	$allRecordFilter = $allRecord;
else	
	$allRecordFilter = $jabatan->getCountByParamsMonitoring(array(), $statement.$searchJson);

$jabatan->selectByParamsMonitoring(array(), $dsplyRange, $dsplyStart, $statement.$searchJson, $sOrder);
