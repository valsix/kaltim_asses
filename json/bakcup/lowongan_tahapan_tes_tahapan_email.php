...
for($i=0;$i<count($arrPelamarId);$i++)
{
	...
	if($pelamar_lowongan_tahapan->updateEmail())
	{
		...
		//$body = file_get_contents("http://".$_SERVER['SERVER_NAME']."/pds-rekrutmen/templates/undangan_tes_tahapan.php?reqLowonganTahapanId=".$reqLowonganTahapanId."&reqLowonganId=".$reqLowonganId."&reqPelamarId=".$arrPelamarId[$i]);
		$body = file_get_contents("http://".$_SERVER['SERVER_NAME'].$linktemplate."undangan_tes_tahapan.php?reqLowonganTahapanId=".$reqLowonganTahapanId."&reqLowonganId=".$reqLowonganId."&reqPelamarId=".$arrPelamarId[$i]);
