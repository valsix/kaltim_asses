...
<script type="text/javascript" language="javascript" class="init">
	...
	function reloadajaxclick()
	{
		...
		"ajax": {
			'type': 'POST',
			'url': "../json-pengaturan/jadwal_hasil_tes_asesor_json.php?reqId=<?=$reqId?>&reqTipeUjianId=<?=$reqTipeUjianId?>&reqPegawaiId=<?=$reqPegawaiId?>",
			'data': {
    ...
    <thead>
	    ...
	    <tr>
	        ...
	        for($i=4; $i < count($arrData); $i++)
	        {
	        	...
	        	if($i == 4)
	        	{
	        		$arrinfodetildata= array("Suka", "Tidak Suka");
	        	}
	        	elseif($i == 5 || $i == 6)
	        	{
	        		$arrinfodetildata= array("Ya", "Tidak");
	        	}
	        ?>
	        <th style="text-align:center"><?=$arrinfodetildata[0]?></th>
	        <th style="text-align:center"><?=$arrinfodetildata[1]?></th>
	        <?
	        }
	        ?>
	    </tr>
