...
{
	$reqMode= "update";
	$set->selectByParams(array("PERATURAN_ID"=> $reqId),-1,-1,'');
	$set->firstRow();
...
<script type="text/javascript">	
	...
	$(function(){
		...
		$('#ff').form({
			url:'../json-pengaturan/master_peraturan_add.php',
			onSubmit:function(){
...
<div id="content" style="height:auto; margin-top:-4px; width:100%">
    	...
    	<table class="table_list" cellspacing="1" width="100%">
            <tr>
                <td colspan="6">
                <div id="header-tna-detil">Tambah <span>Peraturan</span></div>	                    
                </td>			
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>:</td>
                <td>
                    <input type="text" name="reqKeterangan" style="width:350px" value="<?=$tempKeterangan?>"/>
                </td>
            </tr>	
        	<tr>
                <td>
