...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
        ...
        var oTable = $('#example').dataTable({ "iDisplayLength": 100,bJQueryUI: true,
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",					  
		"sAjaxSource": "../json-pengaturan/tipe_soal_json.php",
		...
		/* Click event handler */
		  ...
		  $('#btnTambah,#btnUbahData').on('click', function () {
			  ...
			  opUrl= 'tipe_soal_add.php?reqId='+anSelectedRowId;
			  ...
			  if(anSelectedData == "")
				...
				$.messager.confirm('Confirm','Apakah anda yakin ingin menghapus data terpilih ?',function(r){
					if (r){
						...
						var jqxhr = $.get( "../json-pengaturan/delete.php?reqMode=tipe_soal&id="+anSelectedRowId, function() {
						...
						.done(function() {
							...
							oTable.fnReloadAjax("../json-pengaturan/tipe_soal_json.php");
						})
						.fail(function() {
							alert( "error" );
							$.messager.progress('close');
        ...
        oTable.fnReloadAjax("../json-pengaturan/tipe_soal_json.php?reqTipeSoal="+reqTipeSoal+"&reqTipeUjian="+reqTipeUjian);
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <div id="header-tna">Tipe <span>Soal</span></div>
