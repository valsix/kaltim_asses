...
$index_loop=0;
$statement= " AND A.JADWAL_TES_ID = ".$reqId;
// $statement.= " AND JP.PEGAWAI_ID = 418";
    ...
    <table class="gradient-style" id="link-table" style="width:100%; margin-left:-1px">
       ...
       <tbody class="example altrowstable" id="alternatecolor"> 
		...
		<tr>
            ...
            <!-- <td><?=$reqPegawaiAsesor."-".$reqPegawaiId?></td> -->
            <?
		...
		{
            if($reqPegawaiAsesor!=$cekpegawai){
		?>
		<tr>
            <!-- <th colspan="<?=$colspanpenggalian?>"><?=$reqPegawaiNoUrut.". ".$reqPegawaiNama."-".$reqPegawaiId?></th> -->
            <!-- <th colspan="<?=$colspanpenggalian?>"><?=$reqPegawaiNoUrut.". ".$reqPegawaiAsesor?></th> -->
            <th colspan="<?=$colspanpenggalian?>"><b><?=$reqPegawaiAsesor?></b></th>
        </tr>
        <?
            $cekpegawai=$reqPegawaiAsesor;
        }?>
		<tr>
            <!-- <td><?=$reqPegawaiAsesor?></td> -->
