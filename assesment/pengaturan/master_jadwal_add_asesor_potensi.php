...
<script type="text/javascript">	
	$(function(){
		$('#ff').form({
			url:'../json-pengaturan/master_jadwal_add_asesor_potensi.php',
			onSubmit:function(){
			...
			success:function(data){
				...
				parent.frames['mainFrame'].location.href = 'master_jadwal_add_asesor_potensi_monitoring.php?reqId=<?=$reqId?>';
				parent.frames['mainFrameDetil'].location.href = 'master_jadwal_add_asesor_potensi.php?reqId=<?=$reqId?>&reqRowId=<?=$reqRowId?>';
			}
		});
	...
	function addAsesorRow()
	{
		...
		cell = document.createElement("TD");
		var button = document.createElement('label');
		button.innerHTML = '<input type="hidden" name="reqJadwalAsesorPotensiId[]" id="reqJadwalAsesorPotensiId'+rownum+'" />'
...
<div id="content" style="height:auto; width:100%">
    ...
    <tr>
        ...
        <th scope="col" style="text-align:center; width:20%; display:none">Kelompok & Ruangan</th>
        <th scope="col" style="text-align:center; width:50%">Keterangan</th>
    ...
    <tr>
        ...
        <td>
        	<center><a style="cursor:pointer" onclick="deleteRowDrawTablePhp('tableAsesor', this, '<?=$checkbox_index?>', 'reqJadwalAsesorPotensiId', 'jadwal_asesor_potensi')"><img src="../WEB/images/delete-icon.png" width="15" height="15" border="0" /></a></center>
