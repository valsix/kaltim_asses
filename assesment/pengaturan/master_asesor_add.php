...
{
	$reqMode= "update";
	$set->selectByParams(array("ASESOR_ID"=> $reqId),-1,-1,'');
	$set->firstRow();
...
<script type="text/javascript">	
	...
	$(function(){
		...
		$('#ff').form({
			url:'../json-pengaturan/master_asesor_add.php',
			onSubmit:function(){
			...
			success:function(data){
				...
				{
				?>
					document.location.href= "master_asesor_add.php";
				<?
				}
				?>
			}
...
<div id="content" style="height:auto; margin-top:-4px; width:100%">
    	...
    	<table class="table_list" cellspacing="1" width="100%">
            <tr>
                <td colspan="6">
                <div id="header-tna-detil">Tambah <span>Asesor</span></div>	                    
                </td>			
            </tr>
            <tr>
                ...
                <td>        
                    <select name="reqTipe" id="reqTipe">
                    	<option value="1" <? if($tempTipe == "1") echo "selected"?>>Internal</option>
                        <option value="2" <? if($tempTipe == "2") echo "selected"?>>Eksternal</option>
                    </select>
               </td>
            </tr>
            <tr>
