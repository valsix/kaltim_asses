...
<script type="text/javascript">	
	...
	$(function(){
		$('#ff').form({
			url:'../json-pengaturan/formula_assesment_add_data.php',
			onSubmit:function(){
			...
			success:function(data){
				...
				parent.frames['menuFrame'].location.href = 'formula_assesment_add_menu.php?reqId='+reqId;
				document.location.href = 'formula_assesment_add_data.php?reqId='+reqId;
			}
		});
				...
				<tr>           
					...
					<td>
						<select name = "reqTipeFormula" >
							...
							<option value="3" <? if($tempTipeFormula == '3') echo 'selected';?>>Uji Coba</option>
						</select>
					</td>
		        </tr>
				<tr>
