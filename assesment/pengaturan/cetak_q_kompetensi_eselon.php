...
$statement= " AND A.TIPE_FORMULIR_ID =3";
...
$statement= " AND C.PEGAWAI_ID = ".$reqPegawaiId." AND C.TIPE_FORMULIR_ID = 3";
...
<body>
	<div class="container">
		...
		<p style="font-size: 14pt" align="center"><strong>Q Kompetensi (Eselon) Peserta</strong></p> 
