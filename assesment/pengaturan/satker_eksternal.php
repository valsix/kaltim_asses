...
if($reqMode == "delete")
{
    $satker->setField("SATKER_EKSTERNAL_ID", $reqId);
    if($satker->deleteeksternal())
    {
...
<script type="text/javascript">
    function reloadMe()
    {
        $('#tt').treegrid({url:'../json-pengaturan/satker.php?reqTipe=eksternal&reqSatkerId='+$('#reqSatkerId').val()});
    }
    
    $(function(){
        $('#reqSatkerId').bind('change', function(ev) {
            reloadMe();
        }); 
    });
...
<body style="margin:0; width:100%; margin-left:-20px; margin-top:-20px; background-color:#FFF !important">
    ...
    <table id="tt" title="Satuan Kerja Eksternal" class="easyui-treegrid" style="width:100%;height:600px"
        data-options="
        url: '../json-pengaturan/satker.php?reqTipe=eksternal',
        rownumbers: false,
        pagination: true,
        pageList: [100, 150],
        idField: 'ID',
        ...
        <thead>
            <tr>
                ...
                Nama
                <a onClick="window.OpenDHTMLPopUp('satker_eksternal_add.php?reqSatkerParentId=0')"><img src="../WEB/images/icn_add.png"></a>
                </th>
