...
{
	$reqMode= "update";
	$set->selectByParams(array("KELOMPOK_ID"=> $reqId),-1,-1,'');
	$set->firstRow();
...
<script type="text/javascript">	
	...
	$(function(){
		...
		$('#ff').form({
			url:'../json-pengaturan/master_kelompok_add.php',
			onSubmit:function(){
			...
			success:function(data){
				...
				{
				?>
					document.location.href= "master_kelompok_add.php";
				<?
				}
				?>
			}
...
<div id="content" style="height:auto; margin-top:-4px; width:100%">
    	...
    	<table class="table_list" cellspacing="1" width="100%">
            <tr>
                <td colspan="6">
                <div id="header-tna-detil">Tambah <span>Kelompok</span></div>	                    
                </td>			
            </tr>
            <tr>
