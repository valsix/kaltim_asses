...
<script type="text/javascript">
	var urlAjax= "../json-pengaturan/jadwal_hasil_tes_grafik_big_five_json.php?reqId=<?=$reqId?>&reqTipeUjianId=<?=$reqTipeUjianId?>&reqPegawaiId=<?=$reqPegawaiId?>";
	// var request = $.get(s_url);
	
	judul= "Hasil Big Five";
