...
$set_detil= new JadwalAwalTesPegawai();
...
<script type="text/javascript">	
	$(function(){
		$('#ff').form({
			url:'../json-pengaturan/jadwal_awal_tes_add_undangan_pegawai.php',
			onSubmit:function(){
			...
			success:function(data){
				...
				else
				{
					...
					document.location.href = 'jadwal_awal_tes_add_undangan_pegawai.php?reqId=<?=$reqId?>&reqRowId=<?=$reqRowId?>';
				}
			}
		});
	});
