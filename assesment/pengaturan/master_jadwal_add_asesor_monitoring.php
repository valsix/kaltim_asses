...
<body class="bg-form" style="overflow-x:scroll;">
	<div id="header-tna-detil">Jadwal Acara <span>Asesor</span></div>
    <div id="konten">
    <table class="gradient-style" id="link-table" style="width:100%; margin-left:-1px">
        <thead class="altrowstable">
            <tr>
              ...
              <?php /*?><th style="width:200px">Kelompok & Ruangan</th><?php */?>
              <th>Keterangan</th>
            </tr>
       </thead>
       <tbody class="example altrowstable" id="alternatecolor"> 
		...
		?>
        <tr>
        	<td><a href="master_jadwal_add_asesor.php?reqRowId=<?=$tempRowId?>&reqId=<?=$reqId?>&reqMode=view">link data</a></td>
            <td><?=$tempPenggalianNama?></td>
            <td><?=$tempJam?></td>
            <?php /*?><td><?=$tempJadwalKelompokRuangData?></td><?php */?>
