...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",					  
		"sAjaxSource": "../json-silat/pegawai_pencarian_json.php",
		...
		/* Click event handler */
		  ...
		  $('#btnUbahData').on('click', function () {
				if(anSelectedData == "")
					  return false;			  
			 	window.parent.OptionSetPegawai(anSelectedId);
		  ...
		  $("#reqPencarian").keyup(function(e) { 
			...
			if(code==13)
			{
				  ...
				  oTable.fnReloadAjax("../json-silat/pegawai_pencarian_json.php?reqStatusPeg="+reqStatusPeg+ "&reqId=<?=$reqId?>&reqSearch="+reqPencarian);
			}
		  });
