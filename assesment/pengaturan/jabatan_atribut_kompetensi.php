...
<script type="text/javascript">
	function reloadMe()
	{
		$('#tt').treegrid({url:'../json-pengaturan/jabatan_atribut_tree.php?reqAspekId=2&reqTahun='+$("#reqTahun").val()});  
	}
...
<div style="width:100%;">
    <div id="header-tna">
    Master <span>Jabatan Atribut Kompetensi</span>
    Tahun 
    <select id="reqTahun">
    ...
    <table id="tt" title="Jabatan Atribut" class="easyui-treegrid" style="width:100%;height:600px"
        data-options="
        url: '../json-pengaturan/jabatan_atribut_tree.php?reqAspekId=2',
        rownumbers: false,
        pagination: true,
        pageSize: 2,
        pageList: [5,10,20],
