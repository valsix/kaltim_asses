...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",					  
		"sAjaxSource": "../json-pengaturan/pegawai_jadwal_pencarian_json.php?reqId=<?=$reqId?>&reqPegawaiId="+reqPegawaiId,
			  ...
			  if($("#reqCheckAll").prop('checked')) 
			  {
					$.messager.confirm('Konfirmasi', "Apakah Anda Yakin, pilih semua data yg tampil ?",function(r){
						if (r){
							...
							arrChecked= ""
							arrChecked= [];
							oTable.fnReloadAjax("../json-pengaturan/pegawai_jadwal_pencarian_json.php?reqId=<?=$reqId?>&reqPegawaiId="+reqPegawaiId+"&reqCari="+reqPencarian);
						}
					});
			  }
			  else
