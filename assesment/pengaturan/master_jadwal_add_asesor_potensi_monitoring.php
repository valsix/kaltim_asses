...
<body class="bg-form" style="overflow-x:scroll;">
	<div id="header-tna-detil">Jadwal <span>Potensi</span></div>
    <div id="konten">
    <table class="gradient-style" id="link-table" style="width:100%; margin-left:-1px">
        <thead class="altrowstable">
            <tr>
              ...
              <th style="width:200px; display:none">Kelompok & Ruangan</th>
              <th>Keterangan</th>
            </tr>
       </thead>
       <tbody class="example altrowstable" id="alternatecolor"> 
		...
		while($set->nextRow())
		{
			...
			$tempJadwalKelompokRuangData= $set->getField("JADWAL_KELOMPOK_RUANG_DATA");
			
		?>
        <tr>
        	<td><a href="master_jadwal_add_asesor_potensi.php?reqRowId=<?=$tempRowId?>&reqId=<?=$reqId?>&reqMode=view">link data</a></td>
            <td><?=$tempJam?></td>
            <td style="display:none"><?=$tempJadwalKelompokRuangData?></td>
