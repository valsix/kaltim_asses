...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",					  
		"sAjaxSource": "../json-pengaturan/integrasi_json.php?",
		...
		/* Click event handler */
		  ...
		  $('#example tbody').on( 'dblclick', 'tr', function () {
			  ...
			  opWidth= 400;
			  opHeight= 100;
			  opUrl= 'master_integrasi_view.php?reqId='+anSelectedRowId;
			  window.top.OpenDHTML(opUrl, "Master Riwayat "+tempNama, '880', '495');
		  });
		  ...
		  $('#btnTambah,#btnUbahData').on('click', function () {
			  ...
			  opUrl= 'user_app_add.php?reqId='+anSelectedRowId;
		  ...
		  $('#btnResetPassword').on('click', function () {
			  ...
			  opWidth= 400;
			  opHeight= 100;
			  opUrl= 'user_app_reset.php?reqId='+anSelectedRowId;
			  window.top.OpenDHTML(opUrl, "Master Data", '880', '495');
			  //window.location.href = opUrl;
		  });
		  
		  $('#btnIntegrasiSkp').on('click', function () {
		  	$.messager.confirm('Confirm','Apakah anda yakin ingin Mengintegrasikan data SKP ?',function(r){
				if (r){
					...
					var jqxhr = $.get( "../json-pengaturan/integrasi_input_json.php?reqMode=skp", function() {
						$.messager.progress('close');
					})
					.done(function() {
						$.messager.progress('close');
						
						alert( "Data Berhasil Diintegrasikan" );
		  ...
		  $('#btnIntegrasiPenghargaan').on('click', function () {
		  	$.messager.confirm('Confirm','Apakah anda yakin ingin Mengintegrasikan data Penghargaan ?',function(r){
				if (r){
					...
					var jqxhr = $.get( "../json-pengaturan/integrasi_input_json.php?reqMode=penghargaan", function() {
						$.messager.progress('close');
					})
					.done(function() {
						$.messager.progress('close');						
						// oTable.fnReloadAjax("../json-pengaturan/user_app_json.php");
						alert( "Data Berhasil Diintegrasikan" );
					})
					.fail(function() {
						alert( "error" );
		  ...
		  $("#reqTrainingId,#reqTahun").change(function() { 
			...
			oTable.fnReloadAjax("../json-pengaturan/user_app_json.php?reqTrainingId="+reqTrainingId+"&reqTahun="+reqTahun);
		  });
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <div id="header-tna">Master <span>Riwayat</span></div>
    <div id="bluemenu" class="bluetabs" style="background:url(css/media/bluetab.gif)">    
    <ul>
          <li>
          	<li><a href="#" id="btnIntegrasiSkp" title="Integrasi SKP"><img src="../WEB/images/pegawai-edit.png"/>Integrasi SKP</a></li>
            <li><a href="#" id="btnIntegrasiPenghargaan" title="Integrasi Penghargaan"><img src="../WEB/images/pegawai-edit.png"/>&nbsp;Integrasi Penghargaan</a></li>
          </li>
    </ul>
    </div>
