...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",					  
		"sAjaxSource": "../json-pengaturan/satuan_kerja_pencarian_json.php",
		...
		/* Click event handler */
		  ...
		  $('#btnUbahData').on('click', function () {
				if(anSelectedData == "")
					  return false;			  
			 	window.parent.OptionSetSatkerTambahan(anSelectedId);
				...
				$.messager.confirm('Confirm','Apakah anda yakin ingin menghapus data terpilih ?',function(r){
					if (r){
						...
						.done(function() {
							...
							oTable.fnReloadAjax("../json-pengaturan/satuan_kerja_pencarian_json.php");
						})
						.fail(function() {
							alert( "error" );
							$.messager.progress('close');
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <div id="header-tna"><span>Satuan Kerja</span></div>
