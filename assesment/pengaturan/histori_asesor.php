...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",					  
		"sAjaxSource": "../json-pengaturan/histori_asesor_json.php",
		...
		/* Click event handler */
		  ...
		  $('#btnTambah,#btnUbahData').on('click', function () {
			  ...
			  opUrl= 'histori_asesor_add.php?reqId='+anSelectedRowId;
			  //newWindow = window.open(opUrl, "", 'fullscreen=yes, scrollbars=auto');
			  //newWindow.focus();
			  //window.top.OpenDHTMLDetil(opUrl, "Master Peraturan", '980', '425');
			  window.top.OpenDHTMLDetil(opUrl, "Master Peraturan", '980', '625');
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <div id="header-tna">Histori <span>Asesor</span></div>
    <div id="bluemenu" class="bluetabs" style="background:url(css/media/bluetab.gif)">    
    <ul>
          <li>
          	<li><a href="#" title="Lihat data" id="btnUbahData"><img src="../WEB/images/pegawai-edit.png"/>&nbsp;Lihat Data</a></li>
          </li>
    </ul>
    </div>
