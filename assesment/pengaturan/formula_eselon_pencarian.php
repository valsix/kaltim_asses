...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",					  
		"sAjaxSource": "../json-pengaturan/formula_eselon_pencarian_json.php?reqId=<?=$reqId?>",
		...
		/* Click event handler */
		  ...
		  $('#btnTambah,#btnUbahData').on('click', function () {
			  ...
			  else
			  {
				  ...
				  window.parent.OptionMainSet(anSelectedId);
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <div id="header-tna">Pencarian <span>Formula</span></div>
    ...
    <thead>
        <tr>
            ...
            <th width="50px">Formula Eselon</th>
        </tr>
    </thead>
    </table>
