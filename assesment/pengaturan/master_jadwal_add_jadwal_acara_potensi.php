...
$reqRowId= $set->getField("PUKUL_AWAL");

if($tempSimulasiNama == "")
$tempSimulasiNama= "Potensi";
...
<script type="text/javascript">	
	function setLoad()
	{
		document.location.href= 'master_jadwal_add_jadwal_acara_potensi.php?reqId=<?=$reqId?>&reqJenisId=<?=$reqJenisId?>';
	}
	...
	$(function(){
		...
		$('#ff').form({
			url:'../json-pengaturan/master_jadwal_add_jadwal_acara_potensi.php',
			onSubmit:function(){
				...
				if(reqKelompokJumlah > reqJumlahRuangan)
				{
			...
			success:function(data){
				...
				parent.frames['mainFrame'].location.href = 'master_jadwal_add_jadwal_acara_potensi_monitoring.php?reqId=<?=$reqId?>&reqJenisId=<?=$reqJenisId?>';
				parent.frames['mainFrameDetil'].location.href = 'master_jadwal_add_jadwal_acara_potensi.php?reqId=<?=$reqId?>&reqJenisId=<?=$reqJenisId?>&reqRowId=<?=$reqRowId?>';
			}
		});
...
<div id="content" style="height:auto; width:100%">
    ...
    <table class="table_list" cellspacing="1" width="100%">
        <tr>           
            ...
            <td>
                ...
                <input type="hidden" id="reqPenggalianId" name="reqPenggalianId" value="0" />
                <?php /*?><input type="text" name="reqJadwalNama" id="reqJadwalNama" class="easyui-validatebox" style="width:60%" value="<?=$tempSimulasiNama?>" /><?php */?>
                <input type="hidden" name="reqJadwalNama" id="reqJadwalNama" value="<?=$tempSimulasiNama?>" />
                <input type="text" disabled="disabled" class="easyui-validatebox" style="width:60%" value="<?=$tempSimulasiNama?>" />
            </td>
        </tr>
        <tr>
            <td>Waktu</td><td>:</td>
        ...
        <tr>
            <td>
                ...
                <?php /*?><input type="button" onclick="setLoad()" value="Baru" /><?php */?>
                <?
				}
                ?>
            </td>
    ...
    <tr>
		...
		{
		?>
        <a style="cursor:pointer" id="reqAddAsesor" title="Tambah" onclick="addAsesorRow()"><img src="../WEB/images/icn_add.gif" width="16" height="16" border="0" /></a>
        <?
		}
        ?>
        </th>
