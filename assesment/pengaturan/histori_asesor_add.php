...
<body leftmargin="0" rightmargin="0" topmargin="0" bottommargin="0">
	<div id="kontainer-atas" class="kontainer-atasBagi">
        <iframe class="mainframe" id="idMainFrame" name="mainFramePop" src="histori_asesor_add_monitoring.php?reqId=<?=$reqId?>" style="width:100%; height:calc(100% - 5px); border:none;"></iframe>
    </div>
    
    <div id="trdetil">
        <button id="atasbawah">Show/Hide</button>
        <iframe class="mainframe" id="idMainFrameDetil" name="mainFrameDetilPop" src="histori_asesor_add_detil.php" style="width:100%; height: 100%;  border:none;"></iframe>
    </div>
</body>
</html>
