...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",					  
		"sAjaxSource": "../json-pengaturan/jadwal_awal_tes_json.php",
		...
		/* Click event handler */
		  ...
		  $('#btnTambah,#btnUbahData').on('click', function () {
			  ...
			  opUrl= 'jadwal_awal_tes_add.php?reqId='+anSelectedRowId;
			  ...
			  if(anSelectedData == "")
				...
				$.messager.confirm('Confirm','Apakah anda yakin ingin menghapus data terpilih ?',function(r){
					if (r){
						...
						var jqxhr = $.get( "../json-pengaturan/delete.php?reqMode=jadwal_awal_tes&id="+anSelectedRowId, function() {
		  ...
		  $("#btnCari").on("click", function () {
		  	var reqTahun= reqKdOrganisasiId= reqKdSatuanOrganisasiId= reqEselonId= reqTipeId= "";
		  	
		  	reqTahun= $("#reqTahun").val();
		  	
		  	// if(reqTahun == "")
		  	// {
				// $.messager.alert('Info', 'Isikan Tahun terlebih dahulu', 'info');
				// return false;
		  	// }

		  	// $.messager.confirm('Confirm','Apakah anda ingin melihat data sesuai filter ?',function(r){
		  		// if (r){
		  			// var win = $.messager.progress({title:'Proses', msg:'Proses data...'});
		  			// $.messager.progress('close');

		  			oTable.fnReloadAjax("../json-pengaturan/jadwal_awal_tes_json.php");
		  		// }
			// });	
		  });
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <div id="header-tna">Setting <span></span></div>
    <div id="bluemenu" class="bluetabs" style="background:url(css/media/bluetab.gif)">    
    <ul>
    	<li><a href="#" style="display: none;" id="btnCari" title="Cari"><img src="../WEB/images/pegawai-edit.png"/>&nbsp;Cari</a></li>
