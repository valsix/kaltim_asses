...
<script type="text/javascript">	
	...
	function addAsesorRow()
	{
		...
		+'<input type="text" class="easyui-validatebox" style="width:98%" id="reqAsesor'+rownum+'" data-options="validType:[\'sameAutoLoder[\'reqAsesor'+rownum+'\', \'\']\']" />';
...
<div id="content" style="height:auto; width:100%">
    ...
    <tr>
        ...
        <th scope="col" style="text-align:center; width:60%">Keterangan</th>
    ...
    <tr>
        <td>
            ...
            <input type="text" class="easyui-validatebox" style="width:98%" id="reqAsesor<?=$checkbox_index?>" 
            data-options="validType:['sameAutoLoder[\'reqAsesor\', \'\']']"
            value="<?=$tempAsesor?>" />
        </td>
        <td>
