...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",					  
		// "sAjaxSource": "../json-pengaturan/pegawai_jadwal_pencarian_json.php?reqId=<?=$reqId?>&reqJadwalTesId=<?=$reqJadwalTesId?>&reqPegawaiId="+reqPegawaiId,
		"sAjaxSource": "../json-pengaturan/pegawai_jadwal_pencarian_json.php?reqId=<?=$reqId?>&reqPegawaiId=<?=$reqRowId?>&reqJadwalTesId=<?=$reqJadwalTesId?>&reqPenggalianId="+reqPegawaiId,
			  ...
			  if($("#reqCheckAll").prop('checked')) 
			  {
					$.messager.confirm('Konfirmasi', "Apakah Anda Yakin, pilih semua data yg tampil ?",function(r){
						if (r){
							...
							var data= "";
							data= getChecked();
							window.parent.OptionSetPegawaiDetil(data, reqRowId);
							...
							arrChecked= ""
							arrChecked= [];
							oTable.fnReloadAjax("../json-pengaturan/pegawai_jadwal_pencarian_json.php?reqId=<?=$reqId?>&reqJadwalTesId=<?=$reqJadwalTesId?>&reqPegawaiId="+reqPegawaiId+"&reqCari="+reqPencarian);
						}
					});
			  }
			  else
