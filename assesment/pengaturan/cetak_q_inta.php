...
$reqJenjangJabatan= $CetakanDataPdf->getField("Jenjang_jabatan");
...
$statement= " AND A.TIPE_FORMULIR_ID = 2";
...
$statement= " AND C.PEGAWAI_ID = ".$reqPegawaiId." AND C.TIPE_FORMULIR_ID = 2";
...
<body>
	<div class="container">
		...
		<p style="font-size: 14pt" align="center"><strong>Q Inta Peserta</strong></p> 
