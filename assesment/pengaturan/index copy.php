                    	...
                    	<tr>
                            ...
                            <td>
								...
								<ul id="master-soal" class="flexdropdownmenu" style="background-color:#385f0e;">
                                	...
                                	<li><a href="monitoring.php?reqMode=bank_soal" target="mainFullFrame" onClick="menuHandler('validator')">Bank Soal</a></li>
                                </ul>
                                ...
                                <ul id="master-penilaian" class="flexdropdownmenu" style="background-color:#385f0e;">
                                    ...
                                    <li><a href="monitoring.php?reqMode=jadwal_absen" target="mainFullFrame" onClick="menuHandler('validator')">Jadwal Absen</a></li>
                                    <!-- kemendagri reload -->
                                	...
                                	<?php /*?><li><a href="monitoring.php?reqMode=kelompok" target="mainFullFrame" onClick="menuHandler('validator')">Master Kelompok</a></li>
                                    <li><a href="monitoring.php?reqMode=ruangan" target="mainFullFrame" onClick="menuHandler('validator')">Master Ruangan</a></li><?php */?>
                                	<?php /*?><li><a href="monitoring.php?reqMode=penilaian" target="mainFullFrame" onClick="menuHandler('validator')">Master Penilaian</a></li><?php */?>
                                	<?php /*?><li><a href="monitoring.php?reqMode=jadwal_acara" target="mainFullFrame" onClick="menuHandler('validator')">Master Jadwal Acara</a></li>
                                    <li><a href="monitoring.php?reqMode=jadwal" target="mainFullFrame" onClick="menuHandler('validator')">Master Jadwal</a></li><?php */?>
                                </ul>
    ...
    <tr>
   	...
   	<tr id="shortcut"> 
    	<td colspan="5" valign="middle" style=" background:#3379b7;" height="30">
        	<center>
			<span style="font-size:11px; color:#FFF; text-shadow:1px 1px 1px #286f71;">Copyright &copy; 2020 Pemerintah Provinsi Bali. All Rights Reserved.</span>
            </center>
		</td>
  	</tr>    
</table>
