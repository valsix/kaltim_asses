...
<div id="content" style="height:auto; width:100%">
    ...
    <tr>
        <td>
            <input type="hidden" name="reqPegawaiSatkerTesId[]" id="reqPegawaiId<?=$checkbox_index?>" value="<?=$tempPegawaiSatkerTesId?>" />
            <input type="hidden" name="reqPegawaiTanggalTesId[]" id="reqPegawaiId<?=$checkbox_index?>" value="<?=$tempPegawaiTanggalTes?>" />
