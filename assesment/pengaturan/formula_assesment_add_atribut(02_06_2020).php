...
<div id="bg"><img src="../WEB/images/wall-kanan-polos.png" width="100%" height="100%" alt=""></div>
    ...
    <tr>
        ...
        <th style="width:7%">Nilai standart</th>
    ...
    ?>
        <tr>
            ...
            <td>
                <input type="text" name="reqAtributBobot[]" id="reqAtributBobot<?=$checkbox_index?>" class="easyui-validatebox" 
                style="width:50px" value="<?=$tempAtributBobot?>" />
            </td>
            <td>
                <input type="text" name="reqAtributSkor[]" id="reqAtributSkor<?=$checkbox_index?>" class="easyui-validatebox" 
