...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",					  
		"sAjaxSource": "../json-pengaturan/master_jadwal_acara_json.php",
		"sPaginationType": "full_numbers"
		  ...
		  $('#btnTambah,#btnUbahData').on('click', function () {
			  ...
			  opUrl= 'master_jadwal_acara_add.php?reqId='+anSelectedRowId;
			  //newWindow = window.open(opUrl, "", 'fullscreen=yes, scrollbars=auto');
			  //newWindow.focus();
			  window.top.OpenDHTML(opUrl, "Master Jadwal", '880', '495');
			  ...
			  if(anSelectedData == "")
				...
				$.messager.confirm('Confirm','Apakah anda yakin ingin menghapus data terpilih ?',function(r){
					if (r){
						...
						var jqxhr = $.get( "../json-pengaturan/delete.php?reqMode=master_jadwal_acara&id="+anSelectedRowId, function() {
						...
						.done(function() {
							...
							oTable.fnReloadAjax("../json-pengaturan/master_jadwal_acara_json.php");
						})
						.fail(function() {
							alert( "error" );
							$.messager.progress('close');
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <thead>
        <tr>
            <th width="1px">id</th>
            <th width="200px">Jadwal Tes</th>            
            <th width="200px">Penggalian</th>
            <th width="100px">Pukul 1</th>
            <th width="100px">Pukul 2</th>
            <th>Keterangan</th>
        </tr>
    </thead>
    </table>
