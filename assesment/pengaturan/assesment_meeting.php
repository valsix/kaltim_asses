...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",					  
		"sAjaxSource": "../json-pengaturan/assesment_meeting_json.php",
		...
		/* Click event handler */
		  ...
		  $('#btnTambah,#btnUbahData').on('click', function () {
			  ...
			  opWidth = 1050;
			  opHeight = 550;
			  opUrl= "assesment_meeting_add.php?reqJadwalTesId="+anSelectedRowId+"&reqPegawaiId="+anSelectedRowDetilId;
			  ...
			  if(anSelectedData == "")
				...
				$.messager.confirm('Confirm','Apakah anda yakin ingin menghapus data terpilih ?',function(r){
					if (r){
						...
						var jqxhr = $.get( "../json-pengaturan/delete.php?reqMode=assesment_meeting&id="+anSelectedRowId, function() {
						...
						.done(function() {
							...
							oTable.fnReloadAjax("../json-pengaturan/assesment_meeting_json.php");
						})
						.fail(function() {
							alert( "error" );
							$.messager.progress('close');
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <div id="header-tna">Assesment <span>Meeting</span></div>
    <div id="bluemenu" class="bluetabs" style="background:url(css/media/bluetab.gif)">    
    <ul>
          <li>
          	<li><a href="#" title="Lihat Meeting" id="btnUbahData"><img src="../WEB/images/pegawai-edit.png"/>&nbsp;Lihat Meeting</a></li>
          </li>
    </ul>
    </div>
