...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",					  
		"sAjaxSource": "../json-pengaturan/user_app_json.php?reqTahun=<?=$reqTahun?>",
			  ...
			  if(anSelectedData == "")
				...
				$.messager.confirm('Confirm','Apakah anda yakin ingin menghapus data terpilih ?',function(r){
					if (r){
						...
						var jqxhr = $.get( "../json-pengaturan/delete.php?reqMode=user_app&id="+anSelectedRowId, function() {
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <div id="header-tna">Master <span>User</span></div>
    ...
    <ul>
          <li>
            ...
            <li><a href="#" id="btnResetPassword" title="Reset Password"><img src="../WEB/images/pegawai-edit.png"/> Reset Password</a></li>
          </li>
    </ul>
    </div>
    ...
    <thead>
        <tr>
            ...
            <th width="150px">Asesor</th>
            <th width="150px">Group User</th>
            <th width="150px">Satuan Kerja</th>
        </tr>
    </thead>
    </table>
