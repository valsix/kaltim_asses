...
<body class="bg-form" style="overflow-x:scroll;">
	<div id="header-tna-detil">Jadwal Acara <span>Kelompok & Ruang</span></div>
    <div id="konten">
    <table class="gradient-style" id="link-table" style="width:100%; margin-left:-1px">
       ...
       <tbody class="example altrowstable" id="alternatecolor"> 
		...
		?>
        <tr>
        	<td><a href="master_jadwal_add_kelompok_ruang.php?reqRowId=<?=$tempRowId?>&reqId=<?=$reqId?>&reqMode=view">link data</a></td>
