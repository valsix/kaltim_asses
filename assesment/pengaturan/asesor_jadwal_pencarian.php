...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",					  
		"sAjaxSource": "../json-pengaturan/asesor_jadwal_pencarian_json.php?reqAsesorId=<?=$reqAsesorId?>",
		...
		/* Click event handler */
		  ...
		  $("#reqPencarian").keyup(function(e) { 
			...
			if(code==13)
			{
				  ...
				  oTable.fnReloadAjax("../json-pengaturan/asesor_jadwal_pencarian_json.php?reqAsesorId=<?=$reqAsesorId?>"+"&reqCari="+reqPencarian);
			}
		  });
