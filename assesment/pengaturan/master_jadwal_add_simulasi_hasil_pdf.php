...
$reqNo=1;
for($index_loop_jadwal= 0; $index_loop_jadwal < $jumlah_data; $index_loop_jadwal++)
{
	//master_jadwal_add_simulasi_hasil_tanpa_penggalian
	if($arrData[$index_loop_jadwal]["URL"] == "master_jadwal_add_simulasi_hasil_tanpa_penggalian.php")
	{
		$set = new JadwalTesSimulasiAsesor();
		$statement= " AND A.JADWAL_TES_ID = ".$reqId;
		$statement.= " AND A.PUKUL_AWAL = '".$arrData[$index_loop_jadwal]["PUKUL_AWAL"]."'";
	...
	elseif($arrData[$index_loop_jadwal]["URL"] == "master_jadwal_add_simulasi_hasil_penggalian_tanpa_group.php")
	{
		$set= new JadwalTesSimulasiAsesor();
		$statement= " AND A.JADWAL_TES_ID = ".$reqId;
		$statement.= " AND A.PUKUL_AWAL = '".$arrData[$index_loop_jadwal]["PUKUL_AWAL"]."'";
	...
	elseif($arrData[$index_loop_jadwal]["URL"] == "master_jadwal_add_simulasi_hasil_penggalian_group.php")
	{
		$set = new JadwalTesSimulasiAsesor();
		$statement= " AND A.JADWAL_TES_ID = ".$reqId;
		$statement.= " AND A.PUKUL_AWAL = '".$arrData[$index_loop_jadwal]["PUKUL_AWAL"]."'";
