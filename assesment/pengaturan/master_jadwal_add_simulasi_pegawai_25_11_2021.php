...
<div id="content" style="height:auto; width:100%">
    ...
    <tr>
        ...
        <td><img  src="../WEB/images/down_icon.png" onClick="CetakData(<?=$tempPegawaiId?>)" style="cursor:pointer;text-align: center" class="gambar" /></td>

        <?if ($arrJadwalAsesor[$checkbox_index]["ASELON_ID"]!=99){?>
        <td><img  src="../WEB/images/down_icon.png" onClick="CetakDataPeserta(<?=$tempPegawaiId?>,'CI')" style="cursor:pointer;text-align: center" class="gambar" /></td> 
        <td><img  src="../WEB/images/down_icon.png" onClick="CetakDataPeserta(<?=$tempPegawaiId?>,'QI')" style="cursor:pointer;text-align: center" class="gambar" /></td>
        <td><img  src="../WEB/images/down_icon.png" onClick="CetakDataPeserta(<?=$tempPegawaiId?>,'QK_Eselon')" style="cursor:pointer;text-align: center" class="gambar" /></td>
        <?}
        else{?>
        	<td><img  src="../WEB/images/down_icon.png" onClick="CetakDataPeserta(<?=$tempPegawaiId?>,'QK_Pelaksana')" style="cursor:pointer;text-align: center" class="gambar" /></td>
         <?}?>
