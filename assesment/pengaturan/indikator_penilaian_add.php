		...
		<tr> 
                ...
                <table width="242" border="0" cellpadding="0" cellspacing="0" height="100%" id="menuFrame">
                    <tr> 
                        ...
                        <td valign="top">
                            ...
                            <!-- MENU -->
                            <iframe src="indikator_penilaian_add_menu.php?reqAtributId=<?=$reqAtributId?>" name="menuFrame" id="menuFrame" width="100%" height="100%" scrolling="auto" frameborder="0"></iframe>
                        </td>
                    </tr>
                </table>
            </td>
			...
			<td valign="top" height="100%" width="100%">
				<div id="kontainer-atas" class="kontainer-atasBagi">
					<iframe class="mainframe" id="idMainFrame" name="mainFrame" src="indikator_penilaian_add_level_atribut_monitoring.php?reqAtributId=<?=$reqAtributId?>" style="width:100%; height:calc(100% - 5px); border:none;"></iframe>
				</div>
				<div id="trdetil" style="overflow:hidden;">
					<button id="atasbawah">Show/Hide</button>
					<iframe class="mainframe" id="idMainFrameDetil" name="mainFrameDetil" src="indikator_penilaian_add_level_atribut.php?reqAtributId=<?=$reqAtributId?>" style="width:100%; height:100%;  border:none;"></iframe>
				</div>
			</td>
		</tr>
	</table>
