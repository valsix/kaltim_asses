  ...
  class Kelompok extends Entity{ 
    ...
    **/
	...
	function insert()
	{
		...
		$str = "INSERT INTO kelompok (
				   KELOMPOK_ID, NAMA, STATUS_AKTIF, LAST_CREATE_USER, LAST_CREATE_DATE) 
				VALUES (
    ...
    **/ 
    function selectByParams($paramsArray=array(),$limit=-1,$from=-1, $statement='', $sOrder="ORDER BY KELOMPOK_ID ASC")
	{
		$str = "SELECT KELOMPOK_ID, NAMA, STATUS_AKTIF, CASE WHEN STATUS_AKTIF = '1' THEN 'Ya' ELSE 'Tidak' END STATUS_KET
				FROM kelompok A WHERE 1=1 "; 
