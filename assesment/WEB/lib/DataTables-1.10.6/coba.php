...
include_once("../WEB/classes/base-simpeg/JenisPegawai.php");
...
<div id="begron"><img src="../WEB/images/bg-kanan.jpg" width="100%" height="100%" alt="Smile"></div>
<div id="wadah">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td class="">
            <div id="judul-halaman">
                <span><img src="../WEB/images/panah-judul.png">Data Siswa Magang</span>
            </div>            
            </td>
        </tr>
    </table>
