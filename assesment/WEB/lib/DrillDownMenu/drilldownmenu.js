...
function drilldownmenu(setting){
	this.sublevelarrow={src:'../WEB/lib/DrillDownMenu/right.gif', width:'8px', top:'3px', left:'6px'} //full URL to image used to indicate there's a sub level
	this.breadcrumbarrow='../WEB/lib/DrillDownMenu/right.gif' //full URL to image separating breadcrumb links (if it's defined)
	this.loadingimage='../WEB/lib/DrillDownMenu/loader.gif' //full URL to 'loading' image, if menu is loaded via Ajax
	...
	this.backarrow='../WEB/lib/DrillDownMenu/leftarrow.gif' //full URL to image added in front of back LI 
