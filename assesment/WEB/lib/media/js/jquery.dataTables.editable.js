        ...
        */
        ...
        return this.each(function () {
			...
			if (oAddDeleteToolbar.length != 0) {
				...
				if(properties.pLocation == '../json-simpeg/pegawai_json.php'){
					...
					oStatusPegawaiRowSelect.change(function () { 
						fnReloadAjax(properties.pLocation + '?reqStatusPegawai=' + $("#status_pegawai").val() + '&reqDepartemen=' + properties.pDepartemen);
					});
				}
            }
