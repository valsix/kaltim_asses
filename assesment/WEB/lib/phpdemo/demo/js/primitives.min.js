...
primitives.common.indexOf = function(a, b) {
    var c, d;
...
primitives.common.beforeOpacity = function(a, b) {
    ...
    e = Math.ceil((c.getRed(a) - 255 * (1 - b)) / b);
    c = Math.ceil((c.getRed(a) - 255 * (1 - b)) / b);
...
primitives.common.highestContrast = function(a, b, c) {
    ...
    e.highestContrasts.hasOwnProperty(g) ? d = e.highestContrasts[g] : (e.luminosity(b, a) < e.luminosity(c, a) && (d = c), e.highestContrasts[g] = d);
    return d
};
...
primitives.common.BaseShape.prototype._getLabelPosition = function(a, b, c, d, e, g, f, h) {
    var j = null;
    switch (h) {
        case 1:
            j = new primitives.common.Rect(a + c / 2 - e / 2, b - f - g, e, g);
            break;
        case 2:
            j = new primitives.common.Rect(a + c - e, b - f - g, e, g);
            break;
        case 8:
            j = new primitives.common.Rect(a, b - f - g, e, g);
            break;
        case 3:
            j = new primitives.common.Rect(a + c + f, b + d / 2 - g / 2, e, g);
            break;
        case 11:
            j = new primitives.common.Rect(a + c + f, b, e, g);
            break;
        case 12:
            j = new primitives.common.Rect(a + c + f, b + d - g, e, g);
            break;
        case 4:
            ...
            break;
        case 6:
            j = new primitives.common.Rect(a, b + d + f, e, g);
            break;
        case 7:
            j = new primitives.common.Rect(a - e - f, b + d / 2 - g / 2, e, g);
            break;
        case 9:
            j = new primitives.common.Rect(a - e - f, b, e, g);
            break;
        case 10:
            j = new primitives.common.Rect(a - e - f, b + d - g, e, g);
            break;
        default:
            j = new primitives.common.Rect(a + c / 2 - e / 2, b + d + f, e, g)
    }
    return j
};
primitives.common.BaseShape.prototype._getArrow = function(a, b, c, d, e) {
    for (var g = [], f, h, j, i = [new primitives.common.Point(c, -d / 2), new primitives.common.Point(0, 0), new primitives.common.Point(c, d / 2), new primitives.common.Point(3 * (c / 4), 0)], c = 0, d = i.length; c < d; c += 1) f = i[c], h = f.x * Math.cos(e) - f.y * Math.sin(e), j = f.x * Math.sin(e) + f.y * Math.cos(e), f.x = h + a, f.y = j + b;
    g.push(new primitives.common.MoveSegment(i[0].x, i[0].y));
    g.push(new primitives.common.LineSegment(i[1].x, i[1].y));
    g.push(new primitives.common.LineSegment(i[2].x,
        i[2].y));
    g.push(new primitives.common.QuadraticArcSegment(i[3].x, i[3].y, i[0].x, i[0].y));
    return g
};
...
primitives.common.Callout.prototype.draw = function(a, b) {
    var b = (new primitives.common.Rect(b)).offset(this.offset),
        ...
        g = new primitives.common.Point(b.left(), b.bottom()),
    ...
    null !== a && (c = 0 === this.pointerPlacement ? this._getPlacement(a,
        c, e) : this.pointerPlacement, null !== c && (f[c] = a));
    c = [];
    for (h = 0; h < g.length; h += 1) this._drawSegment(c, g[0], g[1], g[2], this.pointerWidth, d, f[1], f[2]), e = g.shift(), g.push(e), e = f.shift(), f.push(e), e = f.shift(), f.push(e);
    f = {};
    null !== this.fillColor && (f.fillColor = this.fillColor, f.opacity = this.opacity);
    null !== this.borderColor && (f.borderColor = this.borderColor);
    f.lineWidth = this.lineWidth;
    f.lineType = this.lineType;
    this.m_graphics.polyline(c, f)
};
...
primitives.common.Callout.prototype._drawSegment = function(a, b, c, d, e, g, f, h) {
    var j = this._offsetPoint(b, c, g),
        i = this._offsetPoint(c, b, g),
        d = this._offsetPoint(c, d, g),
        e = this.m_graphics.getPxSize(e, b.distanceTo(c) / 2);
    0 === a.length && a.push(new primitives.common.MoveSegment(j));
    null !== f && (j = this._betweenPoint(b, c), b = this._offsetPoint(j, b, e), e = this._offsetPoint(j, c, e), a.push(new primitives.common.LineSegment(b)), a.push(new primitives.common.LineSegment(f)), a.push(new primitives.common.LineSegment(e)));
...
primitives.common.Connector.prototype.draw = function(a, b, c) {
    ...
    var t, s, u = 0,
        v = 0,
        w, a = (new primitives.common.Rect(a)).offset(this.offset),
    ...
    u = Math.max(this.hasLabel ?
        t.width : 0, 5 * j);
    if (a.right() + u < b.left() || a.left() > b.right() + u)
        if (a.left() > b.right() ? (d = new primitives.common.Point(a.left(), a.verticalCenter()), e = new primitives.common.Point(b.right(), b.verticalCenter()), u = 7, v = 3) : (d = new primitives.common.Point(a.right(), a.verticalCenter()), e = new primitives.common.Point(b.left(), b.verticalCenter()), u = 3, v = 7), g = new primitives.common.Rect(d, e), p = d.y <= e.y, n = d.x < e.x, g.height < g.width) {
            g.height < 2 * j && g.offset(0, p ? 2 * j : 0, 0, p ? 0 : 2 * j);
            i = 0;
            for (k = l.length; i < k; i += 1) m = l[i], f.push(new primitives.common.MoveSegment(d.x,
                d.y + m)), f.push(new primitives.common.QuadraticArcSegment(g.horizontalCenter(), (p ? g.top() : g.bottom()) + m, e.x, e.y + m));
            l = t.width < 2 * (g.width / 5) ? this._quadraticBezierPoint(d, new primitives.common.Point(g.horizontalCenter(), p ? g.top() : g.bottom()), e, 0.5) : new primitives.common.Point(d.x, p ? g.top() : g.bottom());
            s = new primitives.common.Rect(l.x + (n ? q : -t.width - q), p ? l.y - t.height - j : l.y + j, t.width, t.height)
        } else {
            i = 0;
            for (k = l.length; i < k; i += 1) m = l[i], f.push(new primitives.common.MoveSegment(d.x, d.y + m)), f.push(new primitives.common.QuadraticArcSegment(g.horizontalCenter() +
                m * (p != n ? 1 : -1), (p ? g.top() : g.bottom()) + m, g.horizontalCenter() + m * (p != n ? 1 : -1), g.verticalCenter() + m)), f.push(new primitives.common.QuadraticArcSegment(g.horizontalCenter() + m * (p != n ? 1 : -1), (p ? g.bottom() : g.top()) + m, e.x, e.y + m));
            s = new primitives.common.Rect(g.horizontalCenter() + (p != n ? q : -(q + t.width)), g.verticalCenter() - t.height / 2, t.width, t.height)
        ...
        v = u = n ? 3 : 7;
        g = new primitives.common.Rect(d, e);
        g.offset(10 * j, 0, 10 * j, 0);
        p = d.y <= e.y;
        i = 0;
        for (k = l.length; i < k; i += 1) m = l[i], f.push(new primitives.common.MoveSegment(d.x, d.y + m)), f.push(new primitives.common.QuadraticArcSegment(n ? g.right() + m * (p ? -1 : 1) : g.left() - m * (p ? -1 : 1), g.verticalCenter(), n ? b.right() : b.left(), b.verticalCenter() - m));
        l = this._quadraticBezierPoint(d, new primitives.common.Point(n ? g.right() : g.left(), g.verticalCenter()), e, 0.5);
        s = new primitives.common.Rect(l.x +
            (n ? q / 2 : -q / 2 - t.width), l.y - t.height / 2, t.width, t.height)
    } else {
        ...
        n = d.x < e.x;
        i = 0;
        for (k = l.length; i < k; i += 1) m = l[i], f.push(new primitives.common.MoveSegment(d.x + m, d.y)), f.push(new primitives.common.QuadraticArcSegment(g.horizontalCenter(), g.top() - m * (n ? -1 : 1), b.horizontalCenter() - m, b.top()));
        l = this._quadraticBezierPoint(d, new primitives.common.Point(g.horizontalCenter(),
            g.top()), e, 0.5);
        s = new primitives.common.Rect(l.x - t.width / 2, l.y - (this.labelOffset + t.height), t.width, t.height)
    }
    if (0 < f.length) {
        this.transform.transformSegments(f, !0);
        switch (this.connectorShapeType) {
            case 1:
                l = f[f.length / 2 - 1];
                ...
                break;
            case 0:
                l = f[f.length - 1], n = Math.atan2(l.cpY - l.y, l.cpX - l.x), h = h.concat(this._getArrow(l.x, l.y, j, r, n)), n = this._offsetPoint(new primitives.common.Point(l.x, l.y), new primitives.common.Point(l.cpX, l.cpY), r), l.x = n.x, l.y = n.y
        }
        j = {};
        null !== this.borderColor && (j.borderColor = this.color);
        j.lineWidth = this.lineWidth;
        j.lineType = this.lineType;
        this.m_graphics.polyline(f, j);
        f = {
            opacity: 1
        };
        null !== this.fillColor && (f.fillColor = this.color);
        null !== this.borderColor && (f.borderColor = this.color);
        f.lineWidth = 0;
        this.m_graphics.polyline(h, f);
        if (this.hasLabel) {
            switch (this.labelPlacementType) {
                case primitives.common.ConnectorLabelPlacementType.From:
                    s = this._getLabelPosition(a.x, a.y, a.width, a.height, s.width, s.height, this.labelOffset, u);
                    break;
                case primitives.common.ConnectorLabelPlacementType.To:
                    s = this._getLabelPosition(b.x, b.y, b.width, b.height, s.width, s.height, this.labelOffset, v)
            }
            this.transform.transformRect(s.x,
                s.y, s.width, s.height, !0, this,
                function(a, b, c, d) {
...
primitives.common.Shape.prototype.draw = function(a, b) {
    var c = [],
        d, e, g, a = (new primitives.common.Rect(a)).offset(this.offset);
    this.transform = new primitives.common.Transform;
    this.transform.size = this.panelSize;
    this.transform.setOrientation(this.orientationType);
        ...
        default:
            ...
            switch (this.shapeType) {
                ...
                case 1:
                    ...
                    g = 0.5522848 * (a.height / 2);
                    c.push(new primitives.common.MoveSegment(a.x,
                        a.verticalCenter()));
                    c.push(new primitives.common.CubicArcSegment(a.x, a.verticalCenter() - g, a.horizontalCenter() - d, a.y, a.horizontalCenter(), a.y));
                    c.push(new primitives.common.CubicArcSegment(a.horizontalCenter() + d, a.y, a.right(), a.verticalCenter() - g, a.right(), a.verticalCenter()));
                    c.push(new primitives.common.CubicArcSegment(a.right(), a.verticalCenter() + g, a.horizontalCenter() + d, a.bottom(), a.horizontalCenter(), a.bottom()));
                    c.push(new primitives.common.CubicArcSegment(a.horizontalCenter() - d, a.bottom(),
                        a.x, a.verticalCenter() + g, a.x, a.verticalCenter()));
                    break;
                case 5:
...
primitives.common.CubicArcSegment = function(a, b, c, d, e, g) {
    ...
    switch (arguments.length) {
        case 3:
            ...
            break;
        case 6:
            this.cpX1 = a, this.cpY1 = b, this.cpX2 = c, this.cpY2 = d, this.x = e, this.y = g
    }
    this.segmentType = 3
};
...
primitives.common.Rect.prototype.addRect = function(a, b, c, d) {
    ...
    switch (arguments.length) {
        case 1:
            a.isEmpty() || (this.isEmpty() ? (this.x = a.x, this.y = a.y, this.width = a.width, this.height = a.height) : (e = Math.max(this.right(), a.right()), g = Math.max(this.bottom(), a.bottom()), this.x = Math.min(this.x, a.x), this.y = Math.min(this.y, a.y), this.width = e - this.x, this.height = g - this.y));
            break;
        case 2:
            this.isEmpty() ? (this.x = a, this.y = b, this.height = this.width = 0) : (e = Math.max(this.right(), a), g = Math.max(this.bottom(), b), this.x = Math.min(this.x,
                a), this.y = Math.min(this.y, b), this.width = e - this.x, this.height = g - this.y);
            break;
        case 4:
            this.isEmpty() ? (this.x = a, this.y = b, this.width = c, this.height = d) : (e = Math.max(this.right(), a + c), g = Math.max(this.bottom(), b + d), this.x = Math.min(this.x, a), this.y = Math.min(this.y, b), this.width = e - this.x, this.height = g - this.y)
    }
    return this
};
...
primitives.common.Graphics.prototype._activateLayer = function(a) {
    ...
    if (void 0 === b) {
        ...
        if (-1 === a) b = new primitives.common.Layer(a), b.canvas = c.div;
            ...
            e = null;
            for (g in c.layers) c.layers.hasOwnProperty(g) && (b = c.layers[g], b.name < a && (e = null !== e ? Math.max(e, b.name) : b.name));
...
primitives.common.Graphics.prototype.text = function(a, b, c, d, e, g, f, h, j) {
    var i = this.m_activePlaceholder,
        f = {
            position: "absolute",
            padding: 0,
            margin: 0,
            "text-align": this._getTextAlign(f),
    ...
    switch (g) {
        ...
        case 3:
            ...
            break;
        case 1:
            f.left = a + Math.round(c / 2 - d / 2);
            f.top = b + Math.round(d / 2 - c / 2);
            f.width = d;
            f.height = c;
            j = "rotate(-90deg)";
            break;
        case 2:
            f.left = a + Math.round(c / 2 - d / 2), f.top = b + Math.round(d / 2 - c / 2), f.width = d, f.height = c, j = "rotate(90deg)"
    }
    f["-webkit-transform-origin"] = "center center";
    f["-moz-transform-origin"] = "center center";
    f["-o-transform-origin"] = "center center";
    f["-ms-transform-origin"] = "center center";
    f["-webkit-transform"] = j;
    f["-moz-transform"] = j;
    f["-o-transform"] = j;
    f["-ms-transform"] = j;
    f.transform = j;
    f["max-width"] = f.width;
    f["max-height"] = f.height;
    e = e.replace(RegExp("\n", "g"), "<br/>");
    switch (h) {
        case 0:
            a = this.m_cache.get(i.name,
                i.activeLayer.name, "text");
            null === a ? (a = jQuery("<div></div>"), a.css(f), a.html(e), i.activeLayer.canvas.append(a), this.m_cache.put(i.name, i.activeLayer.name, "text", a)) : (a.css(f), a.html(e));
            break;
        default:
            f["border-collapse"] = "collapse", b = {
                "vertical-align": this._getVerticalAlignment(h),
                padding: 0
            }, a = this.m_cache.get(i.name, i.activeLayer.name, "textintable"), null === a ? (a = jQuery("<table><tbody><tr><td></td></tr></tbody></table>"), primitives.common.css(a, f), a.find("td").css(b).html(e), i.activeLayer.canvas.append(a),
                this.m_cache.put(i.name, i.activeLayer.name, "textintable", a)) : (primitives.common.css(a, f), a.find("td").css(b).html(e))
    }
};
...
primitives.common.Graphics.prototype.polyline = function(a, b) {
    ...
    for (e = 0; e < a.length; e += 1) switch (g = a[e], g.segmentType) {
        case 1:
            c = Math.round(g.x) + 0.5;
            d = Math.round(g.y) + 0.5;
            break;
        case 0:
            this.rightAngleLine(c, d, Math.round(g.x) + 0.5, Math.round(g.y) + 0.5, b);
            break;
        case 4:
            this.dot(g.x, g.y, g.width, g.height, g.cornerRadius, b)
    }
};
primitives.common.Graphics.prototype.dot = function(a, b, c, d, e, g) {
    var f = this.m_activePlaceholder,
        h = this.m_cache.get(f.name, f.activeLayer.name, "dot"),
        j = void 0 !== g.lineWidth && void 0 !== g.borderColor,
        a = {
            position: "absolute",
            width: c - (j ? 1 : 0),
            top: Math.round(b),
            ...
            "border-color": j ? g.borderColor : ""
        };
    null === h ? (h = jQuery("<div></div>"), primitives.common.css(h, a), f.activeLayer.canvas.append(h), this.m_cache.put(f.name, f.activeLayer.name, "dot", h)) : primitives.common.css(h, a)
};
primitives.common.Graphics.prototype.rightAngleLine = function(a, b, c, d, e) {
    var g = this.m_activePlaceholder,
        f = Math.abs(d - b) > Math.abs(c - a),
        h = e.lineWidth,
        e = {
            position: "absolute",
            top: Math.round(Math.min(b, d) - (f ? 0 : h / 2)),
            left: Math.round(Math.min(a, c) - (f ? h / 2 : 0)),
            padding: 0,
            margin: 0,
            opacity: 0.5,
            "line-height": "0px",
    ...
    f ? (e.width = h, e.height = Math.abs(Math.round(d - b))) : (e.width = Math.abs(Math.round(c - a)), e.height = h);
    a = this.m_cache.get(g.name, g.activeLayer.name,
        "rect");
    null === a ? (a = jQuery("<div></div>"), primitives.common.css(a, e), g.activeLayer.canvas.append(a), this.m_cache.put(g.name, g.activeLayer.name, "rect", a)) : primitives.common.css(a, e)
};
primitives.common.Graphics.prototype.template = function(a, b, c, d, e, g, f, h, j, i, k, l, m) {
...
primitives.common.CanvasGraphics.prototype.begin = function() {
    ...
    for (a in this.m_placeholders)
        if (this.m_placeholders.hasOwnProperty(a))
            for (c in b = this.m_placeholders[a], e = b.size.width, g = b.size.height, b.layers) b.layers.hasOwnProperty(c) && (d = b.layers[c], null !== d.canvascanvas && d.canvascontext.clearRect(0, 0, e, g))
};
...
primitives.common.CanvasGraphics.prototype.reset = function(a, b) {
    ...
    void 0 !== e && (c = e.size.width, g = e.size.height, d = e.layers[d], void 0 !== d && null !== d.canvascanvas && d.canvascontext.clearRect(0, 0, c, g))
};
...
primitives.common.SvgGraphics.prototype.resizePlaceholder = function(a, b, c) {
    var d, e, g;
    this.parent.resizePlaceholder.apply(this, arguments);
    for (d in a.layers) a.layers.hasOwnProperty(d) && (e = a.layers[d], null !== e.svgcanvas && (g = {
        position: "absolute",
        width: b + "px",
        height: c + "px"
    }, e.svgcanvas.css(g), e.svgcanvas.attr({
        viewBox: "0 0 " + b + " " + c
    })))
};
...
primitives.common.SvgGraphics.prototype.polyline = function(a, b) {
    ...
    e = "";
    for (g = 0; g < a.length; g += 1) switch (f = a[g], f.segmentType) {
        case 1:
            e += "M" + (Math.round(f.x) + 0.5) + " " + (Math.round(f.y) + 0.5);
            break;
        case 0:
            e += "L" + (Math.round(f.x) + 0.5) + " " + (Math.round(f.y) + 0.5);
            break;
        case 2:
            e += "Q" + (Math.round(f.cpX) + 0.5) + " " + (Math.round(f.cpY) + 0.5) + " " + (Math.round(f.x) +
                0.5) + " " + (Math.round(f.y) + 0.5);
            break;
        case 4:
            f.width == f.height && f.width / 2 <= f.cornerRadius ? (h = f.width / 2, e += "M" + (Math.round(f.x) + 0.5) + " " + (Math.round(f.y) + f.height / 2 + 0.5), e += "A" + h + " " + h + " 0 0 0 " + (Math.round(f.x + f.width) + 0.5) + " " + (Math.round(f.y) + f.height / 2 + 0.5), e += "A" + h + " " + h + " 0 0 0 " + (Math.round(f.x) + 0.5) + " " + (Math.round(f.y) + f.height / 2 + 0.5)) : 0 == f.cornerRadius ? (e += "M" + (Math.round(f.x) + 0.5) + " " + (Math.round(f.y) + 0.5), e += "L" + (Math.round(f.x + f.width) + 0.5) + " " + (Math.round(f.y) + 0.5), e += "L" + (Math.round(f.x +
                ...
                f.width) + 0.5) + " " + (Math.round(f.y + h) + 0.5), e += "L" + (Math.round(f.x + f.width) + 0.5) + " " + (Math.round(f.y + f.height - h) + 0.5), e += "A" + Math.round(h) + " " + Math.round(h) + " 0 0 1 " + (Math.round(f.x + f.width - h) + 0.5) + " " + (Math.round(f.y + f.height) + 0.5), e += "L" + (Math.round(f.x + h) + 0.5) + " " + (Math.round(f.y + f.height) + 0.5), e += "A" + Math.round(h) + " " + Math.round(h) + " 0 0 1 " + (Math.round(f.x) + 0.5) + " " + (Math.round(f.y + f.height - h) + 0.5), e += "L" + (Math.round(f.x) + 0.5) + " " + (Math.round(f.y + h) + 0.5));
            break;
        case 3:
            e += "C" + (Math.round(f.cpX1) +
                0.5) + " " + (Math.round(f.cpY1) + 0.5) + " " + (Math.round(f.cpX2) + 0.5) + " " + (Math.round(f.cpY2) + 0.5) + " " + (Math.round(f.x) + 0.5) + " " + (Math.round(f.y) + 0.5)
    }
    d.setAttribute("d", e);
...
primitives.common.Transform.prototype.transformPoint = function(a, b, c, d, e) {
    var g;
    c && this.invertArea && (g = a, a = b, b = g);
    this.invertHorizontally && (a = this.size.width - a);
    this.invertVertically && (b = this.size.height - b);
    !c && this.invertArea && (g = a, a = b, b = g);
    e.call(d, a, b)
};
primitives.common.Transform.prototype.transformPoints = function(a, b, c, d, e, g, f) {
    var h;
...
primitives.common.Transform.prototype.transform3Points = function(a, b, c, d, e, g, f, h, j) {
    var i;
    f && this.invertArea && (i = a, a = b, b = i, i = c, c = d, d = i, i = e, e = g, g = i);
    this.invertHorizontally && (a = this.size.width - a, c = this.size.width - c, e = this.size.width - e);
    this.invertVertically && (b = this.size.height - b, d = this.size.height - d, g = this.size.height - g);
    !f && this.invertArea && (i = a, a = b, b = i, i = c, c = d, d = i, i = e, e = g, g = i);
    j.call(h, a, b, c, d, e, g)
};
primitives.common.Transform.prototype.transformRect = function(a, b, c, d, e, g, f) {
    var h;
    e && this.invertArea && (h = a, a = b, b = h, h = c, c = d, d = h);
...
primitives.common.VmlGraphics.prototype.text = function(a, b, c, d, e, g, f, h, j) {
    var i, k, l;
    switch (g) {
        case 0:
        case 3:
            this.parent.text.call(this, a, b, c, d, e, g, f, h, j);
            break;
        default:
            ...
            h.style.trim = !1;
            h.style["v-text-align"] = this._getTextAlign(f);
...
primitives.common.VmlGraphics.prototype.polyline = function(a, b) {
    var c = this.m_activePlaceholder,
        ...
        g = new primitives.common.Element(this.prefix + ":shape"),
        f, h, j, i, k;
    void 0 !== b.borderColor && void 0 !== b.lineWidth ? (g.setAttribute("strokecolor", b.borderColor), g.setAttribute("strokeweight", b.lineWidth), g.setAttribute("stroked", !0)) : g.setAttribute("stroked", !1);
    g.setAttribute("CoordSize", e.width + "," + e.height);
    g.style.top =
        d.y + "px";
    g.style.left = d.x + "px";
    ...
    for (e = 0; e < a.length; e += 1) switch (f = a[e], f.segmentType) {
        case 1:
            d += " m" + 10 * Math.round(f.x) + "," + 10 * Math.round(f.y);
            break;
        case 0:
            d += " l" + 10 * Math.round(f.x) + "," + 10 * Math.round(f.y);
            break;
        case 4:
            h = Math.round(f.x);
            j = Math.round(f.y);
            i = Math.round(f.x + f.width);
            f = Math.round(f.y + f.height);
            h > i && (k = h, h = i, i = k);
            j > f && (k = j, j = f, f = k);
            h = 10 * h + 5;
            j = 10 * j + 5;
            ...
            break;
        case 2:
            d += " qb" + 10 * Math.round(f.cpX) + "," + 10 * Math.round(f.cpY) + " l" + 10 * Math.round(f.x) + "," + 10 * Math.round(f.y);
            break;
        case 3:
            d += " c" + 10 * Math.round(f.cpX1) + "," + 10 * Math.round(f.cpY1) + "," + 10 * Math.round(f.cpX2) + "," + 10 * Math.round(f.cpY2) + "," + 10 * Math.round(f.x) + "," + 10 * Math.round(f.y)
    }
    d += " e";
    e = "shapepath";
    ...
    null !== b.fillColor ? (g.setAttribute("filled", !0), d = new primitives.common.Element(this.prefix + ":fill"), d.setAttribute("opacity", b.opacity), d.setAttribute("color", b.fillColor), g.appendChild(d), e += "fill") : g.setAttribute("filled", !1);
    d = this.m_cache.get(c.name, c.activeLayer.name, e);
    null === d ? (d = jQuery(g.create(this.ie8mode)), c.activeLayer.canvas.append(d), this.m_cache.put(c.name,
        c.activeLayer.name, e, d)) : g.update(d[0], this.ie8mode)
};
...
primitives.orgdiagram.BaseController = function() {
    ...
    this._rightMargins = {};
    this._templates = {};
    this.m_scrollPanel = this._highlightTreeItem = this._cursorTreeItem = this._annotationLabelTemplateHashCode = this._annotationLabelTemplate = this._groupTitleTemplateHashCode =
    ...
    this._scale = null;
    this.scale = 1;
    this.showElbowDots = this.showInvisibleSubTrees = !1
};
...
primitives.orgdiagram.BaseController.prototype._bind = function() {
    ...
    this.options.onDefaultTemplateRender = function(b,
        c) {
...
primitives.orgdiagram.BaseController.prototype._unbind = function() {
    ...
    "ontouchstart" in document.documentElement && (this.m_scrollPanel[0].removeEventListener("gesturestart", this.onGestureStartHandler, !1), this.m_scrollPanel[0].removeEventListener("mousewheel", this.onGestureChangeHandler, !1));
...
primitives.orgdiagram.BaseController.prototype._getEventArgs = function() {
    return null
};
primitives.orgdiagram.BaseController.prototype._onMouseMove = function(a) {
    var b = this.m_placeholder.offset(),
        c = a.pageX - b.left,
        b = a.pageY - b.top;
    this._mouseStarted || (this._cancelMouseClick = !1, c = this._getTreeItemForMousePosition(c, b), "ontouchstart" in document.documentElement ? this._highlightTreeItem = c : null !== c ? c.itemConfig.id !== this.options.highlightItem && (b = this._getEventArgs(this._highlightTreeItem, c), this._highlightTreeItem = c, this.options.highlightItem = c.itemConfig.id, this._trigger("onHighlightChanging",
...
primitives.orgdiagram.BaseController.prototype._onMouseClick = function(a) {
    ...
    null !== b && !this._cancelMouseClick && (c = jQuery(a.target), c.hasClass(this.widgetEventPrefix + "button") || 0 < c.parent("." + this.widgetEventPrefix + "button").length ? (c = c.hasClass(this.widgetEventPrefix + "button") ? c : c.parent("." + this.widgetEventPrefix + "button"), d = c.data("buttonname"), c = this._getEventArgs(null, b, d), this._trigger("onButtonClick", a, c)) : "selectiontext" !== c.attr("name") && ("checkbox" === c.attr("name") ?
        (c = this._getEventArgs(null, b, d), this._trigger("onSelectionChanging", a, c), d = primitives.common.indexOf(this.options.selectedItems, b.itemConfig.id), 0 <= d ? this.options.selectedItems.splice(d, 1) : this.options.selectedItems.push(b.itemConfig.id), this._trigger("onSelectionChanged", a, c)) : (c = this._getEventArgs(null, b), this._trigger("onMouseClick", a, c), !c.cancel && b.itemConfig.id !== this.options.cursorItem && (c = this._getEventArgs(null != this.options.cursorItem ? this._treeItemsByUserId[this.options.cursorItem] : null,
            b), this.options.cursorItem = b.itemConfig.id, this._trigger("onCursorChanging", a, c), c.cancel || (this._refresh(), this._trigger("onCursorChanged", a, c))))));
    this._cancelMouseClick = !1
};
...
primitives.orgdiagram.BaseController.prototype._drawHighlight = function() {
    ...
    null !== this._highlightTreeItem && (this.graphics.activate("placeholder", 3), a = this._highlightTreeItem.actualPosition, b = new primitives.common.Rect(0, 0, Math.round(this._highlightTreeItem.actualSize.width), Math.round(this._highlightTreeItem.actualSize.height)), c = this._highlightTreeItem.template.highlightPadding, b.offset(c.left, c.top, c.right, c.bottom), d = new primitives.common.RenderEventArgs, d.context = this._highlightTreeItem.itemConfig,
        d.isCursor = this._highlightTreeItem.isCursor, d.isSelected = this._highlightTreeItem.isSelected, d.templateName = this._highlightTreeItem.template.name, this.transform.transformRect(a.x, a.y, a.width, a.height, !0, this, function(a, c, f, h) {
            1 == this._highlightTreeItem.actualVisibility ? this.graphics.template(a, c, f, h, b.x, b.y, b.width, b.height, this._highlightTreeItem.template.highlightTemplate, this._highlightTreeItem.template.highlightTemplateHashCode, this._highlightTreeItem.template.highlightTemplateRenderName, d, null) :
...
primitives.orgdiagram.BaseController.prototype._redrawTreeItems = function() {
    ...
    for (g in this._treeItems) this._treeItems.hasOwnProperty(g) && (a = this._treeItems[g], b = a.orgItem, c = this._treeLevels[a.level], a.setActualPosition(c, this.options), this.transform.transformRect(a.actualPosition.x,
        ...
        function(g, i, j, p) {
            switch (a.actualVisibility) {
                case 1:
                    ...
                    this.graphics.template(g, i, j, p, a.contentPosition.x, a.contentPosition.y, a.contentPosition.width, a.contentPosition.height, a.template.itemTemplate, a.template.itemTemplateHashCode, a.template.itemTemplateRenderName,
                        d, {
                            "border-width": a.template.itemBorderWidth
                        });
                    a.actualHasGroupTitle && this.graphics.template(g, i, j, p, 2, a.contentPosition.y, this.options.groupTitlePanelSize - 4, a.contentPosition.height, this._groupTitleTemplate, this._groupTitleTemplateHashCode, "onGroupTitleTemplateRender", a, null);
                    a.actualHasSelectorCheckbox && (this.graphics.activate("placeholder", 10), this.graphics.template(g, i, j, p, a.contentPosition.x, a.actualSize.height - (this.options.checkBoxPanelSize - 4), a.contentPosition.width, this.options.checkBoxPanelSize -
                        4, this._checkBoxTemplate, this._checkBoxTemplateHashCode, "onCheckBoxTemplateRender", a, null));
                    a.actualHasButtons && (this.graphics.activate("placeholder", 10), this.graphics.template(g, i, j, p, a.actualSize.width - (this.options.buttonsPanelSize - 4), a.contentPosition.y, this.options.buttonsPanelSize - 4, Math.max(a.contentPosition.height, a.actualSize.height - a.contentPosition.y), this._buttonsTemplate, this._buttonsTemplateHashCode, "onButtonsTemplateRender", a, null));
                    0 == this.options.showLabels && (k = new primitives.common.Label,
                        k.text = b.title, k.position = new primitives.common.Rect(g, i, j, p), k.weight = 1E4, k.labelType = 1, c.labels.push(k));
                    k = this._createLabel(g, i, j, p, a);
                    null != k && c.labels.push(k);
                    break;
                case 2:
                    e = b.itemTitleColor, null == e && (e = "#000080"), f.hasOwnProperty(e) || (f[e] = []), h = f[e], h.push(new primitives.common.DotSegment(g, i, j, p, a.template.minimizedItemCornerRadius)), k = this._createLabel(g, i, j, p, a), null != k && c.labels.push(k)
            }
        }));
    this.graphics.activate("placeholder", 4);
    for (e in f) f.hasOwnProperty(e) && (h = f[e], g = {
        fillColor: e,
        borderColor: e,
        opacity: 1,
        lineWidth: 1,
        lineType: 0
    }, this.graphics.polyline(h, g));
    this._redrawLabels()
};
primitives.orgdiagram.BaseController.prototype._redrawLabels = function() {
    ...
    if (0 == this.options.showLabels) {
        f = 0;
        for (h = this._treeLevels.length; f < h; f += 1) {
            e = this._treeLevels[f];
            a = e.labels;
            d = 0;
            for (g = a.length; d < g; d += 1) b = a[d], null == e.labelsRect ? e.labelsRect = new primitives.common.Rect(b.position) : e.labelsRect.addRect(b.position), e.hasFixedLabels = e.hasFixedLabels || 2 == b.labelType
        }
        for (f = this._treeLevels.length - 1; 0 < f; f -= 1) a = this._treeLevels[f - 1], b = this._treeLevels[f], null != a.labelsRect && null !=
            b.labelsRect && a.labelsRect.overlaps(b.labelsRect) && (b.showLabels = !1);
        f = 0;
        for (h = this._treeLevels.length; f < h; f += 1)
            if (e = this._treeLevels[f], a = e.labels, e.showLabels) {
                d = 0;
    ...
    f = 0;
    for (h = this._treeLevels.length; f < h; f += 1)
        if (e = this._treeLevels[f], e.showLabels || e.hasFixedLabels) {
            a = e.labels;
            d = 0;
            for (g = a.length; d < g; d += 1)
    ...
    if (!primitives.common.isNullOrEmpty(i.label)) {
        ...
        if (null != h) {
            ...
            switch (i) {
                case 0:
                case 1:
                    h.position = new primitives.common.Rect(a + c / 2 - g / 2, b - j - f, g, f);
                    switch (h.labelOrientation) {
                        case 0:
                ...
                case 2:
                case 11:
                    h.position = new primitives.common.Rect(a + c + j, b - j - f, g, f);
                    switch (h.labelOrientation) {
                        case 0:
                            h.horizontalAlignmentType = 1;
                            h.verticalAlignmentType = 2;
                ...
                case 4:
                case 12:
                    h.position = new primitives.common.Rect(a + c + j, b + d + j, g, f);
                    switch (h.labelOrientation) {
                        case 0:
                            h.horizontalAlignmentType = 1;
                            h.verticalAlignmentType = 0;
                    ...
                    break;
                case 5:
                    h.position = new primitives.common.Rect(a + c / 2 - g / 2, b + d + j, g, f);
                    switch (h.labelOrientation) {
                        case 0:
                            h.horizontalAlignmentType = 0;
                            h.verticalAlignmentType = 0;
                ...
                case 6:
                case 10:
                    h.position = new primitives.common.Rect(a - g - j, b + d + j, g, f);
                    switch (h.labelOrientation) {
                        case 0:
                            h.horizontalAlignmentType = 2;
                            h.verticalAlignmentType = 0;
                    ...
                    break;
                case 7:
                    h.position = new primitives.common.Rect(a - g - j, b + d / 2 - f / 2, g, f);
                    switch (h.labelOrientation) {
                        case 0:
                            h.horizontalAlignmentType = 2;
                            h.verticalAlignmentType = 1;
                ...
                case 8:
                case 9:
                    switch (h.position = new primitives.common.Rect(a - g - j, b - j - f, g, f), h.labelOrientation) {
                        case 0:
                            h.horizontalAlignmentType =
                                2;
                            h.verticalAlignmentType = 2;
    ...
    for (b = this.options.annotations.length; a < b; a += 1) switch (c = this.options.annotations[a], c.annotationType) {
        case 2:
            if (null == j && (j = this._getConnectionsGraph()), null != c.items && 0 < c.items.length) {
                k = c.items.slice(0);
                f = this._treeItemsByUserId[k[0]];
                if (1 == k.length) {
                    c = 0;
                    for (d = f.logicalParents.length; c < d; c += 1) e = this._treeItems[f.logicalParents[c]], null != e.itemConfig && k.push(e.itemConfig.id)
                }
                if (1 < k.length) {
                    c =
                        1;
                    for (d = k.length; c < d; c += 1) {
                        ...
                        i = this._findShortestPath(j, f, e);
                        e = 1;
                        for (g = i.length; e < g; e += 1) l = j[i[e - 1]][i[e]], h = this._treeItems[l.id], h.highlightPath = 1, l.hasOwnProperty("partnerid") && (h = this._treeItems[l.partnerid], h.partnerHighlightPath = 1)
                    }
                }
            }
    }
};
primitives.orgdiagram.BaseController.prototype._findShortestPath = function(a, b, c) {
    var d = {},
        e = {},
        g = {},
        f, h, j, i, k;
    ...
    for (e[b] = 0; 0 < f;) {
        ...
        i = a[b];
        for (j in i) i.hasOwnProperty(j) && (k = h + 1, e.hasOwnProperty(j) ? e[j] > k && d.hasOwnProperty(j) && (e[j] = k, g[j] = b) : (e[j] = k, g[j] = b, d[j] = !0, f += 1));
        if (b == c) break;
        else delete d[b], f -= 1
    }
...
primitives.orgdiagram.BaseController.prototype._getConnectionsGraph = function() {
    ...
    for (c = this._treeLevels.length; b < c; b += 1) {
        ...
        for (e = a.treeItems.length; d < e; d += 1) {
            h = a.treeItems[d];
            h = this._treeItems[h];
            h.connectorPlacement & 8 ? j = [a.treeItems[h.levelPosition - 1]] : h.connectorPlacement & 2 ? j = [a.treeItems[h.levelPosition + 1]] : h.connectorPlacement & 1 ? (g = this._treeItems[h.visualParentId], j = 1 < g.partners.length ? g.partners.slice(0) : [h.visualParentId]) : j = [];
            g = 0;
            for (f =
                j.length; g < f; g += 1) i = j[g], k.hasOwnProperty(h.id) || (k[h.id] = {}), k[h.id][i] = 1 == f ? {
                id: h.id
            } : {
                id: h.id,
                partnerid: i
            }, k.hasOwnProperty(i) || (k[i] = {}), k[i][h.id] = 1 == f ? {
                id: h.id
            } : {
                id: h.id,
                partnerid: i
...
primitives.orgdiagram.BaseController.prototype._drawAnnotations = function() {
    var a;
    a = 8;
    var b, c, d, e, g, f, h, j, i, k, l;
    b = 0;
    for (c = this.options.annotations.length; b < c; b += 1) switch (k = this.options.annotations[b], k.annotationType) {
        case 0:
            if (null != k.fromItem && null != k.toItem && (e = this._treeItemsByUserId[k.fromItem], g = this._treeItemsByUserId[k.toItem], null != e && null != g)) {
                h = new primitives.orgdiagram.ConnectorAnnotationConfig;
                f = new primitives.common.Connector(this.graphics);
                f.orientationType = this.options.orientationType;
                j = "connectorShapeType labelPlacementType offset lineWidth color lineType labelSize zOrderType".split(" ");
                a = 0;
                for (d = j.length; a < d; a += 1) i = j[a], f[i] = k.hasOwnProperty(i) ? k[i] : h[i];
                f.labelTemplate = this._annotationLabelTemplate;
                f.labelTemplateHashCode = this._annotationLabelTemplateHashCode;
                f.hasLabel = !primitives.common.isNullOrEmpty(k.label);
        ...
        case 1:
            if (null != k.items && 0 < k.items.length) {
                ...
                if (!e.isEmpty()) {
                    f = new primitives.common.Shape(this.graphics);
                    ...
                    f.labelTemplate = this._annotationLabelTemplate;
                    f.labelTemplateHashCode = this._annotationLabelTemplateHashCode;
                    f.hasLabel = null != k.templateName || null != k.label;
                    l = new primitives.common.RenderEventArgs;
                    l.context = k;
                    l.templateName = f.labelTemplate;
...
primitives.orgdiagram.BaseController.prototype._redrawConnectors = function() {
    ...
    if (this._treeItems.hasOwnProperty(this._visualRootItem)) {
        ...
        for (h = 0; h < this._treeLevels.length; h += 1) {
            ...
            c = d.treeItems;
            g = 0;
            for (f = c.length; g < f; g += 1) b = this._treeItems[c[g]], this._redrawConnector(a.hasGraphics, e, b, d)
        }
        b = e.getPolylines();
        g = 0;
        for (f = b.length; g < f; g += 1) c = b[g], 0 < c.segments.length && (a = {
...
primitives.orgdiagram.BaseController.prototype._redrawConnector = function(a, b, c, d) {
    var e, g, f, h, j, i, k, l, m, n = 0,
        p, q = 0 == this.options.connectorType,
        r;
    m = d.connectorShift + d.levelSpace / 2 * (d.childrenConnectorOffset - c.childrenConnectorOffset);
    l = 0 < c.partnerConnectorOffset ? d.connectorShift - d.levelSpace / 2 * (d.partnerConnectorOffset - c.partnerConnectorOffset + 1) : c.connectorPlacement & 4 ? c.actualPosition.bottom() : m;
    1 >= c.partnerConnectorOffset && 0 == c.childrenConnectorOffset ? b.selectPalette(0) : 1 < c.partnerConnectorOffset ?
        b.selectPalette(c.partnerConnectorOffset - 1) : b.selectPalette(d.partnerConnectorOffset + d.childrenConnectorOffset - c.childrenConnectorOffset);
    (-1 > c.parentsConnectionsLeftIndex || 1 < c.parentsConnectionsRightIndex) && this.transform.transformPoints(c.actualPosition.horizontalCenter() + this.options.lineItemsInterval * (c.parentsConnectionsLeftIndex + 1), c.actualPosition.top(), c.actualPosition.horizontalCenter() + this.options.lineItemsInterval * (c.parentsConnectionsRightIndex - 1), c.actualPosition.top(), !0, this, function(a,
        c, d, e) {
        r = b.getPolyline(0).segments;
        r.push(new primitives.common.MoveSegment(a, c));
        r.push(new primitives.common.LineSegment(d, e))
    });
    if (0 < c.visualChildren.length || 0 < c.extraChildren.length) e = 4 === c.actualVisibility && c.id === this._visualRootItem, k = c.actualPosition.horizontalCenter();
    if (1 < c.partners.length || 0 < c.extraPartners.length) {
        g = [];
        d = c.partners;
        for (j = 0; j < d.length; j += 1) f = this._treeItems[d[j]], p = new primitives.orgdiagram.ConnectorPoint(f.actualPosition.horizontalCenter(), f.actualPosition.bottom()), p.isSquared = !0, p.highlightPath = f.partnerHighlightPath, p.connectorStyleType = f.partnerHighlightPath ? 2 : 1, g.push(p);
        d = c.extraPartners;
        for (j = 0; j < d.length; j += 1) f = this._treeItems[d[j]], p = new primitives.orgdiagram.ConnectorPoint(f.actualPosition.horizontalCenter(), f.actualPosition.bottom()), p.isSquared = !0, p.highlightPath = f.partnerHighlightPath, p.connectorStyleType = f.partnerHighlightPath ? 2 : 0, g.push(p);
        0 < g.length && (g.sort(function(a, b) {
            return a.x - b.x
        }), 0 == c.visualChildren.length && (k = (g[0].x + g[g.length - 1].x) / 2), this._drawTopConnectors(b,
            k, l, g, !0))
    }
    if (0 < c.visualChildren.length || 0 < c.extraChildren.length) {
        g = [];
        i = !1;
        d = c.visualChildren;
        for (j = 0; j < d.length; j += 1)
            if (f = this._treeItems[d[j]], h = this._treeLevels[f.level], r = b.getPolyline(f.highlightPath ? 2 : 1).segments, f.connectorPlacement & 8) h = this._treeItems[h.treeItems[f.levelPosition - 1]], this.transform.transformPoints(f.actualPosition.x, f.actualPosition.verticalCenter(), h.actualPosition.right(), f.actualPosition.verticalCenter(), !0, this, function(a, b, c, d) {
                r.push(new primitives.common.MoveSegment(a,
                    b));
                r.push(new primitives.common.LineSegment(c, d))
            });
            else if (f.connectorPlacement & 2) h = this._treeItems[h.treeItems[f.levelPosition + 1]], this.transform.transformPoints(f.actualPosition.right(), f.actualPosition.verticalCenter(), h.actualPosition.x, f.actualPosition.verticalCenter(), !0, this, function(a, b, c, d) {
            r.push(new primitives.common.MoveSegment(a, b));
            r.push(new primitives.common.LineSegment(c, d))
        });
        else if (f.connectorPlacement & 1 && !e) {
            h = !0;
            if (a) switch (f.actualVisibility) {
                case 2:
                case 3:
                    h = q
            }
            p = 0;
            p = new primitives.orgdiagram.ConnectorPoint(f.actualPosition.horizontalCenter() +
                p, f.actualPosition.top());
            p.isSquared = h;
            p.connectorStyleType = f.highlightPath ? 2 : 1;
            g.push(p);
            i = i || p.isSquared
        }
        d = c.extraChildren;
        if (0 < d.length) {
            for (j = 0; j < d.length; j += 1) {
                ...
                f.actualPosition.horizontalCenter() < k ? (p = f.parentsConnectionsRightIndex * this.options.lineItemsInterval, 0 == f.parentsConnectionsRightIndex && (f.parentsConnectionsLeftIndex -= 1), f.parentsConnectionsRightIndex += 1) : (p = f.parentsConnectionsLeftIndex * this.options.lineItemsInterval,
                    0 == f.parentsConnectionsLeftIndex && (f.parentsConnectionsRightIndex += 1), f.parentsConnectionsLeftIndex -= 1);
                p = new primitives.orgdiagram.ConnectorPoint(f.actualPosition.horizontalCenter() + p, f.actualPosition.top());
                p.isSquared = h;
                p.connectorStyleType = f.highlightPath ? 2 : 0;
                g.push(p);
                i = i || p.isSquared
            }
            g.sort(function(a, b) {
        ...
        }!e && 0 < g.length && (n = this._drawTopConnectors(b, k, m, g, i));
        e || this.transform.transformPoints(k, l, k, m, !0, this, function(a, d, e, f) {
            r = b.getPolyline(n).segments;
            this.showElbowDots && 1 <
                c.partners.length && r.push(new primitives.common.DotSegment(a, d, 1, 1, 0.5));
            r.push(new primitives.common.MoveSegment(a, d));
            r.push(new primitives.common.LineSegment(e, f));
            this.showElbowDots && 1 < g.length && r.push(new primitives.common.DotSegment(e, f, 1, 1, 0.5))
        })
    }
};
primitives.orgdiagram.BaseController.prototype._drawTopConnectors = function(a, b, c, d, e) {
    var g, f, h, j, i = [],
        k, l = 0,
        m, n;
    if (e) {
        i = [];
        g = 0;
        for (h = d.length; g < h; g += 1)
            if (j = d[g], j.x < b && !j.isSquared) i.push(j);
            else break;
        h = i.length;
        0 < h && (i[h - 1].connectorStyleType = this._drawAngularConnectors(a, b, c, i, !1), l = Math.max(l, i[h - 1].connectorStyleType));
        i = [];
        for (f = d.length - 1; f >= g; f -= 1)
            if (j = d[f], j.x > b && !j.isSquared) i.push(j);
            else break;
        h = i.length;
        0 < h && (i[h - 1].connectorStyleType = this._drawAngularConnectors(a, b, c, i, !1), l = Math.max(l,
            i[h - 1].connectorStyleType));
        for (i = g; i <= f; i += 1) j = d[i], this.transform.transformPoints(j.x, c, j.x, j.y, !0, this, function(b, c, d, e) {
            m = a.getPolyline(j.connectorStyleType).segments;
            l = Math.max(l, j.connectorStyleType);
            this.showElbowDots && 0 < f - g && m.push(new primitives.common.DotSegment(b, c, 1, 1, 0.5));
            m.push(new primitives.common.MoveSegment(b, c));
            m.push(new primitives.common.LineSegment(d, e))
        });
        e = {};
        n = {};
        for (k in primitives.common.ConnectorStyleType) primitives.common.ConnectorStyleType.hasOwnProperty(k) && (e[primitives.common.ConnectorStyleType[k]] =
            b, n[primitives.common.ConnectorStyleType[k]] = b);
        i = Math.max(0, g - 1);
        for (h = Math.min(f + 1, d.length - 1); i <= h; i += 1) j = d[i], e[j.connectorStyleType] = Math.min(e[j.connectorStyleType], j.x), n[j.connectorStyleType] = Math.max(n[j.connectorStyleType], j.x);
        d = b;
        for (i = 2; 0 <= i; i -= 1) m = a.getPolyline(i).segments, k = e[i], null != k && k < d && (this.transform.transformPoints(k, c, d, c, !0, this, function(a, b, c, d) {
            m.push(new primitives.common.MoveSegment(a, b));
            m.push(new primitives.common.LineSegment(c, d))
        }), d = k), k = n[i], null != k && k > b && (this.transform.transformPoints(k,
            c, b, c, !0, this,
            function(a, b, c, d) {
                m.push(new primitives.common.MoveSegment(a, b));
                m.push(new primitives.common.LineSegment(c, d))
            }), b = k)
    } else l = Math.max(l, this._drawAngularConnectors(a, b, c, d, !0));
    return l
};
primitives.orgdiagram.BaseController.prototype._drawAngularConnectors = function(a, b, c, d, e) {
    var g = null,
        ...
        h, j, i, k = 0,
        g = e ? b : d[f - 1].x;
    j = new primitives.common.Point(g, c);
    for (b = 0; b < f; b += 1) switch (h = d[b], i = a.getPolyline(h.connectorStyleType).segments, k = Math.max(k, h.connectorStyleType), this.transform.transformPoint(g, c, !0, this, function(a, b) {
        ...
        case 1:
            ...
            break;
        case 2:
            h = new primitives.common.Rect(j, h), e ? g > h.x ? this.transform.transform3Points(h.right(), h.verticalCenter(), h.x, h.verticalCenter(), h.x, h.bottom(), !0, this, function(a, b, c, d, e, f) {
                ...
                i.push(new primitives.common.CubicArcSegment(a, b, c, d, e, f))
            }) : g > h.x ? this.transform.transformPoints(h.x, h.y, h.x, h.bottom(), !0, this, function(a, b, c, d) {
...
primitives.orgdiagram.BaseController.prototype._centerOnCursor = function() {
    null !== this._cursorTreeItem && (this.graphics.activate("placeholder", 7), this.transform.transformPoint(this._cursorTreeItem.actualPosition.horizontalCenter() * this.scale, this._cursorTreeItem.actualPosition.verticalCenter() * this.scale, !0, this, function(a, b) {
        this.m_scrollPanel.scrollLeft(a - this.m_scrollPanelRect.horizontalCenter());
        this.m_scrollPanel.scrollTop(b - this.m_scrollPanelRect.verticalCenter())
    }))
};
...
primitives.orgdiagram.BaseController.prototype._getTreeItemForMousePosition = function(a, b) {
    ...
    this.transform.transformPoint(a, b, !1, this, function(a, b) {
        d = 0;
        for (e = this._treeLevels.length; d < e; d += 1)
            if (f = this._treeLevels[d], b > f.topConnectorShift && b <= f.connectorShift) {
                j = h = null;
                k = 0;
                for (g = f.treeItems.length; k < g; k += 1) switch (i = this._treeItems[f.treeItems[k]], i.actualVisibility) {
                    case 1:
                        if (i.actualPosition.contains(a,
                                b)) {
                            c = i;
                            return
                        }
                    case 2:
                    case 3:
                        if (l = Math.abs(i.actualPosition.horizontalCenter() - a), null === j || l < j) j = l, h = i
                }
                c = h;
                break
            }
        ...
        case 1:
            ...
            switch (c.showCallout) {
                ...
                case 1:
                    ...
                    break;
                default:
                    l = this.options.showCallout
            }
            l ? (d = new a.Rect(this.m_scrollPanel.scrollLeft(), this.m_scrollPanel.scrollTop(), Math.min(this.m_scrollPanelRect.width - 25, this.m_placeholderRect.width),
                Math.min(this.m_scrollPanelRect.height - 25, this.m_placeholderRect.height)), this.graphics.activate("placeholder", 7), this.transform.transformRect(b.actualPosition.x, b.actualPosition.y, b.actualPosition.width, b.actualPosition.height, !0, this, function(l, p, q, r) {
                g = new a.Rect(l, p, q, r);
                f = new a.Point(g.horizontalCenter(), g.verticalCenter());
                1 != this._highlightTreeItem.actualVisibility || !d.overlaps(g) ? (i = !a.isNullOrEmpty(c.calloutTemplateName) ? c.calloutTemplateName : !a.isNullOrEmpty(c.templateName) ? c.templateName :
                    ...
                    this.m_calloutShape.pointerWidth = this.options.calloutPointerWidth, this.m_calloutShape.borderColor = this.options.calloutBorderColor, this.m_calloutShape.fillColor = this.options.calloutfillColor, this.m_calloutShape.draw(f, h)) : this.m_calloutPlaceholder.css({
                    display: "none",
                    visibility: "hidden"
                })
            })) : this.m_calloutPlaceholder.css({
        ...
        switch (this.options.pageFitMode) {
            ...
            default:
                ...
                if (!this._checkDiagramSize(b, d) && (e = 0, b = this._setTreeLevelsVisibilityAndPositionTreeItems(c,
                    ...
                    for (f = g = c.length - 1; 1 < g - e;) f = Math.floor((g + e) / 2), b = this._setTreeLevelsVisibilityAndPositionTreeItems(c, f), this._checkDiagramSize(b, d) ? g = f : e = f;
                    g !== f && (b = this._setTreeLevelsVisibilityAndPositionTreeItems(c, g))
                }
        }
        b.width < a.width && (this._stretchToWidth(b.width, a.width), b.width = a.width);
...
primitives.orgdiagram.BaseController.prototype._setOffset = function(a) {
    var b = this._treeLevels[a.level],
        ...
        d, e, g, f, h, j;
    e = a.parentsConnectionsCount * this._itemsInterval[3];
    a.leftPadding = Math.max(c + (0 < b.currentOffset ? c * a.relationDegree * this.options.cousinsIntervalMultiplier : 0), e);
    a.rightPadding = Math.max(c, e);
    ...
    if (0 < a.visualChildren.length) {
        ...
        if (0 < c) this._offsetItemChildren(a, c);
        else if (0 > c && (c = -c, this._offsetItem(a, c), d = null, e = {}, f = null, h = this._getParentItem(a), null !== h)) {
            for (b = h.visualChildren.length - 1; 0 <= b; b -= 1)
                if (j = h.visualChildren[b], j === a) d = [];
                else if (null !== d)
                if (g = this._getGapBetweenSiblings(j, a), e[j.id] = g, 0 < g) d.splice(0, 0, j);
                else {
                    f = j;
                    break
                }
            if (0 < d.length) {
                if (null !== f) {
                    ...
                    b = 1;
                    for (d = g.length; b < d; b += 1) a = g[b - 1], h = g[b], 2 == a.gravity || 1 == h.gravity ? f[f.length - 1].push(h) : f.push([h])
                } else f = [d.slice(0)], f[f.length - 1].push(a);
                if (0 < f.length) {
                    d = f[f.length - 1];
                    for (b = d.length - 2; 0 <= b; b -= 1) a = d[b], g = e[a.id], c = Math.min(g, c), this._offsetItem(a, c), this._offsetItemChildren(a, c)
                }
                h = c / (f.length - 1);
                for (d = f.length - 2; 0 < d; d -= 1) {
                    j = f[d];
                    for (b = j.length - 1; 0 <= b; b -= 1) a = j[b], g = e[a.id], c = Math.min(d * h, Math.min(g, c)), this._offsetItem(a, c), this._offsetItemChildren(a, c)
                }
            }
        }
    }
...
primitives.orgdiagram.BaseController.prototype._getGapBetweenSiblings = function(a, b) {
    var c = null,
        ...
        f, h;
    for (f = 0; f < g && !(h = e[f] - d[f], c = null !== c ? Math.min(c, h) : h, 0 >= h); f += 1);
    return Math.floor(c)
};
...
primitives.orgdiagram.BaseController.prototype._getChildrenOffset = function(a) {
    ...
    if (null === a.visualAggregatorId) {
        ...
        d = null;
        g = 0;
        for (e = a.length; g < e && !(d = this._treeItems[a[g]], d.connectorPlacement & 1); g += 1);
        e = null;
        for (g = a.length - 1; 0 <= g && !(e = this._treeItems[a[g]], e.connectorPlacement & 1); g -= 1);
...
primitives.orgdiagram.BaseController.prototype._offsetItemChildren = function(a, b) {
    ...
    if (0 < c.length) {
        d = null;
        e = 0;
        for (g = c.length; e < g; e += 1) d = this._treeItems[c[e]], d.offset += b, this._offsetItemChildren(d, b);
...
primitives.orgdiagram.BaseController.prototype._recalcItemsSize = function() {
    ...
    for (b = this._treeLevels.length; a < b; a += 1) {
        ...
        f = g.treeItems;
        c = 0;
        for (d = f.length; c < d; c += 1) e = this._treeItems[f[c]], e.setActualSize(g, this.options)
    }
};
primitives.orgdiagram.BaseController.prototype._recalcLevelsDepth = function() {
    var a, b, c, d, e, g, f, h, j, i, k, l, m;
    a = 0;
    for (b = this._treeLevels.length; a < b; a += 1) {
        h = this._treeLevels[a];
        e = h.treeItems;
        c = 0;
    ...
    for (b = this._treeLevels.length; a < b; a += 1) {
        ...
        h.shift = 0;
        h.depth = 0;
        h.partnerConnectorOffset = 0;
        h.childrenConnectorOffset = 0;
        h.actualVisibility = 4;
        e = h.treeItems;
        i = [];
        k = [];
        c = 0;
        for (d = e.length; c < d; c += 1) f = this._treeItems[e[c]], h.depth = Math.max(h.depth, f.actualSize.height),
            h.actualVisibility = Math.min(h.actualVisibility, f.actualVisibility), (0 < f.partners.length || 0 < f.extraPartners.length) && i.push(new primitives.orgdiagram.TreeItemsGroup(f)), 0 < f.extraChildren.length && k.push(new primitives.orgdiagram.TreeItemsGroup(f)), f.connectorPlacement & 1 && (f.parentsConnectionsRightIndex = 1, f.parentsConnectionsLeftIndex = -1);
        if (0 < i.length) {
            c = 0;
            for (d = i.length; c < d; c += 1) {
                l = i[c];
                m = l.treeItem.partners.slice(0).concat(l.treeItem.extraPartners);
                e = 0;
                for (g = m.length; e < g; e += 1) j = this._treeItems[m[e]],
                    j = j.offset + j.actualSize.width / 2, l.startIndex = null != l.startIndex ? Math.min(l.startIndex, j) : j, l.endIndex = null != l.endIndex ? Math.max(l.endIndex, j) : j
            }
            h.partnerConnectorOffset = this._setConnectorsOffset(i, "partnerConnectorOffset")
        }
        if (0 < k.length) {
            c = 0;
            for (d = k.length; c < d; c += 1) {
                l = k[c];
                i = l.treeItem.visualChildren.slice(0).concat(l.treeItem.extraChildren);
                i.push(f.id);
                e = 0;
                for (g = i.length; e < g; e += 1) j = this._treeItems[i[e]], j = j.offset + j.actualSize.width / 2, l.startIndex = null != l.startIndex ? Math.min(l.startIndex, j) : j, l.endIndex =
                    null != l.endIndex ? Math.max(l.endIndex, j) : j
            }
            c = this._setConnectorsOffset(k, "childrenConnectorOffset");
            h.childrenConnectorOffset = c
        }
    }
};
primitives.orgdiagram.BaseController.prototype._setConnectorsOffset = function(a, b) {
    var c = 0,
        d, e, g, f, h, j, i, k = [],
        l, m, n, p, q, r;
    a.sort(function(a, b) {
    ...
    for (h = a.length; f < h; f += 1) {
        g = a[f];
        e = d = 0;
        n = new primitives.orgdiagram.PositionOffset(g.startIndex, d + 1);
        p = new primitives.orgdiagram.PositionOffset(g.endIndex, e);
        i = k.length;
        if (0 < i) {
            l = [];
            r = q = !1;
            for (j = 0; j < i; j += 1) m = k[j], m.position < n.position ? (l.push(m), e = d = m.offset) : m.position < p.position ? (q || (l.push(n), q = !0), d = Math.max(d, m.offset), e = m.offset) : (q || (l.push(n), q = !0), r || (l.push(p), r = !0, n.offset = d + 1, p.offset = e), l.push(m));
            q || (l.push(n), q = !0);
            r || (l.push(p), r = !0, n.offset = d + 1, p.offset = e);
            k = l
        } else k = [n, p];
        g.treeItem[b] = n.offset;
        c = Math.max(c, n.offset)
    }
    return c
};
...
primitives.orgdiagram.BaseController.prototype._readTemplates = function() {
    var a, b;
    this._templates = {};
    a = new primitives.orgdiagram.Template(new primitives.orgdiagram.TemplateConfig);
    a.name = this.widgetEventPrefix + "Template";
    a.createDefaultTemplates(this.options);
    this._templates[a.name] = a;
    for (a = 0; a < this.options.templates.length; a += 1) b = this.options.templates[a], b = new primitives.orgdiagram.Template(b), b.createDefaultTemplates(this.options), this._templates[b.name] = b
};
...
primitives.orgdiagram.BaseController.prototype._onButtonsTemplateRender = function(a, b) {
    ...
    switch (b.renderingMode) {
        case 0:
            for (g = 0; g < this.options.buttons.length; g += 1) d = this.options.buttons[g], e = jQuery('<li data-buttonname="' + d.name + '"></li>').css({
                    position: "absolute",
                    top: c + "px",
                    left: "0px",
                    ...
                    text: d.text,
                    label: d.label
                }), primitives.common.isNullOrEmpty(d.tooltip) ||
                null != e.tooltip && e.tooltip({
                    content: d.tooltip
                }), c += 10 + d.size.height
    }
};
...
primitives.orgdiagram.BaseController.prototype._createVisualTree = function() {
    ...
    if (0 < this._orgItemRoots.length) {
        a =
            this._getNewTreeItem({
                visibility: 4,
                visualChildren: [],
        ...
        b = 0;
        for (c = this._orgItemRoots.length; b < c; b += 1) {
            d = this._orgItemRoots[b];
            d = this._getNewTreeItem({
                itemConfig: d.context,
                orgItem: d,
                connectorPlacement: (d.hideParentConnection ? 0 : 1) | (d.hideChildrenConnection ? 0 : 4),
                visualParentId: a.id
            });
            a.visualChildren.push(d);
            a.logicalChildren.push(d);
            d.logicalParents.push(a.id);
            switch (d.orgItem.itemType) {
                case 2:
                case 5:
                case 1:
                case 4:
                ...
                case 8:
                    ...
                    break;
                default:
                    d.actualItemType = d.orgItem.itemType
            }
            d.visibility = !d.orgItem.isVisible ? 4 : 0;
            this._createVisualTreeItem(d)
        }
        this._treeItemsByUserId.hasOwnProperty(this.options.cursorItem) && (this._cursorTreeItem = this._treeItemsByUserId[this.options.cursorItem], this._cursorTreeItem.isCursor = !0);
        this._treeItemsByUserId.hasOwnProperty(this.options.highlightItem) && (this._highlightTreeItem = this._treeItemsByUserId[this.options.highlightItem]);
...
primitives.orgdiagram.BaseController.prototype._addExtraConnections = function() {
    var a, b, c, d, e, g, f, h, j;
    for (a in this._orgPartners)
        if (this._orgPartners.hasOwnProperty(a) && null != this._orgPartners[a]) {
            c = this._orgPartners[a];
            g = this._treeItemsByUserId[a];
            d = 0;
            for (e = c.length; d < e; d += 1) {
                b = c[d];
                0 == g.partners.length && g.partners.push(g.id);
                f = this._treeItemsByUserId[b];
                g.extraPartners.push(f.id);
                b = 0;
                for (h = g.logicalChildren.length; b < h; b += 1) j = this._treeItems[g.logicalChildren[b]], this._defineLogicalParent(f, j)
            }
        }
    for (a in this._orgChildren)
        if (this._orgChildren.hasOwnProperty(a) &&
            null != this._orgChildren[a]) {
            g = this._treeItemsByUserId[a];
            null != g.relocatedTo && (g = this._treeItems[g.relocatedTo]);
            c = this._orgChildren[a];
            d = 0;
            for (e = c.length; d < e; d += 1) {
                b = c[d];
                j = this._treeItemsByUserId[b];
                g.extraChildren.push(j.id);
                b = 0;
                for (h = g.partners.length; b < h; b += 1) f = this._treeItems[g.partners[b]], this._defineLogicalParent(f, j);
                this._defineLogicalParent(g, j);
                j.parentsConnectionsCount += 1
            }
        }
};
...
primitives.orgdiagram.BaseController.prototype._createVisualTreeItem = function(a) {
        ...
        for (e = g.length; h < e; h += 1)
            if (c = g[h], this.showInvisibleSubTrees || this._hasVisibleChildren(c)) {
                ...
                switch (b.actualItemType) {
                    ...
                    case 6:
                        d = this._treeItems[a.visualParentId];
                        if (a.connectorPlacement & 2) d.visualChildren.splice(j, 0, b), b.connectorPlacement = 6, b.gravity = 2;
                        else if (a.connectorPlacement & 8) d.visualChildren.splice(d.visualChildren.length - i, 0, b), b.connectorPlacement = 12, b.gravity = 1;
                        else {
                            switch (c.adviserPlacementType) {
                                case 2:
    ...
    switch (a.actualItemType) {
        ...
        default:
            if (null !== a.visualParentId) {
                d = this._treeItems[a.visualParentId];
                for (h = j; h < d.visualChildren.length - i; h += 1)
    ...
    h = 0;
    for (e = f.length; h < e; h += 1) this._createVisualTreeItem(f[h]);
    if (null !== a.visualAggregatorId && (e = this._treeItems[a.visualAggregatorId], 0 < e.visualChildren.length && (i = this._getAssitantsDepth(a), 1 < i)))
    ...
    for (e = c.length; h < e; h += 1) {
        i = c[h];
        f = g[h] = 0;
        for (j = i.length; f < j; f += 1) g[h] = Math.max(g[h], this._getItemDepth(i[f]))
    }
    h = 0;
    for (e = g.length; h < e; h += 1)
        if (c = g[h], 1 < c) {
            f = 0;
            for (j = d[h].length; f < j; f += 1)
                if (k = d[h][f], 0 < k.visualChildren.length)
                    for (i = c; 1 < i;) k = this._createNewVisualAggregator(k), i -= 1
        }
...
primitives.orgdiagram.BaseController.prototype._layoutPartners = function(a, b) {
    ...
    if (1 < b.length) {
        ...
        g = g.concat(d.visualChildren.slice(0));
        d = d.visualChildren.length = 0;
        for (e = b.length; d < e; d += 1) c = b[d], f = this._getAdvisersDepth(c), c = this._getItemDepth(c), h = Math.max(Math.max(h, c), f);
        d = 0;
        ...
        if (0 <
            ...
            d = 0;
            for (e =
                g.length; d < e; d += 1) h = g[d], h.visualParentId = i.id;
            d = 0;
            for (e = b.length; d < e; d += 1)
                if (c = b[d], c.id != a.id) {
                    g = 0;
                    for (f = a.logicalChildren.length; g < f; g += 1) switch (h = a.logicalChildren[g], h.actualItemType) {
                        case 5:
                        case 2:
                        case 4:
                        case 1:
...
primitives.orgdiagram.BaseController.prototype._defineLogicalParent = function(a, b) {
    var c = [],
        d = [],
        e, g = [],
        f, h;
    if (4 === a.visibility)
        for (d = d.concat(a.logicalParents); 0 < d.length;) {
            f = 0;
            for (h = d.length; f < h; f += 1) e = this._treeItems[d[f]], 4 === e.visibility ? g = g.concat(e.logicalParents) : c.push(e);
            d = g;
            g = []
        }
    0 == c.length && c.push(a);
    f = 0;
    for (h = c.length; f < h; f += 1) e = c[f], e.logicalChildren.push(b), b.logicalParents.push(e.id)
};
...
primitives.orgdiagram.BaseController.prototype._layoutChildren = function(a, b, c, d) {
    ...
    switch (b) {
        case 2:
            0 < e.visualChildren.length && (this._treeItems[e.visualChildren[0]].relationDegree =
                1);
            break;
        case 3:
            if (3 < e.visualChildren.length) {
                ...
                for (l = 0; l < k; l += 1) {
                    ...
                    for (m = 0; m < i; m += 1) {
                        ...
                        f = this._getMatrixItem(a, 2 * l + 1, m, j);
                        void 0 === c[m] && (c[m] = [], d[m] = []);
                        null !== b && (0 == l && (b.relationDegree = 1), g.visualChildren.push(b), b.visualParentId = g.id, b.connectorPlacement = 6, b.gravity = 2, d[m].push(b));
                        if (null !==
                            b || null !== f) h = this._getNewTreeItem({
                            visibility: 4,
                            visualParentId: g.id,
                            connectorPlacement: 5
                        }), g.visualChildren.push(h), g.visualAggregatorId = h.id, c[m].push(h);
                        null !== f && (g.visualChildren.push(f), f.visualParentId = g.id, f.connectorPlacement = 12, f.gravity = 1, d[m].push(f));
                        g = h
                    }
                }
        ...
        case 1:
            a = e.visualChildren.slice(0);
            f = e.visualChildren.length = 0;
            for (j = a.length; f < j; f += 1) {
                b = a[f];
                ...
                switch (g) {
                    case 2:
                        ...
                        break;
                    case 3:
                        e.visualChildren.push(h), e.visualChildren.push(b), b.connectorPlacement = 12, b.gravity = 1
                }
                c[f] = [h];
                d[f] = [b];
                e = h
    ...
    for (e = a.length - 1; 0 <= e; e -= 1)
        if (d = a[e], null === c) {
            if (d === b) {
                ...
                f[b] = !0;
                d = 0;
                for (g = b.logicalChildren.length; d < g; d += 1) f[b.logicalChildren[d]] = !0
            }
        } else if (f.hasOwnProperty(d)) {
        d = 0;
        for (g = b.logicalChildren.length; d < g; d += 1) f[b.logicalChildren[d]] = !0
    } else {
        c = e;
    ...
    for (g = a.length; e < g; e += 1)
        if (d = a[e], null === c) {
            if (d === b) {
                ...
                h[b] = !0;
                d = 0;
                for (f = b.logicalChildren.length; d < f; d += 1) h[b.logicalChildren[d]] = !0
            }
...
primitives.orgdiagram.BaseController.prototype._readVisualTree = function(a, b) {
    ...
    c = a.orgItem;
    null !== c && (d = this._templates[c.templateName], a.template = void 0 !== d ? d : this._defaultTemplate, a.actualHasSelectorCheckbox = this._getSelectionVisibility(a.isCursor, c.hasSelectorCheckbox, this.options.hasSelectorCheckbox), a.actualHasButtons = 0 < this.options.buttons.length &&
        this._getSelectionVisibility(a.isCursor, c.hasButtons, this.options.hasButtons));
    c = 0;
...
primitives.orgdiagram.BaseController.prototype._showSelectedItems = function() {
    ...
    for (c = this.options.selectedItems.length; b < c; b += 1)
        if (a = this._treeItemsByUserId[this.options.selectedItems[b]],
            ...
            case 1:
                g = this._getAllLogicalParents(a);
                d = 0;
                for (a = g.length; d < a; d += 1) e = g[d], 0 === e.visibility && (e.visibility = 1)
        }
};
primitives.orgdiagram.BaseController.prototype._getAllLogicalParents = function(a) {
    for (var b = [], c = [], d = [], e, g, c = c.concat(a.logicalParents); 0 < c.length;) {
        e = 0;
        for (g = c.length; e < g; e += 1) a = this._treeItems[c[e]], b.push(a), d = d.concat(a.logicalParents);
        c = d;
        d = []
    }
    return b
...
primitives.orgdiagram.BaseController.prototype._showCursorNeigbours = function() {
    ...
    if (null !== this._cursorTreeItem) {
        ...
        for (b = this._cursorTreeItem.logicalParents.length; a <
            b; a += 1) {
            g = this._treeItems[this._cursorTreeItem.logicalParents[a]];
            c = 0;
            for (d = g.logicalChildren.length; c < d; c += 1) e = g.logicalChildren[c], 0 === e.visibility && (e.visibility = 1)
        }
    }
};
...
primitives.famdiagram.Controller = function() {
    ...
    this.options.highlightLinesType = 0;
    this.partnersToAlign = []
};
primitives.famdiagram.Controller.prototype = new primitives.orgdiagram.BaseController;
primitives.famdiagram.Controller.prototype._getEventArgs = function(a, b, c) {
    var d = new primitives.famdiagram.EventArgs,
        e, g;
    null != a && null != a.itemConfig.id && (d.oldContext = this._treeItemConfigs[a.itemConfig.id]);
    if (null != b && null != b.itemConfig.id) {
        d.context = this._treeItemConfigs[b.itemConfig.id];
        if (null != b.itemConfig.parents) {
            a = 0;
            for (e = b.itemConfig.parents.length; a < e; a += 1) g = this._treeItemConfigs[b.itemConfig.parents[a]], null != g && d.parentItems.push(g)
        }
...
primitives.famdiagram.Controller.prototype._createOrgTree = function() {
    ...
    if (0 < this.options.items.length) {
        a = 0;
        for (b = this.options.items.length; a <
            b; a += 1) d = this.options.items[a], null != d && (this._treeItemConfigs[d.id] = d, f = new primitives.famdiagram.FamilyItem, f.id = d.id, f.itemConfig = d, this._famItems[f.id] = f, this._famItemsNonExtracted[f.id] = f, this.maximumFamItemId = Math.max(this.maximumFamItemId, d.id));
        for (c in this._famItems)
            if (this._famItems.hasOwnProperty(c)) {
                f = this._famItems[c];
                f.logicalParents = null != f.itemConfig.parents ? f.itemConfig.parents.slice(0) : [];
                e = {};
                a = 0;
                for (b = f.logicalParents.length; a < b; a += 1) d = f.logicalParents[a], this._famItems.hasOwnProperty(d) &&
                    d != f.id && !e.hasOwnProperty(d) ? (this._famItems[d].logicalChildren.push(f.id), e[d] = !0) : f.logicalParents.splice(primitives.common.indexOf(f.logicalParents, d), 1)
            }
        a = 0;
        for (b = this.options.items.length; a < b; a += 1) d = this.options.items[a], f = this._famItems[d.id], null == f.level && (f.level = 0, this._sortItemsBylevels(f));
        k = [];
        a = c = h = 0;
        for (b = this.options.items.length; a < b; a += 1) d = this.options.items[a], f = this._famItems[d.id], h = Math.min(h, f.level), c = Math.max(c, f.level), null == k[f.level] ? k[f.level] = [d.id] : k[f.level].push(d.id);
        b = {};
        for (a = c; a >= h; a -= 1) {
            l = k[a];
            c = 0;
            for (d = l.length; c < d; c += 1) {
                e = l[c];
                f = this._famItems[e];
                0 < f.logicalChildren.length && (e = b[e], f.level < e - 1 && (f.level = e - 1));
                e = 0;
                for (g = f.logicalParents.length; e < g; e += 1) i = f.logicalParents[e], b[i] = b.hasOwnProperty(i) ? Math.min(b[i], f.level) : f.level
            }
        }
        a = 0;
        for (b = this.options.items.length; a < b; a += 1) {
            d = this.options.items[a];
            f = this._famItems[d.id];
            k = f.logicalChildren.slice(0);
            c = 0;
            for (d = k.length; c < d; c += 1)
                if (h = this._famItems[k[c]], f.level + 1 < h.level) {
                    m = h.logicalParents;
                    e = 0;
                    for (g = h.logicalParents.length; e <
                        g; e += 1) i = this._famItems[h.logicalParents[e]], l = primitives.common.indexOf(i.logicalChildren, h.id), i.logicalChildren.splice(l, 1);
                    h.logicalParents = [];
                    l = [];
                    for (e = f.level + 1; e < h.level; e += 1) this.maximumFamItemId += 1, g = new primitives.famdiagram.FamilyItem, g.id = this.maximumFamItemId, g.level = e, g.isVisible = !1, this._famItems[g.id] = g, this._famItemsNonExtracted[g.id] = g, l[e] = g, m.push(g.id);
                    l[h.level] = h;
                    e = 0;
                    for (g = m.length; e < g; e += 1) i = this._famItems[m[e]], i.level <= f.level ? (l[f.level + 1].logicalParents.push(i.id), i.logicalChildren.push(l[f.level +
                        1].id)) : (l[i.level + 1].logicalParents.push(i.id), i.logicalChildren.push(l[i.level + 1].id))
                }
            for (k = f.logicalChildren.slice(0); 0 < k.length;) {
                m = {};
                f = [];
                c = 0;
                for (d = k.length; c < d; c += 1)
                    if (h = this._famItems[k[c]], !1 == h.isVisible && (e = h.logicalParents.sort().toString(), !primitives.common.isNullOrEmpty(e)))
                        if (m.hasOwnProperty(e)) {
                            n = m[e];
                            e = 0;
                            for (g = h.logicalParents.length; e < g; e += 1) i = this._famItems[h.logicalParents[e]], l = primitives.common.indexOf(i.logicalChildren, h.id), i.logicalChildren.splice(l, 1);
                            h.logicalParents = [];
                            e = 0;
                            for (g = h.logicalChildren.length; e < g; e += 1) i = this._famItems[h.logicalChildren[e]], l = primitives.common.indexOf(i.logicalParents, h.id), i.logicalParents.splice(l, 1), i.logicalParents.push(n.id), n.logicalChildren.push(i.id);
                            delete this._famItems[h.id];
                            delete this._famItemsNonExtracted[h.id];
                            f = f.concat(n.logicalChildren.slice(0))
                        } else m[e] = h;
                k = [];
                c = {};
                e = 0;
                for (g = f.length; e < g; e += 1) l = f[e], c.hasOwnProperty(l) || (k.push(l), c[l] = !0)
            }
        }
        this.properties = "title description image itemTitleColor groupTitle groupTitleColor isVisible hasSelectorCheckbox hasButtons templateName showCallout calloutTemplateName label showLabel labelSize labelOrientation labelPlacement".split(" ");
        ...
        if (0 < this._families.length) {
            ...
            for (b = this._families.length; a < b; a += 1) {
                e = this._families[a];
                c = 0;
                for (d = e.links.length; c < d; c += 1) g = e.links[c], h = this._famItems[g.fromItem].familyId, i = this._famItems[g.toItem].familyId, h != i && (j.hasOwnProperty(h) || (j[h] = {}), j[h].hasOwnProperty(i) || (j[h][i] =
                    0), j[h][i] += 1, j.hasOwnProperty(i) || (j[i] = {}), j[i].hasOwnProperty(h) || (j[i][h] = 0), j[i][h] += 1), this._families[i].backLinks.push(new primitives.famdiagram.FamLink(g.toItem, g.fromItem))
            }
            for (; f.length < this._families.length;) {
                a = 0;
                for (b = this._families.length; a < b; a += 1)
                    if (e = this._families[a], !k.hasOwnProperty(e.id))
                        if (h = this._findMaximumSpanningTree(j, e.id), h.hasOwnProperty(e.id)) {
                            this._countNumberOfSubFamilies(e.id, h);
                            f.push(e.id);
                            k[e.id] = !0;
                            i = h[e.id];
                            c = 0;
                            for (d = i.length; c < d; c += 1) {
                                l = this._getFamilyAndItsSubFamilies(i[c],
                                    h);
                                e = 0;
                                for (g = l.length; e < g; e += 1) m = l[e], f.push(m), k[m] = !0
                            }
                        } else f.push(e.id), k[e.id] = !0
            }
        }
        this.maximumFamItemId += 1;
        k = this._createOrgItem(this.maximumFamItemId, null, null, this.minimumLevel - 1, null);
        k.hideParentConnection = !0;
        k.hideChildrenConnection = !0;
        k.title = "root";
        k.isVisible = !1;
        this._orgItemRoots.push(k);
        d = {};
        a = 0;
        for (b = f.length; a < b; a += 1) {
            e = this._families[f[a]];
            h = {};
            i = k;
            l = 0;
            j = e.links.concat(e.backLinks);
            for (c = 0; c < j.length; c += 1)
                if (g = j[c], m = this._orgItems[g.toItem], !0 == d[m.familyId]) {
                    for (g = e.items[0]; m.level >=
                        g.level;) m = this._orgItems[m.parent];
                    h[m.id] = h.hasOwnProperty(m.id) ? h[m.id] + 1 : 1;
                    l < h[m.id] && (i = m, l = h[m.id])
                }
        ...
        this._sumOrgItems();
        this._balanceChildrenForItem(a, this._orgItemRoots[0]);
        a = 0;
        for (b = this.partnersToAlign.length; a < b; a += 1) c = this.partnersToAlign[a], j = this._orgItems[c.parent], c.adviserPlacementType = 0 < j.totalRightLink - j.totalLeftLink ? 3 : 2
    }
};
primitives.famdiagram.Controller.prototype._sumOrgItems = function() {
    ...
    for (g = this.maximumLevel; g >= this.minimumLevel; g -= 1)
        if (a = c[g], null != a) {
            d = 0;
            for (e = a.length; d < e; d += 1) b = a[d],
                null != b.parent && (this._orgItems[b.parent].weight += b.weight)
        }
};
primitives.famdiagram.Controller.prototype._balanceChildrenForItem = function(a, b) {
    var c, d, e, g, f, h, j, i, k, l, m, n, p, q = [b],
        r, t = [],
        s, u;
    for (b.childIndex = 0; 0 < q.length;) {
        j = 0;
        for (i = q.length; j < i; j += 1)
            if (r = q[j], c = {}, this._orgItemChildren.hasOwnProperty(r.id)) {
                s = this._orgItemChildren[r.id];
                h = null;
                u = [];
                if (0 < s.length) {
                    d = 0;
                    for (e = s.length; d < e; d += 1) switch (k = s[d], k.itemType) {
                        case 0:
                            null == h && (h = k);
                            if (a.hasOwnProperty(k.id)) {
                                m = a[k.id];
                                g = 0;
                                for (f = m.length; g < f; g += 1) l = m[g], n = l.fromParent, p = l.toParent, l.commonParent == r.id ?
                                    n != p && (c.hasOwnProperty(n) || (c[n] = {}), c[n].hasOwnProperty(p) || (c[n][p] = 0), c[n][p] += 1) : this._orgItems[n].childIndex < this._orgItems[p].childIndex ? k.rightLink += 1 : k.leftLink += 1
                            }
                            0 < d && (c.hasOwnProperty(h.id) || (c[h.id] = {}), c[h.id].hasOwnProperty(k.id) || (c[h.id][k.id] = 0), c.hasOwnProperty(k.id) || (c[k.id] = {}), c[k.id].hasOwnProperty(h.id) || (c[k.id][h.id] = 0));
                            break;
                        default:
                            u.push(k)
                    }
                    if (null != h) {
                        d = this._findMaximumSpanningTree(c, h.id);
                        this._sumUpOrgItemsInSpanningTree(h, d);
                        d = this._sortOrgItemsInSpanningTree(h,
                            d, c, 0, !1);
                        c = 0;
                        for (h = d.length; c < h; c += 1) e = d[c], e.childIndex = c, u.push(e)
                    }
                    this._orgItemChildren[r.id] = u
                }
                t = t.concat(s)
            }
        q = t;
...
primitives.famdiagram.Controller.prototype._sortOrgItemsInSpanningTree = function(a, b, c, d, e) {
    var d = [],
        g = [],
        f, h, j, i, k;
    f = b[a.id];
    if (null != f) {
        h = 0;
        for (j = f.length; h < j; h += 1) i = this._orgItems[f[h]], g.push(i), i.connections = c[i.id][a.id];
        g.sort(function(a, b) {
            var c;
            c = a.connections - Math.abs(a.leftLink - a.rightLink);
            return b.connections - Math.abs(b.leftLink - b.rightLink) - c
        });
        d.push(a);
        e = a.rightLink - a.leftLink + (e ? -1 : 1) * a.connections;
        h = f = 0;
        for (j = g.length; h < j; h += 1) i = g[h], k = i.totalRightLink - i.totalLeftLink, k * a.weight <
            e * i.totalWeight || k * a.weight == e * i.totalWeight && 0 < f ? (i = this._sortOrgItemsInSpanningTree(i, b, c, i.connections, !1), d = i.concat(d), f -= 1) : (i = this._sortOrgItemsInSpanningTree(i, b, c, i.connections, !0), d = d.concat(i), f += 1)
    } else d = [a];
    return d
};
primitives.famdiagram.Controller.prototype._sumUpOrgItemsInSpanningTree = function(a, b) {
    var c, d, e, g;
    a.totalWeight = a.weight;
    a.totalLeftLink = a.leftLink;
    a.totalRightLink = a.rightLink;
    c = b[a.id];
    if (null != c) {
        d = 0;
        for (e = c.length; d < e; d += 1) g = this._orgItems[c[d]], this._sumUpOrgItemsInSpanningTree(g, b), a.totalWeight += g.totalWeight, a.totalLeftLink += g.totalLeftLink, a.totalRightLink += g.totalRightLink
    }
};
primitives.famdiagram.Controller.prototype._getExtraGravity = function() {
    ...
    for (a in this._orgChildren)
        if (this._orgChildren.hasOwnProperty(a)) {
            b = this._orgItems[a];
            g = this._orgChildren[a];
            d = 0;
            for (e = g.length; d < e; d += 1) f = this._orgItems[g[d]], 0 != f.itemType && (this.partnersToAlign.push(f), f = this._orgItems[f.parent]), h = this._orgItems[f.parent], this._addExtraGravitiesForConnection(c, h, f, b)
        }
    for (a in this._orgPartners)
        if (this._orgPartners.hasOwnProperty(a)) {
            b = this._orgItems[a];
            g = this._orgPartners[a];
            d = 0;
            for (e = g.length; d < e; d += 1) f = this._orgItems[g[d]], this._addExtraGravitiesForConnection(c, f, null, b)
        }
    return c
};
primitives.famdiagram.Controller.prototype._addExtraGravitiesForConnection = function(a, b, c, d) {
    var e = new primitives.famdiagram.ExtraGravity,
        g = new primitives.famdiagram.ExtraGravity;
    this._addExtraGravityForItem(a, b.id, e);
    this._addExtraGravityForItem(a, d.id, g);
    null != c && this._addExtraGravityForItem(a, c.id, e);
    for (c = d; b.parent != c.parent;) b = this._orgItems[b.parent], c = this._orgItems[c.parent], this._addExtraGravityForItem(a, b.id, e), this._addExtraGravityForItem(a, c.id, g);
    e.commonParent = b.parent;
    e.fromParent =
        b.id;
    e.toParent = c.id;
    g.commonParent = b.parent;
    g.fromParent = c.id;
    g.toParent = b.id
};
primitives.famdiagram.Controller.prototype._addExtraGravityForItem = function(a, b, c) {
    a.hasOwnProperty(b) ? a[b].push(c) : a[b] = [c]
};
primitives.famdiagram.Controller.prototype._getFamilyAndItsSubFamilies = function(a, b) {
    ...
    if (null != d) {
        e = 0;
        for (g = d.length; e < g; e += 1) f = d[e], c = c.concat(this._getFamilyAndItsSubFamilies(f, b))
    }
    return c
};
primitives.famdiagram.Controller.prototype._countNumberOfSubFamilies = function(a, b) {
    ...
    if (null != g) {
        d = 0;
        for (e = g.length; d < e; d += 1) h = g[d], f[h] = this._countNumberOfSubFamilies(h, b), c.familyPriority += f[h];
        g.sort(function(a, b) {
            return f[a] - f[b]
        })
    }
...
primitives.famdiagram.Controller.prototype._findMaximumSpanningTree = function(a, b) {
    var c = {},
        d = {},
        e, g = [],
        f, h = {},
    ...
    for (h[b] = null; 0 < j;) {
        ...
        for (e in d)
            if (d.hasOwnProperty(e)) {
                m = a[e];
                f = !1;
                for (n in m) m.hasOwnProperty(n) && !h.hasOwnProperty(n) && (p = m[n], f = !0, p > k && (i = n, k = p, l = e));
                f || g.push(e)
            }
        if (null == i) break;
        else d[i] = !0, j += 1, h[i] = l, c.hasOwnProperty(l) || (c[l] = []), c[l].push(i);
        f = 0;
        for (i = g.length; f < i; f += 1) delete d[g[f]], j -= 1
    }
    return c
};
primitives.famdiagram.Controller.prototype._attachFamilyToOrgChart = function(a, b) {
    var c, d = b.items[0],
        e = null,
        e = a;
    for (c = a.level + 1; c < d.level; c += 1) this.maximumFamItemId += 1, e = this._createOrgItem(this.maximumFamItemId, e.id, null, c, null), e.title = "shift", e.isVisible = !1, e.hideParentConnection = !0, e.hideChildrenConnection = !0, b.items.push(e);
    d.parent = e.id;
...
primitives.famdiagram.Controller.prototype._extractOrgChart = function(a, b) {
    ...
    for (e = this._extractChildren(a, b); 0 < e.length;) {
        g = [];
        c = 0;
        for (d = e.length; c < d; c += 1) f = e[c], g = g.concat(this._extractChildren(a, f));
        e = g
    }
};
primitives.famdiagram.Controller.prototype._extractChildren = function(a, b) {
    ...
    if (null != this.itemByChildrenKey[d]) {
        ...
        d = 0;
        for (e = b.logicalChildren.length; d < e; d += 1) g = b.logicalChildren[d], a.links.push(new primitives.famdiagram.FamLink(b.id, g))
    } else {
...
primitives.famdiagram.Controller.prototype._createOrgItem = function(a, b, c, d, e) {
    ...
    g.level = d;
    a = 0;
    for (b = this.properties.length; a < b; a += 1) c = this.properties[a], g[c] = null != e && void 0 !== e[c] ? e[c] : this.defaultItemConfig[c];
    this._adoptOrgItem(g);
    return g
};
...
primitives.famdiagram.Controller.prototype._compareArrays = function(a, b) {
    var c = !0,
        d, e;
    ...
    for (h = this.maximumLevel; h >= this.minimumLevel; h -=
        ...
        if (e = d[h], null != e) {
            ...
            for (f = e.length; g < f; g += 1) {
                ...
                k[b.id][b.id] = !0;
                j = 0;
                for (i = b.logicalParents.length; j < i; j += 1)
                    if (n = b.logicalParents[j], this._famItemsNonExtracted.hasOwnProperty(n) && (k.hasOwnProperty(n) || (k[n] = {}), k[n][b.id] = !0, k.hasOwnProperty(b.id)))
...
primitives.famdiagram.Controller.prototype._sortItemsBylevels = function(a) {
    for (var b, c, d, e, g, f = this._getParentEdges(a), h = this._getChildrenEdges(a); 0 < f.length || 0 < h.length;) {
        e = [];
        g = [];
        a = 0;
        for (b = h.length; a < b; a += 1) c = this._famItems[h[a].parent], d = this._famItems[h[a].child], null == d.level ? (d.level = this._getMaximumLevel(d.logicalParents) + 1, e = e.concat(this._getParentEdges(d)), g = g.concat(this._getChildrenEdges(d))) : d.level <= c.level && this._shiftChartItem(d, c.level - d.level + 1);
        a = 0;
        for (b = f.length; a < b; a += 1) c = this._famItems[f[a].parent],
            d = this._famItems[f[a].child], null == c.level ? (c.level = this._getMinimumLevel(c.logicalChildren) - 1, e = e.concat(this._getParentEdges(c)), g = g.concat(this._getChildrenEdges(c))) : d.level <= c.level && this._shiftChartItem(d, c.level - d.level + 1);
        f = e;
        h = g
    }
};
primitives.famdiagram.Controller.prototype._getParentEdges = function(a) {
    var b, c, d, e = [];
    b = 0;
    for (c = a.logicalParents.length; b < c; b += 1) d = a.logicalParents[b], e.push(new primitives.famdiagram.EdgeItem(d, a.id));
    return e
};
primitives.famdiagram.Controller.prototype._getChildrenEdges = function(a) {
    var b, c, d, e = [];
    b = 0;
    for (c = a.logicalChildren.length; b < c; b += 1) d = a.logicalChildren[b], e.push(new primitives.famdiagram.EdgeItem(a.id, d));
    return e
};
var depth = 0;
primitives.famdiagram.Controller.prototype._shiftChartItem = function(a, b) {
    var c, d, e;
    a.level += b;
    depth += 1;
    if (0 < b) {
        c = 0;
        for (d = a.logicalChildren.length; c < d; c += 1) e = this._famItems[a.logicalChildren[c]], null != e.level && e.level <= a.level && this._shiftChartItem(e, a.level - e.level + 1)
    } else {
        c = 0;
        for (d = a.logicalParents.length; c < d; c += 1) e = this._famItems[a.logicalParents[c]], null != e.level && e.level >= a.level && this._shiftChartItem(e, a.level - e.level - 1)
    }
    depth -= 1
};
primitives.famdiagram.Controller.prototype._getMaximumLevel = function(a) {
    var b, c, d, e;
    b = 0;
    for (c = a.length; b < c; b += 1) e = this._famItems[a[b]], null != e.level && (d = null != d ? Math.max(d, e.level) : e.level);
    return d
};
primitives.famdiagram.Controller.prototype._getMinimumLevel = function(a) {
    var b, c, d, e;
    b = 0;
    for (c = a.length; b < c; b += 1) e = this._famItems[a[b]], null != e.level && (d = null != d ? Math.min(d, e.level) : e.level);
    return d
};
...
primitives.orgdiagram.Config = function(a) {
    ...
    //this.linesColor = "#c0c0c0";
    //this.linesWidth = 10;
	this.linesColor = "#565656";
	this.linesWidth = 5;
	this.arrowsDirection = "Children";
    this.linesType = 0;
...
primitives.orgdiagram.Controller.prototype._getEventArgs = function(a, b, c) {
    var d = new primitives.orgdiagram.EventArgs,
        e;
    null != a && null != a.itemConfig.id && (d.oldContext = this._treeItemConfigs[a.itemConfig.id]);
    null != b && null != b.itemConfig.id && (d.context = this._treeItemConfigs[b.itemConfig.id], null !== b.itemConfig.parent && (d.parentItem = this._treeItemConfigs[b.itemConfig.parent]), e = this.m_placeholder.offset(), a = this.element.offset(), d.position = (new primitives.common.Rect(b.actualPosition)).translate(e.left, e.top).translate(-a.left, -a.top));
    null != c && (d.name = c);
    return d
};
primitives.orgdiagram.Controller.prototype._createOrgTree = function() {
    ...
    if (null != this.options.items && 0 < this.options.items.length) {
        h = "title description image itemTitleColor groupTitle groupTitleColor isVisible hasSelectorCheckbox hasButtons itemType adviserPlacementType childrenPlacementType templateName showCallout calloutTemplateName label showLabel labelSize labelOrientation labelPlacement".split(" ");
        j =
...
primitives.orgdiagram.OrgItem = function() {
    ...
    this.connections = 0;
    this.weight = 1;
    this.totalRightLink = this.totalLeftLink = this.totalWeight = this.rightLink = this.leftLink = 0
};
...
primitives.orgdiagram.PositionOffset = function(a, b) {
    this.position = a;
    this.offset = b
};
primitives.orgdiagram.Template = function(a) {
    this.widgetEventPrefix = "orgdiagram";
    this.templateConfig = a;
    this.name = a.name;
    this.itemSize = a.itemSize;
    this.itemBorderWidth = a.itemBorderWidth;
    this.minimizedItemSize = a.minimizedItemSize;
    ...
    this.highlightPadding = a.highlightPadding;
    this.highlightBorderWidth = a.highlightBorderWidth;
    this.cursorPadding = a.cursorPadding;
    this.cursorBorderWidth = a.cursorBorderWidth;
    this.itemTemplate = a.itemTemplate;
    this.highlightTemplate = a.highlightTemplate;
    this.cursorTemplate = a.cursorTemplate;
...
primitives.orgdiagram.Template.prototype.createDefaultTemplates = function(a) {
    primitives.common.isNullOrEmpty(this.itemTemplate) && (this.itemTemplate = this._getDefaultItemTemplate(a), this.itemTemplateRenderName = "onDefaultTemplateRender");
    this.itemTemplateHashCode = primitives.common.hashCode(this.itemTemplate);
    primitives.common.isNullOrEmpty(this.cursorTemplate) && (this.cursorTemplate = this._getDefaultCursorTemplate(a), this.cursorTemplateRenderName = null);
...
primitives.orgdiagram.TreeItem = function(a) {
    ...
    this.visualChildren = [];
    this.relocatedTo = this.visualAggregatorId = null;
    this.partners = [];
    this.extraPartners = [];
    this.extraChildren = [];
    this.parentsConnectionsRightIndex = this.parentsConnectionsLeftIndex = this.parentsConnectionsCount = this.childrenConnectorOffset = this.partnerConnectorOffset = 0;
    this.visibility = 1;
    this.levelPosition = this.level = this.template =
        null;
    ...
    this.actualHasGroupTitle = this.actualHasButtons = this.actualHasSelectorCheckbox = this.isSelected = this.isCursor = !1;
...
primitives.orgdiagram.TreeItemsGroup = function(a) {
    this.treeItem = a;
    this.endIndex = this.startIndex = null
};
...
primitives.orgdiagram.TreeLevel = function(a) {
    ...
    this.childrenConnectorOffset = this.partnerConnectorOffset = this.levelSpace = this.connectorShift = this.topConnectorShift = this.currentOffset = this.nextLevelShift = this.depth = this.shift = 0;
    this.treeItems = [];
    this.labels = [];
