...
(function( $ ) {
    ...
    var methods = {
        ...
        create : function() {
			...
			//note-abd
			$('#'+$.fn.jexcel.current+'.jexcel').css( "overflow", "visible" );
            ...
            if (! $.fn.jdropdown.onclick) {
                ...
                $.fn.jdropdown.onkeydown = function(e) {
                    ...
                    if ($.fn.jdropdown.current) {
                        ...
                        index= $.fn.jdropdown.currentIndex;
        ...
        updateCursorPosition : function(index) {
            if ($.fn.jdropdown.current) {
                ...
                // Update scroll
                // noteone-comment update scroll top

                /*var container = $(this).find('.jdropdown-content').scrollTop();
                var element = "";
                if(typeof $.fn.jdropdown.currentIndex == "undefined")
                {
                    // console.log("a");
                }
                else
                {
                    // if(typeof $(dropDownOptions[$.fn.jdropdown.currentIndex]) == "undefined")
                    if ( $(dropDownOptions[$.fn.jdropdown.currentIndex]) != undefined) 
                    {
                        // console.log("b");
                    }
                    else
                    element = $(dropDownOptions[$.fn.jdropdown.currentIndex]).position().top;
                }
        ...
        find : function(str) {
            // noteone-reset data
            // untuk reset apabila data kosong
            var multipledata= $.fn.jdropdown.configuration[$.fn.jdropdown.current].multiple;
            if ( multipledata == true) {}
            else
                $(this).find('.jdropdown-selected').removeClass('jdropdown-selected');

            var itens = $(this).find('.jdropdown-item');

            // Append options
            $.each(itens, function(k, v) {
                // noteone kondisi pencarian
                // if (str == null || $(v).hasClass('jdropdown-selected') || $(v).html().toLowerCase().indexOf(str.toLowerCase()) != -1) {
                if (str == null || $(v).html().toLowerCase().indexOf(str.toLowerCase()) != -1) {
                    $(v).show();
                } else {
                    $(v).hide();
                }
        ...
        close : function() {
            if ($.fn.jdropdown.current) {
                ...
                //note-abd
				$('#'+$.fn.jexcel.current+'.jexcel').css( "overflow", "auto" );
            }
        },
