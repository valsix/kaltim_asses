...
var methods = {
    ...
    createTable : function() {
        ...
        if (! $('.jexcel_corner').length) {
            ...
            $.fn.jexcel.mouseDownControls = function (e) {
                ...
                // kuncinoteone
                // console.log("noteone-mouseDownControls");
                                    ...
                                    if ($(e.target).is('.jexcel_label')) {
                                        ...
                                        if ($.fn.jexcel.defaults[$.fn.jexcel.current].rowDrag == true && $(e.target).outerWidth() - e.offsetX < 8) {
                                            ...
                                            if ($.fn.jexcel.selectedRow && (e.shiftKey || e.ctrlKey)) {
                                                ...
                                                // tambahan detil load function pada row selected
                                                if (typeof window.loaddetilexcel === 'function')
                                                {
                                                    ...
                                                    // console.log(dindex+"-"+reqIRowIdval);
                                        ...
                                        // console.log("noteone-b");
                                        // Update cell selection
                                        if (! $(e.target).parents('.edition').length) {
                                            // console.log("noteone-b1");
            ...
            $.fn.jexcel.mouseUpControls = function (e) {
                // console.log("noteone-mouseUpControls");
            ...
            $.fn.jexcel.doubleClickControls = function (e) {
                // console.log("doubleClickControls");
                // Jexcel is selected
                if ($.fn.jexcel.current) {
                    if ($.fn.jexcel.defaults[$.fn.jexcel.current].editable == true) {
                        // Corner action
            ...
            $.fn.jexcel.mouseOverControls = function (e) {
                // console.log("noteone-mouseOverControls");
                    ...
                    if ($.fn.jexcel.selectedCell) {
                        ...
                        if (e.which == 37) {
                            ...
                            if (! $($.fn.jexcel.selectedCell).hasClass('edition')) {
                                ...
                                // console.log( $(cell).scrollLeft()+"--"+$(cell).width()+"--"+$(cell).offset().left );
                                if(cell.length > 0)
                                {
                            ...
                            // Escape
                            if ($($.fn.jexcel.selectedCell).hasClass('edition')) {
                                // console.log("noteone-Escape");
                                // console.log($.fn.jexcel.defaults[$.fn.jexcel.current].columns[columnId[0]].type);
                                // Exit without saving

                                if ($.fn.jexcel.defaults[$.fn.jexcel.current].columns[columnId[0]].type == 'dropdown') {
                                    // console.log("noteone-Escape1");
                                    $('#' + $.fn.jexcel.current).jexcel('closeEditor', $($.fn.jexcel.selectedCell), true);
                                    // $('#' + $.fn.jexcel.current).jexcel('updateSelection');

                                    // $.fn.jexcel.mouseDownControls;
                                    // $(document).on('mousedown touchstart', $.fn.jexcel.mouseDownControls);
                                    // e.preventDefault();
                                }
                                else
                                {
                                    // console.log("noteone-Escape2");
                            ...
                            if ($($.fn.jexcel.selectedCell).hasClass('edition')) {
                                ...
                                if ($.fn.jexcel.defaults[$.fn.jexcel.current].columns[columnId[0]].type == 'calendar') {
                                    ...
                                    // $('#' + $.fn.jexcel.current).jexcel('closeEditor', $($.fn.jexcel.selectedCell).prev(), true);
                                }
                            }
                        ...
                        // Arrows control
                        if (cell) {
                            // console.log("noteone"+$(cell).length);
                            // Control selected cell
                            if ($(cell).length > 0) {
                                // In case of a multiple cell selection
                                // typeexcel= $.fn.jexcel.defaults[$.fn.jexcel.current].columns[columnId[0]].type;

                                // console.log(e.shiftKey+"noteone"+e.which);
                                // console.log($.fn.jexcel.defaults[$.fn.jexcel.current].columns[columnId[0]].type);
                                ...
                                // console.log(d+"-"+$.fn.jexcel.current);
                                // $('#' + $.fn.jexcel.current).parent().next().find('#' + columnId[0] + '-' + (parseInt(columnId[1]) + 1)).focus();
                                // $('#' + $.fn.jexcel.current).jexcel('updateSelection', o, d);
            ...
            if (options.columns[position[0]].editor) {
                ...
                if (options.columns[position[0]].type == 'checkbox' || options.columns[position[0]].type == 'radio' || options.columns[position[0]].type == 'hidden') {
                    ...
                    if ($.fn.jdropdown) {
                        ...
                        // console.log("noteone-Create dropdown");
                        ...
                        if (options.columns[position[0]].type == 'autocomplete') {
                            ...
                            // console.log("noteone-else Create dropdown");
                            // console.log(position+";"+value);
                        }
                    }
    ...
    closeEditor : function(cell, save) {
        ...
        if (save == true) {
            ...
            if (options.columns[position[0]].editor) {
                ...
                // console.log("noteone-custom editor");
                // console.log(position+";"+value);
            } else {
                // Native functions
                if (options.columns[position[0]].type == 'checkbox' || options.columns[position[0]].type == 'radio' || options.columns[position[0]].type == 'hidden') {
            ...
            // $('#' + $.fn.jexcel.current).jexcel('updateSelection', position[1], position[0], true);
    ...
    shiftFormulaByColumn : function(value, index) {
        // console.log("shiftFormulaByColumn");
        // Default
        if (! index) {
            index = 1;
        }
    ...
    destroy : function () {
        ...
        {
            // console.log($.fn.jexcel.defaults[id]);
