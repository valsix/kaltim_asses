        ...
        if (obj.records[y][x].classList.contains('readonly') == true && ! force) {
            ...
            if (obj.options.columns[x].editor) {
                ...
                if (obj.options.columns[x].type == 'checkbox' || obj.options.columns[x].type == 'radio') {
                    ...
                    // noteone
                    // Update data and cell
                    // console.log(obj.options.columns[x].text+"Update"+value);
                    // value= "";
                    obj.options.data[y][x] = value;
    ...
    if (jexcel.current) {
        if (jexcel.current.edition) {
            ...
            if (e.which == 27) {
                ...
                else if (jexcel.current.options.columns[jexcel.current.edition[2]].type == 'autocomplete') {
                    // jexcel.current.down(e.shiftKey, e.ctrlKey);
                    // jexcel.current.right(e.shiftKey, e.ctrlKey)
                    // jexcel.current.resetSelection();
                    // jexcel.current.up();

                    // jexcel.current.edition[0].children[0].dropdown.close(true);
                    // jexcel.current.edition[0].children[0].dropdown.close(false);
                    // jexcel.current.edition[0].children[0].blur();
