<?
############### MOD FOR USE IN SIMWEB ENGINE ##############
include_once("../../classes/utils/UserLogin.php");
...
if(isset($_GET['pollId'])){
	...
	if($optionId)
	{
		$voteSql = "insert into poller_vote(optionID, ipAddress, pollerID, UID)
					values(
						'".$optionId."',
						'".getenv("REMOTE_ADDR")."',
						'".$pollId."',
