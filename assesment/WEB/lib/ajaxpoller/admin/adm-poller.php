...
<head>
	...
	<link href="../../../../admin/themes/main.css" rel="stylesheet" type="text/css">
	...
	<fieldset>
		<table>
			<tr>
				...
				if(!empty($id)){
					?>
					<td><input type="submit" name="delete" value="Delete" onclick="return confirm('Hapus data polling?')" class="formButton"></td>
					<?					
				}
				?>
			</tr>
