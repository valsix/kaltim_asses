...
$arrkolomdata= array(
    array("info"=>"Nama", "width"=>"10")
    , array("info"=>"Jabatan", "width"=>"25")
    , array("info"=>"Rumpun", "width"=>"")
    , array("info"=>"Satuan Kerja", "width"=>"25")
    , array("info"=>"Target", "width"=>"5")
);
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",					  
		"sAjaxSource": "../json-suksesi/formula_jabatan_target_json.php",
		...
		/* Click event handler */
		  ...
		  $('#btnTambah,#btnUbahData').on('click', function () {
			  ...
			  opUrl= 'formula_jabatan_target_add.php?reqId='+anSelectedRowId;
		  ...
		  $('#cetakexcel').on('click', function () {
			  ...
			  newWindow = window.open("jabatan_target_excel.php?reqId="+anSelectedPegawaiId+"&reqFormulaJabatanTargetId="+anSelectedRowId+"&sSearch="+reqPencarian);
			  newWindow.focus();
		  });
			  ...
			  if(anSelectedData == "")
				...
				$.messager.confirm('Confirm','Apakah anda yakin ingin menghapus data terpilih ?',function(r){
					if (r){
						...
						var jqxhr = $.get( "../json-suksesi/delete.php?reqMode=formula_jabatan_target&id="+anSelectedRowId, function() {
						...
						.done(function() {
							...
							oTable.fnReloadAjax("../json-suksesi/formula_jabatan_target_json.php");
						})
						.fail(function() {
							alert( "error" );
							$.messager.progress('close');
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <div id="header-tna">Setting <span>Jabatan Target</span></div>
