...
<div class="simpleTabs">
    <ul class="simpleTabsNavigation">
      <li><a href="#"><i class="fa fa-line-chart fa-lg"></i>Monitoring kandidat</a></li>
    ...
    <div class="simpleTabsContent">
        ...
        <tr>
            ...
            <td align="center">
                <label>
                <input type="hidden" name="reqRowMasakanId[]" id="reqRowMasakanId<?=$checkbox_index?>" value="<?=$tempRowMasakanId?>" />
                <?
                //if($checkbox_index == 0){}
                //else
                //{
                    ...
                    //{
                ?>
                <a style="cursor:pointer" onclick="deleteRowDrawTablePhp('tableMasakanUtama', this, '<?=$checkbox_index?>', 'reqRowMasakanId', 'pegawai_kandidat')"><img src="../WEB/images/delete-icon.png" width="15" height="15" border="0" /></a>
                <?
                    //}
                //}
                ?>
