...
include_once("../WEB/classes/base/Unsur.php");
...
if($reqMode == "delete")
{
    $atribut->setField("ATRIBUT_ID", $reqId);
    if($atribut->delete())
    {
...
<script type="text/javascript">
	function reloadMe()
	{
		$('#tt').treegrid({url:'../json-pengaturan/atribut_tree.php?reqAspekId='+$('#reqAspekId').val()});
	}
...
<div style="width:100%;">
    ...
    <table id="tt" title="Kamus Kompetensi" class="easyui-treegrid" style="width:100%;height:600px"
        data-options="
        url: '../json-pengaturan/atribut_tree.php?reqAspekId='+$('#reqAspekId').val(),
        rownumbers: false,
        pagination: true,
        pageList: [100, 150],
        idField: 'ID',
        ...
        <thead>
            <tr>
                ...
                Nama
                <a onClick="window.OpenDHTMLPopUp('atribut_add.php?reqAtributParentId=0')"><img src="../WEB/images/icn_add.png"></a>
                </th>
