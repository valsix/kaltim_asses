...
if(varItem == 'idpegawai'){
	...
	parent.mainFrame.location.href='../ikk/identitas_edit<?=$reqSource?>.php?reqPegawaiId=<?=$reqPegawaiId?>&reqIdOrganisasi=<?=$reqIdOrganisasi?>';
	...
	parent.mainFrame.location.href='../ikk/jabatan<?=$reqSource?>.php?reqPegawaiId=<?=$reqPegawaiId?>&reqIdOrganisasi=<?=$reqIdOrganisasi?>';
	parent.document.getElementById('trdetil').style.display = 'none';	
	...
	parent.mainFrame.location.href='../ikk/pangkat<?=$reqSource?>.php?reqPegawaiId=<?=$reqPegawaiId?>&reqIdOrganisasi=<?=$reqIdOrganisasi?>';
	parent.document.getElementById('trdetil').style.display = 'none';	
	...
	parent.mainFrame.location.href='../ikk/skp<?=$reqSource?>.php?reqPegawaiId=<?=$reqPegawaiId?>&reqIdOrganisasi=<?=$reqIdOrganisasi?>';
	parent.mainFrameDetil.location.href='../ikk/skp_detil<?=$reqSource?>.php?reqPegawaiId=<?=$reqPegawaiId?>&reqIdOrganisasi=<?=$reqIdOrganisasi?>';
	parent.document.getElementById('trdetil').style.display = '';	
	...
	parent.mainFrame.location.href='../ikk/pendidikan_umum<?=$reqSource?>.php?reqPegawaiId=<?=$reqPegawaiId?>&reqIdOrganisasi=<?=$reqIdOrganisasi?>';
	parent.document.getElementById('trdetil').style.display = 'none';	
	...
	parent.mainFrame.location.href='../ikk/penilaian_kompetensi_analisa<?=$reqSource?>.php?reqPegawaiId=<?=$reqPegawaiId?>&reqIdOrganisasi=<?=$reqIdOrganisasi?>';
	parent.document.getElementById('trdetil').style.display = 'none';
}
...
<?php /*?>else if(varItem == 'penilaianLHKPN'){
	...
	parent.setShowHideMenu(1);
	$('#penilaianLHKPN').addClass("menuAktifDynamis");
	parent.mainFrame.location.href='../silat/penilaian_lhkpn_monitoring<?=$reqSource?>.php?reqPegawaiId=<?=$reqPegawaiId?>&reqIdOrganisasi=<?=$reqIdOrganisasi?>';
	parent.mainFrameDetil.location.href='../silat/penilaian_lhkpn_add_data<?=$reqSource?>.php?reqPegawaiId=<?=$reqPegawaiId?>&reqIdOrganisasi=<?=$reqIdOrganisasi?>';
	parent.document.getElementById('trdetil').style.display = '';
}
else if(varItem == 'lampiran'){
	parent.setShowHideMenu(2);
	$('#lampiran').addClass("menuAktifDynamis");
	parent.mainFrame.location.href='../ikk/lampiran<?=$reqSource?>.php?reqPegawaiId=<?=$reqPegawaiId?>&reqIdOrganisasi=<?=$reqIdOrganisasi?>';
	parent.document.getElementById('trdetil').style.display = 'none';	
	//parent.mainFrameDetil.location.href='jabatan_detil<?=$reqSource?>.php?reqPegawaiId=<?=$reqPegawaiId?>&reqIdOrganisasi=<?=$reqIdOrganisasi?>';
	//parent.document.getElementById('trdetil').style.display = '';	
}
else if(varItem == 'unsur_penilaian'){
	parent.setShowHideMenu(2);
	$('#unsur_penilaian').addClass("menuAktifDynamis");
	parent.mainFrame.location.href='../ikk/unsur_penilaian<?=$reqSource?>.php?reqPegawaiId=<?=$reqPegawaiId?>&reqIdOrganisasi=<?=$reqIdOrganisasi?>';
	parent.document.getElementById('trdetil').style.display = 'none';	
	//parent.mainFrameDetil.location.href='jabatan_detil<?=$reqSource?>.php?reqPegawaiId=<?=$reqPegawaiId?>&reqIdOrganisasi=<?=$reqIdOrganisasi?>';
	//parent.document.getElementById('trdetil').style.display = '';	
}
	...
	parent.setShowHideMenu(1);
	$('#penilaian').addClass("menuAktifDynamis");
	parent.mainFrame.location.href='penilaian.php?reqId=<?=$reqPegawaiId?>';
	parent.mainFrameDetil.location.href='penilaian_add.php?reqId=<?=$reqPegawaiId?>';
	parent.document.getElementById('trdetil').style.display = '';
}
...
<div id="content">
 ...
 -->
      ...
      <div>
        ...
        <a href="#" id="unsur_penilaian" onclick="executeOnClick('unsur_penilaian');">Unsur Penilaian</a>
        <a href="#" id="penilaian" onclick="executeOnClick('penilaian');">Penilaian Dari Luar</a>
      </div>
