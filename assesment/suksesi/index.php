...
<?
$_GET["JUDUL"] = "| Modul";
$_GET["DESKRIPSI"] = "Perencanaan Suksesi";
                    	...
                    	<tr>
                            ...
                            <td>
                            	<div id="menu-2">
									...
									{
                                    ?>
									<!-- <div id="menu-2-konten"><a href="monitoring.php?reqRowId=1&reqMode=rencana_suksesi" target="mainFrame" onClick="menuHandler('pegawai')">Rencana Suksesi</a></div> -->
									<?
									}
                                    ?>
                                    <!---->
                                    <!-- <div id="menu-2-konten"><a href="monitoring.php?reqRowId=1&reqMode=rencana_suksesi" target="mainFrame" onClick="menuHandler('pegawai')">Hasil Penilaian</a></div>
                                    <div id="menu-2-konten"><a href="monitoring.php?reqRowId=1&reqMode=rencana_suksesi" target="mainFrame" onClick="menuHandler('pegawai')">Penilaian</a></div> -->
                                    <div id="menu-2-konten"><a href="monitoring.php?reqMode=pegawai_hasil_penilaian" target="mainFrame" onClick="menuHandler('pegawai')">Hasil Penilaian</a></div>
                                    <div id="menu-2-konten"><a href="monitoring.php?reqMode=pegawai_penilaian" target="mainFrame" onClick="menuHandler('pegawai')">Penilaian</a></div>
                                    <!-- <div id="menu-2-konten"><a href="monitoring.php?reqMode=setting_awal" target="mainFullFrame" onClick="menuHandler('validator')">Setting Awal</a></div>  -->
                                    <!-- <div id="menu-2-konten"><a href="#" data-flexmenu="alur-data">Setting Penilaian</a></div> -->
                                    <div id="menu-2-konten"><a href="#" data-flexmenu="alur-data">Pengaturan</a></div>
                                    <div id="menu-2-konten"><a href="#" data-flexmenu="master-data">Master</a></div>
                                    <div id="menu-2-konten"><a href="monitoring.php?reqRowId=1&reqMode=pegawai" target="mainFrame" onClick="menuHandler('pegawai')">Pegawai</a>
                                    </div>
                               ...
                               <!--  <ul id="flex-pegawai" class="flexdropdownmenu" style="background-color:#385f0e;">
                                ...
                                <ul id="alur-data" class="flexdropdownmenu" style="background-color:#385f0e;">
                                	<!-- <li><a href="monitoring.php?reqMode=formula_suksesi" target="mainFullFrame" onClick="menuHandler('validator')">Setting Grafik & Kuadran talent pool</a></li>
                                	<li><a href="monitoring.php?reqMode=formula_jabatan_target" target="mainFullFrame" onClick="menuHandler('validator')">Setting Jabatan Target</a></li> -->
                                	<li><a href="monitoring.php?reqMode=formula_suksesi" target="mainFullFrame" onClick="menuHandler('validator')">Pengaturan Bobot Penilaian</a></li>
                                	<li><a href="monitoring.php?reqMode=formula_jabatan_target" target="mainFullFrame" onClick="menuHandler('validator')">Pengaturan Jabatan Target</a></li>
                                </ul>

                                <ul id="master-data" class="flexdropdownmenu" style="background-color:#385f0e;">
                                	<li><a href="monitoring.php?reqMode=rumpun_jabatan" target="mainFullFrame" onClick="menuHandler('validator')">Master Rumpun Jabatan</a></li>
                                	<li><a href="monitoring.php?reqMode=master_jabatan" target="mainFullFrame" onClick="menuHandler('validator')">Master Jabatan</a></li>
                                	<li><a href="monitoring.php?reqMode=master_unsur_penilaian" target="mainFullFrame" onClick="menuHandler('validator')">Master Unsur Penilaian</a></li>
                                </ul>
      		...
      		<table width="242" border="0" cellpadding="0" cellspacing="0" height="100%" id="menuFrame" style="display:none">
        		<tr> 
					...
					?>
				  	...
				  	<!-- MENU -->                    
					  	<iframe src="../ikk/satuan_kerja_menu.php?reqMode=<?=$reqMode?>" name="menuSatuanKerja" width="100%" height="100%" scrolling="auto" frameborder="0"  id="menuSatuanKerja" style="display:none"></iframe>
                    <?
					}
					else
					{
