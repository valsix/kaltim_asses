...
<script type="text/javascript">	
	$(function(){
		...
		$('#ff').form({
			url:'../json-suksesi/formula_jabatan_target_add.php',
			onSubmit:function(){
			...
			success:function(data){
				...
				else
				{
					...
					document.location.href = 'formula_jabatan_target_add.php?reqId='+reqId;
				...
				<td>
					<div id="reqJabatanInfoId">
	                    ...
	                    onCheck: function(node, checked){
	                        clickNode($('#reqJabatanJsonId'), node.id);
	                    }" style="width:550px;" value="<?=$reqJabatanNama?>" />
