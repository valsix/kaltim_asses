...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",
		"sAjaxSource": "../json-suksesi/pegawai_penilaian_json.php?reqId=<?=$reqId?>&reqFormulaJabatanTargetId=<?=$reqFormulaJabatanTargetId?>&reqFormulaUnsurId=<?=$reqFormulaUnsurId?>",
		...
		/* Click event handler */
		  ...
		  $("#reqPencarian").keyup(function(e) { 
			...
			if(code==13)
			{
				  ...
				  //setFooter();
				  oTable.fnReloadAjax("../json-suksesi/pegawai_penilaian_json.php?reqFormulaJabatanTargetId="+reqFormulaJabatanTargetId+"&reqFormulaUnsurId="+reqFormulaUnsurId+"&reqId=<?=$reqId?>&sSearch="+reqPencarian);
			}
		  });
		  ...
		  $("#reqFormulaJabatanTargetId").change(function() { 
			  ...
			  //setFooter();
			  document.location.href= "pegawai_penilaian.php?reqFormulaJabatanTargetId="+reqFormulaJabatanTargetId+"&reqFormulaUnsurId="+reqFormulaUnsurId+"&reqId=<?=$reqId?>&sSearch="+reqPencarian;
		  });
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <div id="header-tna">Data <span>Penilaian</span></div>
    <div id="bluemenu" class="bluetabs" style="background:url(css/media/bluetab.gif)">    
    	<ul>
    		<li>
    			<a href="#" title="Set Penilaian" id="btnUbahData" ><img src="../WEB/images/pegawai-edit.png"/>&nbsp;Set Penilaian</a>
    		</li>
    	</ul>
   </div>
