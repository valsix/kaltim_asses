...
$atribut= new RumpunJabatan();
if($reqMode == "delete")
{
    $atribut->setField("RUMPUN_ID", $reqId);
    if($atribut->delete())
    {
...
<script type="text/javascript">
	function reloadMe()
	{
		$('#tt').treegrid({url:'../json-suksesi/rumpun_jabatan_tree.php?reqAspekId='+$('#reqAspekId').val()});
	}
...
<div style="width:100%;">
    ...
    <table id="tt" title="Rumpun Jabatan" class="easyui-treegrid" style="width:100%;height:600px"
        data-options="
        url: '../json-suksesi/rumpun_jabatan_tree.php',
        rownumbers: false,
        pagination: true,
        pageList: [100, 150],
        idField: 'ID',
        treeField: 'NAMA_RUMPUN',
        ...
        <thead>
            <tr>
                <th field="NAMA_RUMPUN" width="70%">
                Nama
                <a onClick="window.OpenDHTMLPopUp('rumpun_jabatan_add.php?reqRumpunJabatanParentId=0')"><img src="../WEB/images/icn_add.png"></a>
                </th>
                <!-- <th field="ASPEK_NAMA_RUMPUN" width="15%">Aspek</th> -->
