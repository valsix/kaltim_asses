...
$arrkolomdata= array(
    array("info"=>"Tahun", "width"=>"10")
    , array("info"=>"Formula", "width"=>"25")
    , array("info"=>"Keterangan", "width"=>"")
);
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",					  
		"sAjaxSource": "../json-suksesi/formula_suksesi_json.php",
		...
		/* Click event handler */
		  ...
		  $('#btnTambah,#btnUbahData').on('click', function () {
			  ...
			  opUrl= 'formula_suksesi_add.php?reqId='+anSelectedRowId;
			  window.top.OpenDHTMLDetil(opUrl, "Pengaturan Bobot dan Program Suksesi", '1000', '615');
			  ...
			  if(anSelectedData == "")
				...
				$.messager.confirm('Confirm','Apakah anda yakin ingin menghapus data terpilih ?',function(r){
					if (r){
						...
						var jqxhr = $.get( "../json-suksesi/delete.php?reqMode=formula_suksesi&id="+anSelectedRowId, function() {
						...
						.done(function() {
							...
							oTable.fnReloadAjax("../json-suksesi/formula_suksesi_json.php");
						})
						.fail(function() {
							alert( "error" );
							$.messager.progress('close');
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <div id="header-tna">Setting <span>Grafik & Kuadran talent pool</span></div>
