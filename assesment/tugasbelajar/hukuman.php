...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",					  
		"sAjaxSource": "../json-tugasbelajar/hukuman_json.php",
		...
		/* Click event handler */
		  ...
		  $('#btnEksporXls').on('click', function () {
			  newWindow = window.open('rekap_hukuman_excel.php', 'Cetak');
			  newWindow.focus();
		  });
		  ...
		  $('#btnTambah,#btnUbahData').on('click', function () {
			  ...
			  opUrl= 'hukuman_add_data.php?reqId='+anSelectedId;
			  
			  window.top.OpenDHTML(opUrl, "Hukuman", '880', '495');
		  });
			  ...
			  if(anSelectedData == "")
				...
				$.messager.confirm('Confirm','Apakah anda yakin ingin menghapus data terpilih ?',function(r){
					if (r){
						...
						var jqxhr = $.get( "../json-tugasbelajar/delete.php?reqMode=hukuman&id="+anSelectedId, function() {
							$.messager.progress('close');
						})
						.done(function() {
							$.messager.progress('close');
							
							oTable.fnReloadAjax("../json-tugasbelajar/hukuman_json.php");
						})
						.fail(function() {
							alert( "error" );
							$.messager.progress('close');
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <div id="header-tna"><span>Hukuman</span></div>
    ...
    <thead>
        <tr>
            ...
            <th width="70px">Tgl. SK</th>
            <th width="70px">TMT SK</th>
            <th width="150px">Tingkat Hukuman</th>
            <th width="150px">Jenis Hukuman</th>
            <th width="100px">Permasalahan</th>
            <th width="100px">Masih Berlaku</th>
        </tr>
    </thead>
    </table>
