...
/* create objects */
$ijin_belajar_add_semester = new TugasBelajarLapor();
...
{
	$ijin_belajar_add_semester->selectByParams(array('A.TUGAS_BELAJAR_LAPOR_ID'=>$reqRowId));
	$ijin_belajar_add_semester->firstRow();
	//echo $ijin_belajar_add_semester->query;exit;
	
	$tempTanggal = dateToPage($ijin_belajar_add_semester->getField("TANGGAL"));
	$tempKeterangan = $ijin_belajar_add_semester->getField("KETERANGAN");
	$tempStatusBelajar = $ijin_belajar_add_semester->getField("STATUS_BELAJAR");
	$tempSemester = $ijin_belajar_add_semester->getField("SEMESTER");
	$tempTipeTugas = $ijin_belajar_add_semester->getField("TIPE_TUGAS");
}
...
<link rel="stylesheet" type="text/css" href="../WEB/lib/easyui/themes/default/easyui.css">
	...
	<script type="text/javascript">
		...
		$(function(){
			$('#ff').form({
				url:'../json-tugasbelajar/ijin_belajar_add_semester_add_data.php',
				onSubmit:function(){
		...
		function setReload()
		{
			parent.frames['mainFrame'].location.href = 'ijin_belajar_add_semester_monitoring.php?reqId=<?=$reqId?>&reqMode=' + mode;
			parent.frames['mainFrameDetil'].location.href = 'ijin_belajar_add_semester.php?reqId=<?=$reqId?>';
		}
