   	...
   	<tr> 
      		...
      		<table width="242" border="0" cellpadding="0" cellspacing="0" height="100%" id="menuFrame">
        		<tr> 
         			...
         			<td valign="top">
				  	...
				  	<!-- MENU -->
				  	<iframe src="ijin_belajar_menu.php?reqId=<?=$reqId?>&reqPegawaiId=<?=$reqPegawaiId?>" name="menuFrame" width="100%" height="100%" scrolling="auto" frameborder="0"></iframe>		  
		  			</td>
        		</tr>
      		</table>
		</td>
    	...
    	<td valign="top" height="100%" width="100%">
            <table cellpadding="0" cellspacing="0"  width="100%" height="100%">
            	<tr height="10%">
                	<td><iframe src="ijin_belajar_add_data.php?reqId=<?=$reqId?>&reqConfirm=<?=$reqConfirm?>" class="mainframe" id="idMainFrame" name="mainFrame" width="100%" height="100%" scrolling="auto" frameborder="0"></iframe></td>
                </tr>
