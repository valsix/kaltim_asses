                    	...
                    	<tr>
                            ...
                            <td>
                            	<div id="menu-2">
                                    ...
                                    <?
									//}
									if(findWord($tempListInfo, "Hukuman") == 1 || $tempListInfo == "")
									{
                                    ?>
                                    <div id="menu-2-konten"><a href="monitoring.php?reqRowId=1&reqMode=hukuman" target="mainFullFrame" onClick="menuHandler('validator')">Hukuman</a></div>
                                     <?
									}
                                    ?>
                                    
                                    <?
									if(findWord($tempListInfo, "Tugas Belajar") == 1 || $tempListInfo == "")
									{
                                    ?>
                                    <div id="menu-2-konten"><a href="monitoring.php?reqRowId=1&reqMode=tugas_belajar" target="mainFullFrame" onClick="menuHandler('validator')">Tugas Belajar</a></div>
                                    <?
									}
                                    ?>
                                    
                                    <?
									if(findWord($tempListInfo, "Ijin Belajar") == 1 || $tempListInfo == "")
									{
                                    ?>
                                    <div id="menu-2-konten"><a href="monitoring.php?reqRowId=1&reqMode=ijin_belajar" target="mainFullFrame" onClick="menuHandler('validator')">Ijin Belajar</a></div>
                                    <?
									}
                                    ?>
                                    <!---->
