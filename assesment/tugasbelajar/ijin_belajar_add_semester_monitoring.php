...
<div id="content" style="height:auto">
	...
	?>
        <tr style="background-color:#FFF;cursor:pointer" onmouseover="ChangeColor(this, true);"  onmouseout="ChangeColor(this, false);">
        	<td><a href="ijin_belajar_add_semester.php?reqId=<?=$reqId?>&reqRowId=<?=$tugas_belajar_add_semester->getField("TUGAS_BELAJAR_LAPOR_ID")?>">link data</a></td>
            ...
            <td>
            <a href="#" onClick="if(confirm('Apakah anda yakin ingin menghapus data ini?')) { window.location.href = 'ijin_belajar_add_semester_monitoring.php?reqMode=delete&reqDeleteId=<?=$tugas_belajar_add_semester->getField("TUGAS_BELAJAR_LAPOR_ID")?>' }"><img src="../WEB/images/delete-icon.png"></a>
            </td>
        </tr>    
    <?
	}
