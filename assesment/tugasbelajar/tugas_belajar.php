...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",					  
		"sAjaxSource": "../json-tugasbelajar/tugas_belajar_json.php",
		...
		/* Click event handler */
		  ...
		  $('#btnTambah,#btnUbahData').on('click', function () {
			  ...
			  opUrl= 'tugas_belajar_add.php?reqId='+anSelectedId+'&reqPegawaiId='+anSelectedPegawaiId;
			  
			  window.top.OpenDHTML(opUrl, "Tugas Belajar", '880', '495');
		  });
			 ...
			 if(anSelectedStatusInfoId !== "2")
			  ...
			  $.messager.confirm('Konfirmasi', "Apakah Anda yakin merubah data menjadi perpanjangan dan tmt akhir nya d tambah 1 tahun ?",function(r){
					if (r){
						...
						var jqxhr = $.post( "../json-tugasbelajar/tugas_belajar_add.php?reqId="+anSelectedId, function() {
							arrChecked = [];
						...
						.done(function(dataJson) {
							...
							oTable.fnReloadAjax("../json-tugasbelajar/tugas_belajar_json.php?reqStatusBelajar="+reqStatusBelajar+"&reqTanggalAwalFilter="+reqTanggalAwalFilter+"&reqTanggalAkhirFilter="+reqTanggalAkhirFilter);
						})
						.fail(function() {
							arrChecked = [];
							alert( "error" );
		  ...
		  $('#btnEksporXls').on('click', function () {
			...
			$("#reqStatusInfo").change(function() { 
				...
				oTable.fnReloadAjax("../json-tugasbelajar/tugas_belajar_json.php?reqStatusInfo="+reqStatusInfo);
			});
				...
				$.messager.confirm('Confirm','Apakah anda yakin ingin menghapus data terpilih ?',function(r){
					if (r){
						...
						.done(function() {
							...
							oTable.fnReloadAjax("../json-tugasbelajar/tugas_belajar_json.php");
						})
						.fail(function() {
							alert( "error" );
							$.messager.progress('close');
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <div id="header-tna">Master <span>Tugas Belajar</span></div>
