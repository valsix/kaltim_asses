...
if(varItem == 'ijin_belajar_add_data'){
	$('#ijin_belajar_add_data').addClass("menuAktifDynamis");
	parent.mainFrame.location.href='ijin_belajar_add_data.php?reqId=<?=$reqId?>';
	parent.document.getElementById('trdetil').style.display = 'none';
}
else if(varItem == 'ijin_belajar_add_semester'){
	$('#ijin_belajar_add_semester').addClass("menuAktifDynamis");
	parent.mainFrame.location.href='ijin_belajar_add_semester_monitoring.php?reqId=<?=$reqId?>';
	parent.mainFrameDetil.location.href='ijin_belajar_add_semester.php?reqId=<?=$reqId?>';
	parent.document.getElementById('trdetil').style.display = '';	
}
else if(varItem == 'persyaratan_ijin_belajar_add_data'){
	$('#persyaratan_ijin_belajar_add_data').addClass("menuAktifDynamis");
	parent.mainFrame.location.href='persyaratan_ijin_belajar_add_data.php?reqId=<?=$reqId?>';
	parent.document.getElementById('trdetil').style.display = 'none';
}
return true;
}
...
<div id="content">
    ...
    <div style="float: left" id="my_menu" class="sdmenu">
      <div> 
      	<span>Info Data</span>
        <a href="#" id="ijin_belajar_add_data" onclick="executeOnClick('ijin_belajar_add_data');"  <? if($reqMode == "fip") {} else { ?> class="menuAktifDynamis"  <? } ?>>Ijin Belajar</a>
        <a href="#" id="ijin_belajar_add_semester" onclick="executeOnClick('ijin_belajar_add_semester');">Laporan Semester</a>
        <?
	if($reqId == ""){}
	else
	{
    ?>
    <a href="#" id="persyaratan_ijin_belajar_add_data" onclick="executeOnClick('persyaratan_ijin_belajar_add_data');">Laporan Persyaratan Ijin Belajar</a>
