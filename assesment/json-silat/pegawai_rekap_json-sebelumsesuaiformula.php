...
$aColumns = array("NAMA", "NIP_BARU", "JABATAN_NAMA", "SATKER", "STANDAR_SKOR_AKHIR", "SKOR_INDIVIDU_AKHIR");
$aColumnsAlias = array("NAMA", "NIP_BARU", "JABATAN_NAMA", "SATKER", "STANDAR_SKOR_AKHIR", "SKOR_INDIVIDU_AKHIR");
...
if($reqJadwalTesId == ""){}
	...
	$statement .= " AND PN.FORMULA_ID = ".$reqJadwalTesId;
...
$sOrder= "ORDER BY COALESCE(PN.SKOR_INDIVIDU_AKHIR,0) DESC";
