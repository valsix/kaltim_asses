...
$aColumns = array("IDPEG", "STATUS","NIP_BARU", "NAMA","TEMPAT_KERJA","LAST_JABATAN","JABATAN_LAMAR");
$aColumnsAlias = array("IDPEG", "STATUS", "NIP_BARU", "NAMA","TEMPAT_KERJA","LAST_JABATAN","JABATAN_LAMAR");
...
if($reqStatusPeg == "")
$statement.=' AND A.STATUS_JENIS = 2 OR A.STATUS_JENIS = 3 ';
else
	// $statement .= " AND A.STATUS_PEGAWAI_ID = ".$reqStatusPeg." ";
	$statement .= " AND A.STATUS_JENIS = ".$reqStatusPeg." ";
