...
if($_GET['sSearch'] == "")
	...
	$allRecordFilter = $set->getCountByParamsMonitoringAnalisaPegawai(array(), $statement.$searchJson);

$sOrder="ORDER BY A.LAST_PANGKAT_ID  DESC, COALESCE(A.LAST_ESELON_ID,'99')  ASC";
$set->selectByParamsMonitoringAnalisaPegawai(array(), $dsplyRange, $dsplyStart, $statement.$searchJson, $sOrder);
