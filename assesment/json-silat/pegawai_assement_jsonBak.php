...
if($_GET['sSearch'] == "")
	...
	$allRecordFilter = $set->getCountByParamsMonitoringPenilaianPegawai(array(), $statement.$statement_json, $reqTahun);
//echo $set->query;exit;
$set->selectByParamsMonitoringPenilaianPegawai(array(), $dsplyRange, $dsplyStart, $statement.$statement_json, $sOrder, $reqTahun);
