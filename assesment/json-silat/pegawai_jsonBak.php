...
$allRecord = $set->getCountByParamsMonitoringPegawai(array(), $statement.$statement_json);
if($_GET['sSearch'] == "")
	$allRecordFilter = $allRecord;
else
	$allRecordFilter = $set->getCountByParamsMonitoringPegawai(array(), $statement.$statement_json);

$set->selectByParamsMonitoringPegawai(array(), $dsplyRange, $dsplyStart, $statement.$statement_json, $sOrder);
