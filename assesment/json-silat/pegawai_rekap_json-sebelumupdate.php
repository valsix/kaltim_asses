...
$aColumns = array("NAMA", "NIP_BARU", "JABATAN_NAMA", "SATKER");
...
$allRecord = $set->getCountByParamsRekap(array(), $statement, $reqJadwalTesId);
if($_GET['sSearch'] == "")
	$allRecordFilter = $allRecord;
else
	$allRecordFilter = $set->getCountByParamsRekap(array(), $statement.$searchJson, $reqJadwalTesId);
// echo $set->query;exit;
