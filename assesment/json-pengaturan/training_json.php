...
$aColumns = array("TRAINING_NAMA", "ATRIBUT_NAMA", "TAHUN", "TRAINING_ID");
$aColumnsAlias = array("TRAINING_NAMA", "ATRIBUT_NAMA", "TAHUN", "TRAINING_ID");
...
if ( isset( $_GET['iSortCol_0'] ) )
{
	...
	if ( trim($sOrder) == "ORDER BY TRAINING_NAMA asc, TRAINING_NAMA asc" )
	{
		/*
		...
		*/
		$sOrder = " ORDER BY A.TAHUN DESC, A.TRAINING_ID asc, C.ATRIBUT_ID ASC";
...
if($reqTrainingId== "" || $reqTrainingId== "null"){}
	...
	$statement= " AND A.TRAINING_ID = '".$reqTrainingId."' ";

if($reqTahun== ""){}
else
	$statement.= " AND A.TAHUN = '".$reqTahun."' ";

$searchJson= " AND (UPPER(A.NAMA) LIKE '%".strtoupper($_GET['sSearch'])."%' OR UPPER(C.NAMA) LIKE '%".strtoupper($_GET['sSearch'])."%') ";
