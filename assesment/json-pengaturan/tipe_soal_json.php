...
$aColumns= array("TIPE_UJIAN_ID", "NO",  "TIPE", "KATEGORI_NAMA");
$aColumnsAlias= array("TIPE_UJIAN_ID", "NO", "TIPE", "KATEGORI_NAMA");
...
if ( isset( $_GET['iSortCol_0'] ) )
{
	...
	if ( trim($sOrder) == "ORDER BY TIPE_SOAL_ID asc" )
	{
		/*
...
$searchJson= " AND (UPPER(TIPE) LIKE '%".strtoupper($_GET['sSearch'])."%') ";
