...
if($reqTipeUjianId == "48")
{
	$statement= " AND B.PEGAWAI_ID = ".$reqPegawaiId." AND B.JADWAL_TES_ID = ".$reqId;
...
else
{
	...
	$statementdetil.= " AND B.PEGAWAI_ID = ".$reqPegawaiId." AND HSL.TIPE_UJIAN_ID = ".$reqTipeUjianId." AND HSL.JADWAL_TES_ID = ".$reqId;
