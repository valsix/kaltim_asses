...
if($_GET['sSearch'] == "")
	...
	$allRecordFilter = $set->getCountByParamsPegawai(array(), $statement.$searchJson);
	//echo $set->query;exit;

$set->selectByParamsPegawai(array(), $dsplyRange, $dsplyStart, $statement.$searchJson, $sOrder);
// echo $set->query;exit;
/*
 * Output
 */
