...
$allRecord = $set->getCountByParamsMonitoringLhkpnPegawai(array(), $statement.$statement_json);
if($_GET['sSearch'] == "")
	$allRecordFilter = $allRecord;
else
	$allRecordFilter = $set->getCountByParamsMonitoringLhkpnPegawai(array(), $statement.$statement_json);

$set->selectByParamsMonitoringLhkpnPegawai(array(), $dsplyRange, $dsplyStart, $statement.$statement_json, $sOrder);
