...
$allRecord = $set->getCountByParamsMonitoringTableTalentPoolPotensiKompetensiMonitoring($statementArray, $statement, $reqTahun);
if($_GET['sSearch'] == "")
	$allRecordFilter = $allRecord;
else
	$allRecordFilter = $set->getCountByParamsMonitoringTableTalentPoolPotensiKompetensiMonitoring($statementArray, $statement, $reqTahun, $searchJson);

$set->selectByParamsMonitoringTableTalentPoolPotensiKompetensiMonitoring($statementArray, $dsplyRange, $dsplyStart, $statement, "", $reqTahun, $searchJson);
