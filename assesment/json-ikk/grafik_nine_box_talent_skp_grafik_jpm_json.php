...
$sOrder = " ORDER BY COALESCE(X.JPM,0) DESC, COALESCE(Y.NILAI_KOMPETENSI,0) DESC ";
$set->selectByParamsMonitoringTalentPoolSkpJPMPegawai(array(), -1, -1, $statement, $sOrder, $reqTahun);
// echo $set->query;exit;
$i=0;
while($set->nextRow())
{
