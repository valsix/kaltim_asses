...
$arrKeterangan= array("Managerial", "Personality<br>(Kepribadian)", "Human Relation<br>(Sosiabilitas)", "Willingess To Do More<br>(Potensi Kerja)"
					  , "Ability to Work<br>(Cara Kerja)", "Intelektual & Kemumpuan Umum", "Pengalaman Kerja", "Pendidikan"
					  , "Goal & Objective Setting", "Emotional Quotient(EQ)");
$arrDataStandar= array("3.5", "3", "3", "3.2"
					  , "3", "2.8", "3.5", "2.5"
					  , "2.7", "2.5");
$arrDataTarget= array("2.5", "3", "3", "3.2"
					  , "3", "2.8", "2.5", "2.5"
					  , "2.7", "2.5");
$arrDataToleransi= array("2.7", "3.2", "3.2", "3.4"
					  , "3.2", "3", "2.7", "2.7"
					  , "2.9", "2.7");
