...
$aColumns = array("IDPEG", "NO", "NIP_LAMA", "NIP_BARU", "NAMA", "TEMPAT_LAHIR", "TGL_LAHIR", "JENIS_KELAMIN", "STATUS", "NAMA_GOL", "TMT_GOL_AKHIR", "NAMA_ESELON", "NAMA_JAB_STRUKTURAL", "", "", "TELP", "ALAMAT", "SATKER", "", "", "KONDISI_LAPOR");
$aColumnsAlias = array("IDPEG", "NO", "NIP_LAMA", "NIP_BARU", "NAMA", "TEMPAT_LAHIR", "TGL_LAHIR", "JENIS_KELAMIN", "STATUS", "NAMA_GOL", "TMT_GOL_AKHIR", "NAMA_ESELON", "NAMA_JAB_STRUKTURAL", "", "", "TELP", "ALAMAT", "SATKER", "", "", "KONDISI_LAPOR");
...
$allRecord = $set->getCountByParamsMonitoringSkpPegawai(array(), $statement.$statement_json, $reqTahun);
if($_GET['sSearch'] == "")
	$allRecordFilter = $allRecord;
else
	$allRecordFilter = $set->getCountByParamsMonitoringSkpPegawai(array(), $statement.$statement_json, $reqTahun);

$set->selectByParamsMonitoringSkpPegawai(array(), $dsplyRange, $dsplyStart, $statement.$statement_json, $reqTahun, $sOrder);
