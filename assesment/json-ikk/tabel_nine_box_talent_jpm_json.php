...
// $reqFormulaId = httpFilterRequest("reqFormulaId");
...
$aColumns = array("PEGAWAI_ID", "NO", "NAMA", "NAMA_JAB_STRUKTURAL", "KOMPETEN_IKK", "PSIKOLOGI_IKK", "IKK", "JPM_TOTAL", "IKK_TOTAL", "NILAI", "KODE_KUADRAN", "NAMA_KUADRAN");
$aColumnsAlias = array("PEGAWAI_ID", "NO", "NAMA", "NAMA_JAB_STRUKTURAL", "KOMPETEN_IKK", "PSIKOLOGI_IKK", "IKK", "JPM_TOTAL", "IKK_TOTAL", "NILAI", "KODE_KUADRAN", "NAMA_KUADRAN");
...
$allRecord = $set->getCountByParamsMonitoringTableTalentPoolJPMMonitoring($statementArray, $statement, $reqTahun);
// echo $set->query;exit;
if($_GET['sSearch'] == "")
	$allRecordFilter = $allRecord;
else
	$allRecordFilter = $set->getCountByParamsMonitoringTableTalentPoolJPMMonitoring($statementArray, $statement, $reqTahun, $searchJson);

// echo $set->query;exit;
$set->selectByParamsMonitoringTableTalentPoolJPMMonitoring($statementArray, $dsplyRange, $dsplyStart, $statement, "", $reqTahun, $searchJson);
