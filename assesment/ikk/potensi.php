...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",
		"sAjaxSource": "../json-ikk/potensi_json.php?reqId=<?=$reqId?>&reqCari=<?=$reqCari?>",
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <div id="header-tna">Data <span>Potensi Pegawai</span></div>
    ...
    <ul>
          <li>
            ...
            <?php /*?><a href="#" title="Cetak" id="btnCetak" ><img src="../WEB/images/pegawai-edit.png"/>&nbsp;Cetak Rekap</a><?php */?>
          	<?php /*?><a href="#" title="Cetak" onClick="windowOpenerPopup(250,650,'btncaripotensi','cari_potensi.php');"><img src="../WEB/images/potensi-search.png"/>&nbsp;Cari</a>
