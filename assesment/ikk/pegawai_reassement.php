...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",
		"sAjaxSource": "../json-silat/pegawai_reassement_json.php?reqId=<?=$reqId?>&reqCari=<?=$reqCari?>&reqTahun=<?=$reqTahun?>",
		...
		/* Click event handler */
		  ...
		  $('#btnCetak').on('click', function () {
				reqTahun= $("#reqTahun").val();
			  	...
			  	newWindow = window.open('pegawai_reassement_excel.php?reqTahun='+reqTahun+'&reqId=<?=$reqId?>', 'Cetak');
				newWindow.focus();
		  });
		  ...
		  $("#reqPencarian").keyup(function(e) { 
			...
			if(code==13)
			{
				  ...
				  //setFooter();
				  oTable.fnReloadAjax("../json-silat/pegawai_reassement_json.php?reqStatusPeg="+reqStatusPeg+"&reqTahun="+reqTahun+"&reqEselonId="+reqEselonId+"&reqId=<?=$reqId?>&sSearch="+reqPencarian);
			}
		  });
			  
		  $("#reqStatusPeg,#reqTahun,#reqEselonId").change(function() { 
		  	  var reqStatusPeg= reqTahun= reqEselonId= reqPencarian= "";
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <ul>
          <li>
          	<a href="#" title="Laporan Individu" id="btnLihatFile"><img src="../WEB/images/pegawai-edit.png"/>&nbsp;Laporan Individu</a>
    ...
    IKK per satker :
    <label style="font-weight:bold; font-size:14px;" id="reqInfoIkk"></label><?php */?>
    </div>
