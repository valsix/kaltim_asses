...
$(document).ready(function() {
	zingchart.render({	
		...
		//width : 680,
		height : 480,
		dataurl : "../json-ikk/potensi_add_penilaian_atribut_spider_json.php?reqId=<?=$reqId?>&reqRowId=<?=$reqRowId?>"
	});
});		
			      ...
			      <td colspan="6" id="zingchartPsycology">
                  		<ol id="toc"> 
                           <li><a href="#" onclick="parent.setLoad('general_ikk_add_penilaian_monitoring.php?reqId=<?=$reqId?>', '');"><span>Kembali</span></a></li>
                            <li><a href="#" onclick="parent.setLoad('potensi_add_penilaian_atribut.php?reqId=<?=$reqId?>&reqRowId=<?=$reqRowId?>', '1');"><span><?=$tempAspekNama?></span></a></li>
                            <li class="current"><a href="parent.setLoad('potensi_add_penilaian_atribut_spider.php?reqId=<?=$reqId?>&reqRowId=<?=$reqRowId?>', '1');"><span>Grafik<!--Spider Plot--></span></a></li>
                        </ol>
                  </td>
            </tr>
        </table>
