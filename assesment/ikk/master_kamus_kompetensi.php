...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",
		"sAjaxSource": "../json-ikk/master_kamus_kompetensi_json.php?reqId=<?=$reqId?>&reqCari=<?=$reqCari?>",
		...
		/* Click event handler */
		  ...
		  $('#btnAdd').on('click', function () {
			  window.top.OpenDHTML('master_kamus_kompetensi_add.php?reqMode=insert', 'Aplikasi Indeks Kesenjangan Kompetensi', '880', '495');
		  });
		  ...
		  $('#btnEdit').on('click', function () {
			  ...
			  window.top.OpenDHTML('master_kamus_kompetensi_add.php?reqMode=update', 'Aplikasi Indeks Kesenjangan Kompetensi', '880', '495');
		  });
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <div id="header-tna">Data <span>Kamus Kompetensi</span></div>
