...
{
	$statement_ikk= " AND D.PENILAIAN_ID = ".$reqRowId." AND B.ASPEK_ID = 1 AND X.KODE_UNKER = '".$tempSatkerTesId."'";
...
<div class="detil">
<div style="width:100%; text-align:center; font-weight:600; font-size: 32px;">GENERAL POTENTIAL MATCHING</div><br />
...
<table style="width:100%;" class="bordertable">
    ...
    <tbody>
	  ...
	  ?>
      	<tr>
        	<td class="paddingleftdetil"><?=$index_atribut.". ".$tempNama?></td>
...
<table style="width:100%;" class="myTable">
	<tr>
    	<td rowspan="8" style="width:50%;"></td>
        <td>Jakarta, 02 Desember 2015</td>
    </tr>
    <tr>
    	<td>Menyetujui/Approved By</td>
    </tr>
    <tr>
    	<td>Psychologist</td>
    </tr>
