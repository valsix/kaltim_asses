...
if($reqMode == "delete")
{
	...
	echo "parent.frames['mainFrame'].location.href = 'potensi_add_penilaian_monitoring.php?reqId=".$reqId."&reqMode=".$mode."';";
	echo '</script>';
	
	echo '<script language="javascript">';
	echo "parent.frames['mainFrameDetil'].location.href = 'potensi_add_penilaian.php?reqId=".$reqId."';";
	echo '</script>';
}
...
<link rel="stylesheet" type="text/css" href="../WEB/lib/easyui/themes/default/easyui.css">
	...
	<script type="text/javascript">
		...
		$(function(){
			$('#ff').form({
				url:'../json-ikk/potensi_add_penilaian.php',
				onSubmit:function(){
		...
		function setReload()
		{
			parent.frames['mainFrame'].location.href = 'potensi_add_penilaian_monitoring.php?reqId=<?=$reqId?>&reqMode=' + mode;
			parent.frames['mainFrameDetil'].location.href = 'potensi_add_penilaian.php?reqId=<?=$reqId?>';
		}
...
<div id="content" style="height:auto; margin-top:-4px; width:100%">
	...
	?>
		...
		?>
            <li style="display:none"><a href="potensi_add_penilaian.php?reqMode=tambah&reqId=<?=$tempId?>"><img src="../WEB/img/tambah.png" width="15" height="15"/> Tambah</a></li>
		...
		elseif($reqMode == 'view' || $reqMode == 'cancel')
		{
			$read = 'readonly'; $disabled = 'disabled';
		?>
        <li><a href="#" onclick="parent.setLoad('potensi_add_penilaian_atribut.php?reqId=<?=$tempId?>&reqTahun=<?=$reqTahun?>&reqRowId=<?=$reqRowId?>', 1);"><img src="../WEB/img/tambah.png" width="15" height="15"/> Penilaian</a></li>
        
        <?
		if($tempAspekId == 2)
		{
        ?>
        <!-- <li><a href="potensi_add_penilaian_cetak.php?tempPegawaiInfoId=<?=$reqId?>&tempPegawaiInfoJadwalTesId=<?=$tempJadwalTesId?>" target="_new"><img src="../WEB/img/tambah.png" width="15" height="15"/> Cetak</a></li> -->
        <?
		}
        ?>
        
        <li style="display:none"><a href="#" onclick="parent.setLoad('potensi_add_penilaian_atribut_view.php?reqId=<?=$tempId?>&reqTahun=<?=$reqTahun?>&reqRowId=<?=$reqRowId?>', 1);"><img src="../WEB/img/tambah.png" width="15" height="15"/> Lihat Nilai</a></li>
        <li style="display:none"><a href="potensi_add_penilaian.php?reqMode=tambah&reqId=<?=$tempId?>&reqRowId=<?=$reqRowId?>"><img src="../WEB/img/tambah.png" width="15" height="15"/> Tambah</a></li>
        <li style="display:none"><a href="potensi_add_penilaian.php?reqMode=edit&reqId=<?=$tempId?>&reqRowId=<?=$reqRowId?>"><img src="../WEB/img/edit.png" width="15" height="15"/> Edit</a></li>
        <li style="display:none"><a href="javascript:confirmAction('?reqMode=delete&reqId=<?=$tempId?>&reqRowId=<?=$reqRowId?>', '1')"><img src="../WEB/img/hapus.png" width="15" height="15"/> Hapus</a></li>
        <li style="display:none"><a href="#" style="background: white url(media/bluetab.gif) top left repeat-x; cursor:default; color:#C0C0C0"><img src="../WEB/img/save.png" width="15" height="15"/> Simpan</a></li>
        <li style="display:none"><a href="#" style="background: white url(media/bluetab.gif) top left repeat-x; cursor:default; color:#C0C0C0"><img src="../WEB/img/cancel.png" width="15" height="15"/> Batal</a></li>        
        <? 
		}
        ...
        <li><a href="#" onclick="$('#ff').submit();"><img src="../WEB/img/save.png" width="15" height="15"/> Simpan</a></li>
			...
			?>
        <li><a href="potensi_add_penilaian.php?reqMode=cancel&reqId=<?=$tempId?>&reqRowId=<?=$reqRowId?>"><img src="../WEB/img/cancel.png" width="15" height="15"/> Batal</a></li>
        <? 
		}
...
<div class="content" style="height:90%; width:100%;overflow:hidden; overflow:-x:hidden; overflow-y:auto; position:fixed;">
    ...
    <table class="table_list" cellspacing="1" width="100%">
    	<tr style="display:none">
            ...
            <td>:</td>
            <td>
            	<input id="reqNamaAsesi" name="reqNamaAsesi" class="easyui-validatebox" required <?=$disabled?> style="width:250px" value="<?=$tempNamaAsesi?>" />
            </td>
        </tr>
        <tr style="display:none">
            <td>Metode</td>
            <td>:</td>
            <td>
            	<input id="reqMetode" name="reqMetode" class="easyui-validatebox" required <?=$disabled?> style="width:90%" value="<?=$tempMetode?>" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>:</td>
            <td>
                <?php /*?><input type="text" name="reqJabatanTesId" id="reqJabatanTesId" value="<?=$tempJabatanTesId?>" /> <?php */?>
                <input type="text" <?=$disabled?> class="easyui-validatebox" required style="width:98%" id="reqJabatanTes" name="reqJabatanTesId"
                <?php /*?>data-options="validType:['sameAutoLoder[\'reqJabatanTes\', \'\']']"<?php */?>
