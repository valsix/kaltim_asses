...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",
		"sAjaxSource": "../json-ikk/general_ikk_json.php?reqId=<?=$reqId?>&reqCari=<?=$reqCari?>",
		...
		/* Click event handler */
		  ...
		  $('#btnProses').on('click', function () {
			  if(anSelectedData == "")
				  return false;
			  window.top.OpenDHTML('general_ikk_add.php?reqId='+anSelectedPegawaiId, anSelectedPegawaiNipBaru+' - '+anSelectedPegawaiNama, '880', '495');
		  });
		  ...
		  $('#btnMutasi').on('click', function () {
			  ...
			  opWidth= 1050;
			  opHeight= 550;
			  opUrl= 'mutasi_general_ikk.php?reqPegawaiId='+anSelectedPegawaiId+'&reqId='+anSelectedSatkerId;
			  //newWindow = window.open(opUrl, "", 'fullscreen=yes, scrollbars=auto');
			  //newWindow.focus();
			  ...
			  if(anSelectedData == "")
				...
				$.messager.confirm('Confirm','Apakah anda yakin ingin menghapus data terpilih ?',function(r){
					if (r){
						...
						var jqxhr = $.get( "delete.php?reqMode=general_ikk&id="+anSelectedPegawaiId, function() {
							$.messager.progress('close');
						})
						.done(function() {
							$.messager.progress('close');
							oTable.fnReloadAjax("../json-ikk/general_ikk_json.php?reqSearch=" + $("#reqStatus").val() + "&reqId=<?=$reqId?>");
						})
						.fail(function() {
							alert( "error" );
							$.messager.progress('close');
		  ...
		  $('#btnCetak').on('click', function () {
			  	newWindow = window.open('cetak_rekap_ikk_pdf.php?reqId=<?=$reqId?>');
				newWindow.focus();
		  });
		  ...
		  $("#reqPencarian").keyup(function(e) { 
			...
			if(code==13)
			{
				  ...
				  oTable.fnReloadAjax("../json-ikk/general_ikk_json.php?reqId=<?=$reqId?>&reqCari=<?=$reqCari?>&sSearch="+reqPencarian);
			}
		  });
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <div id="header-tna">Data <span>General IKK Pegawai</span></div>
    ...
    <ul>
          <li>
            ...
            <a href="#" title="Lihat Penilaian" id="btnProses" ><img src="../WEB/images/pegawai-edit.png"/>&nbsp;Lihat Penilaian</a>
             <a href="#" title="Cetak" id="btnCetak" ><img src="../WEB/images/pegawai-edit.png"/>&nbsp;Cetak Rekap</a>
          	<?php /*?><a href="#" title="Cetak" onClick="windowOpenerPopup(250,650,'btncarigeneral_ikk','cari_general_ikk.php');"><img src="../WEB/images/general_ikk-search.png"/>&nbsp;Cari</a>
