...
$set_detil->selectByParamsMonitoringPenilaian(array(), -1, -1, " AND B.ASPEK_ID = 2 AND A.SATUAN_KERJA_ID = '".$tempSatkerTesId."'", $reqRowId);
...
<script type="text/javascript">
	...
	$(function(){
		...
		$('#ff').form({
			url:'../json-ikk/kompetensi_add_penilaian_atribut.php',
			onSubmit:function(){
			...
			success:function(data){
				...
				$('#rst_form').click();
				document.location.href= "kompetensi_add_penilaian_atribut.php?reqId=<?=$reqId?>&reqRowId=<?=$reqRowId?>";
