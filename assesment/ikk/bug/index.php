...
<?
$_GET["JUDUL"] = "| Modul";
$_GET["DESKRIPSI"] = "Indeks Kesenjangan Kompetensi";
                    	...
                    	<tr>
                            ...
                            <td>
                            	<div id="menu-2">
									...
									{
                                    ?>
                                    <div id="menu-2-konten"><a href="#" data-flexmenu="flex-indeks-kesenjangan">Indeks Kesenjangan</a></div>                                    
                                    <?
									}
                                    ?>
									...
									{
									?>
                                    	<div id="menu-2-konten"><a href="monitoring.php?reqMode=pegawai_assement" target="mainFrame" onClick="menuHandler('pegawai')">Assesment</a></div>
                                    <?
									}
									if(findWord($tempListInfo, "Pegawai IKK") == 1 || $tempListInfo == "")
									{
									?>
                                    	<div id="menu-2-konten"><a href="monitoring.php?reqMode=pegawai" target="mainFrame" onClick="menuHandler('pegawai')">Pegawai</a></div>
                                    <?
									}
                                    ?>
                                    <!---->
                                ...
                                <ul id="flex-talent" class="flexdropdownmenu" style="background-color:#385f0e;">
                                	<?
									if(findWord($tempListInfo, "Grafik Nine Box Talent") == 1 || $tempListInfo == "")
									{
                                    ?>
									...
									if(findWord($tempListInfo, "Tabel Nine Box Talent") == 1 || $tempListInfo == "")
									{
                                    ?>
