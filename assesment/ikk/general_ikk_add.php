   	...
   	<tr> 
    	<td valign="top" height="100%" width="100%">
            <table cellpadding="0" cellspacing="0"  width="100%" height="100%">
            	<tr height="10%">
                	<td>
                    	<iframe src="general_ikk_add_penilaian_monitoring.php?reqId=<?=$reqId?>&reqTahun=<?=$reqTahun?>" class="mainframe" id="idMainFrame" name="mainFrame" width="100%" height="100%" scrolling="auto" frameborder="0"></iframe>
                    </td>
                </tr>
            	<tr height="20%" id="trdetil">
                	<td>
                    	<iframe src="general_ikk_add_penilaian.php?reqId=<?=$reqId?>&reqTahun=<?=$reqTahun?>" class="mainframe" id="idMainFrameDetil" name="mainFrameDetil" width="100%" height="100%" scrolling="no" frameborder="0"></iframe>
                    </td>
                </tr>
            </table>			
		</td>
