		        ...
		        <table border="0" style="width:100%">
		        	...
		        	<tr style="padding-top: 3px;">
		        		<td colspan="3">
		        			...
		        			<a style=" background-color: #4CAF50; color: white;padding: 5px;text-align: center;margin: 4px 2px;cursor: pointer;border-radius: 8px;"  onclick="updateSkp()">Update SKP</a>
		        		</td>
		        	</tr>
		        </table>
