...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",
		"sAjaxSource": "../json-ikk/kompetensi_json.php?reqId=<?=$reqId?>&reqCari=<?=$reqCari?>",
		...
		/* Click event handler */
		  ...
		  $('#btnProses').on('click', function () {
			  if(anSelectedData == "")
				  return false;
			  window.top.OpenDHTML('kompetensi_add.php?reqId='+anSelectedPegawaiId, anSelectedPegawaiNipBaru+' - '+anSelectedPegawaiNama, '880', '495');
		  });
		  ...
		  $('#btnMutasi').on('click', function () {
			  ...
			  opWidth= 1050;
			  opHeight= 550;
			  opUrl= 'mutasi_kompetensi.php?reqPegawaiId='+anSelectedPegawaiId+'&reqId='+anSelectedSatkerId;
			  //newWindow = window.open(opUrl, "", 'fullscreen=yes, scrollbars=auto');
			  //newWindow.focus();
			  ...
			  if(anSelectedData == "")
				...
				$.messager.confirm('Confirm','Apakah anda yakin ingin menghapus data terpilih ?',function(r){
					if (r){
						...
						var jqxhr = $.get( "delete.php?reqMode=kompetensi&id="+anSelectedPegawaiId, function() {
							$.messager.progress('close');
						})
						.done(function() {
							$.messager.progress('close');
							oTable.fnReloadAjax("../json-ikk/kompetensi_json.php?reqSearch=" + $("#reqStatus").val() + "&reqId=<?=$reqId?>");
						})
						.fail(function() {
							alert( "error" );
							$.messager.progress('close');
		  ...
		  $('#btnLembarSPMTRow').on('click', function () {
		   ...
		   $('#btnCetak').on('click', function () {
			  	newWindow = window.open('cetak_rekap_kompetensi_pdf.php?reqId=<?=$reqId?>');
				newWindow.focus();
		  ...
		  $("#reqPencarian").keyup(function(e) { 
			...
			if(code==13)
			{
				  ...
				  oTable.fnReloadAjax("../json-ikk/kompetensi_json.php?reqId=<?=$reqId?>&reqCari=<?=$reqCari?>&sSearch="+reqPencarian);
			}
		  });
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <div id="header-tna">Data <span>Kompetensi Pegawai</span></div>
    ...
    <ul>
          <li>
          	...
          	<a href="#" title="Penilaian" id="btnProses"><img src="../WEB/images/pegawai-edit.png"/>&nbsp;Penilaian</a>
            <a href="#" title="Cetak" id="btnCetak"><img src="../WEB/images/pegawai-edit.png"/>&nbsp;Cetak Rekap</a>
         
          	<?php /*?><a href="#" title="Cetak" onClick="windowOpenerPopup(250,650,'btncarikompetensi','cari_pegawai.php');"><img src="../WEB/images/pegawai-search.png"/>&nbsp;Cari</a>
