...
/* DATA VIEW */
$set->selectByParams(array(), -1, -1, " AND A.PEGAWAI_ID = '".$reqId."' AND A.ASPEK_ID = 1");
...
<div id="content" style="height:auto">
	<table class="table_list" cellspacing="1" width="100%" border="0">
        <tr>
            <td colspan="3">
            <div id="header-tna-detil">INDEKS KESENJANGAN KOMPETENSI <span> ASPEK POTENSI</span></div>	                    
            </td>			
        </tr>
        <tr class="terang">
            <td width="20%">Nama</td>
        	...
        	<td colspan="3" width="100%">
            	<table class="gradient-style" cellspacing="1" style="width:100%" id="link-table">
                    ...
                    <tr style="background-color:#FFF;cursor:pointer" <?php /*?>onmouseover="ChangeColor(this, true);"  onmouseout="ChangeColor(this, false);"<?php */?>>
                        <td><a href="potensi_add_penilaian.php?reqId=<?=$set->getField("PEGAWAI_ID")?>&reqRowId=<?=$set->getField("PENILAIAN_ID")?>&reqMode=view">link data</a></td>
                        <td style="display:none"><?=$set->getField("NAMA_ASESI")?></td>
                        <td style="display:none"><?=$set->getField("METODE")?></td>
