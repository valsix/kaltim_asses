...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "160%",
		"sAjaxSource": "../json-ikk/penilaian_skp_json.php?reqId=<?=$reqId?>&reqCari=<?=$reqCari?>&reqTahun=<?=$reqTahun?>",
		...
		/* Click event handler */
		  ...
		  $("#reqTahun").change(function() { 
			  ...
			  oTable.fnReloadAjax("../json-ikk/penilaian_skp_json.php?reqTahun="+reqTahun+"&reqId=<?=$reqId?>&sSearch="+reqPencarian);
		  });
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <div id="header-tna">Data <span>Penilaian SKP</span></div>
