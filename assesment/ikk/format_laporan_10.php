...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr valign="top">
        ...
        <td colspan="15" nowrap="true">
            <table width="640px" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td align="center"><span><font face="ArialMT" color="#000000" size="6"><b>RINGKASAN KOMPETENSI MANAJERIAL</b></font></span></td>
            </tr>
            </table>
        </td>
        <td >&nbsp;</td>
...
<table style="width:100%;">
	<thead>
    	<tr style="background-color:#C7DBE4">
        	...
        	<td class="border txtcenter" rowspan="2" style="width:30%;">AKTIFITAS/KOMPETENSI</td>
