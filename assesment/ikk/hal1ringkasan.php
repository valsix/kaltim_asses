...
<body>
	<div class="container">
		...
		<p style="font-size: 14pt" ><strong>Laporan Individual Hasil Penilaian Kompetensi<br><?=$tempTipeFormula?></strong></p> 
		<p style="font-size: 10pt" >Ringkasan Hasil Penilaian Kompetensi</p>
		...
		<p style="font-size: 14pt" ><strong>I. IDENTITAS PRIBADI</strong></p>	
			<table style="font-size: 10pt">
				<tr style="border: 3px">
					...
					<td><?=$tempPesertaNomorUrut.'-'.$tempBulanRomawi.'-'.$tempTahun?></td>
					<td></td>
					<td>Jabatan</td>
					<td style="width:20px">:</td>
