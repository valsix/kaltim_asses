...
<body>
    ...
    {?>
        <h2 style="text-align: center;">        <?=$arrAsesor[$index_loop]["PENGGALIAN_NAMA"]?></h2>
        <?
      ...
      $reqInfoPenggalianKode= $arrAsesor[$index_loop]["PENGGALIAN_KODE"];
        if($reqInfoPenggalianId != "0")
        {
            ...
            <table style="width :100%; font-size:11pt; border-collapse: collapse;">
                <thead>
                    <tr>
                        <td style="width: 20%;border: 0.5px solid black;text-align: center;background-color: lightgray;"><b>Kompetensi</b></td>
                        <td style="border: 0.5px solid black;text-align: center;background-color: lightgray;"><b>Uraian</b></td>
                        <td style="width: 10%;border: 0.5px solid black;text-align: center;background-color: lightgray;"><b>Nilai</b></td>
                    </tr>
                </thead>
            <?  
            if($arrayKey == ''){}
        ...
        <br>
            <table width ='100%' style=" font-size:11pt; border-collapse: collapse;"> 
              <thead>
                  <tr>
                    <td  style="border: 0.5px solid black; text-align: center;background-color: lightgray;">ATRIBUT & INDIKATOR</td>
                    <td  style="border: 0.5px solid black; text-align: center;background-color: lightgray;">Standar</td>
                    <td  style="border: 0.5px solid black; text-align: center;background-color: lightgray;">Nilai</td>
                  </tr>
              </thead>
                <?
            ...
            <table  style="width :100%; font-size:11pt; border-collapse: collapse;">
                <tr>
                    <td style="border: 0.5px solid black;background-color: lightgray;" width="3%">No</td>
                    <td style="border: 0.5px solid black;background-color: lightgray;" width="20%">Kompetensi</td>
                    <td style="border: 0.5px solid black;background-color: lightgray;" width="5%">Rating</td>
                    <td style="border: 0.5px solid black;background-color: lightgray;" >Keterangan</td>
                </tr>
                <?
    ...
    <h2 style="text-align: center;">Nilai Akhir</h2>
    <table style="width: 100%; border-collapse: collapse;padding-top: 20px;">
      <thead>
        <tr>
            <td style="text-align:center; width: 10%;border: 0.5px solid black;background-color: lightgray;">No</td>
            <td style="text-align:center;border: 0.5px solid black;background-color: lightgray;">ATRIBUT & INDIKATOR</td>
            <td style="text-align:center; width: 10%;border: 0.5px solid black;background-color: lightgray;">Standar Rating</td>
            <td style="text-align:center;border: 0.5px solid black;background-color: lightgray;" >Hasil Individu</td>
            <td style="text-align:center; width: 5%;border: 0.5px solid black;background-color: lightgray;">Gap</td>
            <td style="text-align:center;border: 0.5px solid black;background-color: lightgray;">Deskripsi</td>
            <td style="text-align:center;border: 0.5px solid black;background-color: lightgray;">Saran Pengembangan</td>
        </tr>
      </thead>
      <tbody>
        <?
          ...
          for($index_detil=0; $index_detil < count($arrayKey); $index_detil++)
          {
            ...
            ?>
              <tr style="background-color: lightgray;">
                <th style="text-align:center;border: 0.5px solid black;"><b><?=romanicNumber($index_atribut_parent)?></b></th>
                <th colspan="<?=$tempcolspan+1?>" style="border: 0.5px solid black;"><b><?=$reqPenilaianKompetensiAtributNama?></b></th>
              </tr>
            <?
            }
            else
            ...
            ?>                                          
              <tr>
                <td style="vertical-align: top; text-align:center;border: 0.5px solid black;"><?=$index_atribut?></td>
                <td style="vertical-align: top;border: 0.5px solid black;"><?=$reqPenilaianKompetensiAtributNama?>.</td>
                <?
                ...
                ?>
                <td style="vertical-align: top; text-align:center;border: 0.5px solid black;"><?=NolToNone($reqPenilaianKompetensiNilaiStandar)?>&nbsp;</td>
                <td style="vertical-align: top; text-align:center;border: 0.5px solid black;"><?=$reqPenilaianKompetensiNilaiAsli?></td>
                <td style="vertical-align: top; text-align:center;border: 0.5px solid black;"><?=$reqPenilaianKompetensiGap?></td>
                <td style="border: 0.5px solid black;"><?=$reqPenilaianKompetensiBukti?></td>
                <td style="vertical-align: top; text-align:center;border: 0.5px solid black;"><?=$reqPenilaianKompetensiCatatan?></td>
              </tr>
            <?
            }
          }
    ...
    <table style="border-collapse: collapse;">
        <tr style="border: 0.5px solid black;">
          <th colspan="<?=$tempsarancolspan+1?>" style="background-color: lightgray;">
            Area Pengembangan
          </th>
        </tr>
        <tr  style="border: 0.5px solid black;">
    ...
    <table style="width: 100%; border-collapse: collapse;" >
        <thead>
            <tr>
               <td style="border:0.5px solid black;text-align: center;background-color: lightgray;"><b>Aspek</b></td>
                <td style="border:0.5px solid black;text-align: center;background-color: lightgray;"><b>Keterangan</b></td>
            </tr>
        </thead>                           
        <tr>
            <td style="border:0.5px solid black"> Kekuatan</td>
        ...
        <tr>
            <td style="border:0.5px solid black"> Kelemahan</td>
            <td style="border:0.5px solid black">
                <?
        ...
        <tr>
            <td style="border:0.5px solid black"> Rekomendasi</td>
            <td style="border:0.5px solid black">
            <?
        ...
        <tr>
            <td style="border:0.5px solid black"> Saran Pengembangan</td>
            <td style="border:0.5px solid black">
                <?
        ...
        <tr>
            <td style="border:0.5px solid black"> Saran Penempatan</td>
            <td style="border:0.5px solid black">
                <table>
                <?
                  for($index_catatan=0; $index_catatan<$jumlahPenilaianPotensiSaranPenempatan; $index_catatan++)
        ...
        <tr>
            <td style="border:0.5px solid black"> Ringkasan Profil Kompetensi</td>
            <td style="border:0.5px solid black">
                <table>
                <?
    ...
    <table style="border-collapse: collapse; width: 100%;" >
      <tr>
        <td style="background-color: lightgray; text-align: center;width: 5%; border: 0.5px solid black;">No</td>
        <td style="background-color: lightgray; text-align: center;width: 30%; border: 0.5px solid black;">Kompetensi</td>
        <?for($index_loop=0; $index_loop < $jumlah_asesor; $index_loop++)
        {
          $reqInfoPenggalianKode= $arrAsesor[$index_loop]["PENGGALIAN_KODE"];
          if($reqInfoPenggalianKode!='Psikotes'){
        ?>
          <td style="background-color: lightgray;text-align: center;border: 0.5px solid black;"><?=$reqInfoPenggalianKode?></td>
        <?
          }
        }
        ?>
        <td style="background-color: lightgray;text-align: center;width: 30%;border: 0.5px solid black;">Kesimpulan</td>
      </tr>
     <?
     // $arrayKey= in_array_column("2", "ASPEK_ID", $arrPenilaian);
      $arrayKey= in_array_column($reqInfoPenggalianId, "PENGGALIAN_ID", $arrPegawaiNilai);
      ...
      for($index_detil=0; $index_detil < count($arrayKey); $index_detil++)
      {
        ...
        if($ceknama!=$reqJadwalPegawaiAtributNama){
          ?>
        <tr>
          <td style="background-color: lightgray;text-align: center;border: 0.5px solid black;"><?=$no?></td>
        ...
        <?
          ...
          if($arrPenilaian[$arrayKeysss[$no]]["PENILAIAN_DETIL_ID"]==''){?>
            <td style="border: 0.5px solid black;text-align: center;"><?=$arrPenilaian[$arrayKeysss[$no+1]]["NILAI"];?></td>
          <?}
          else{
          ?>
            <td style="border: 0.5px solid black;text-align: center;"><?=$arrPenilaian[$arrayKeysss[$no]]["NILAI"];?></td>
          <?}?>
        </tr>
        <?  
        $no++;
    ...
    <table style="margin-bottom:60px; border-collapse: collapse;" >
        <thead>
            <tr>
                <td style="background-color: lightgray;text-align: center;width: 5%;border: 0.5px solid black;">No</td>
                <td style="background-color: lightgray;text-align: center;border: 0.5px solid black;">Aspek Potensi</td>
                <td style="background-color: lightgray;text-align: center;border: 0.5px solid black;">Rating</td>
                <td style="background-color: lightgray;text-align: center;border: 0.5px solid black;">Keterangan</td>
            </tr>
        </thead>
     <?
      $arrayKey= in_array_column("1", "ASPEK_ID", $arrPenilaian);
      ...
      else
      {
        ...
        for($index_detil=0; $index_detil < count($arrayKey); $index_detil++)
        {
          ...
          <tr>
            <td style="border: 0.5px solid black;"><?=$index_atribut_parent?></td>
            <td style="border: 0.5px solid black;"><?=$reqPenilaianKompetensiAtributNama?></td>
            <td style="text-align: center;border: 0.5px solid black;"><?=$setPenilaianKompetensi->getField("nilai")?></td>
          ...
          <tr>
            <td colspan="4"  style="background-color: lightgray;text-align: center;border: 0.5px solid black;"><?=$reqPenilaianKompetensiAtributNama?></td>                         
          </tr>
          <?
          $index_atribut_parent= 1;
          }
