    ...
    <table class="table_list" cellspacing="1" width="100%" id="link-table">
      ...
      <th>Tempat</th>
        ...
        <tr style="background-color:#FFF;cursor:pointer"onmouseover="ChangeColor(this, true);"  onmouseout="ChangeColor(this, false);">
            ...
            <td><center><?=$pendidikan_riwayat->getField('tahun_awal')?> - <?=$pendidikan_riwayat->getField('tahun_akhir')?><center></td>
            <td><?=$pendidikan_riwayat->getField('nama_sekolah')?></td>
            <td><?=$pendidikan_riwayat->getField('TEMPAT')?></td>
