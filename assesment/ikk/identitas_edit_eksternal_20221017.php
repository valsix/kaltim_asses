    	...
    	<td width="15%">Jenis Pegawai</td><td style="width: 2%">:</td>
			<td>
				<select name="reqStatusJenis">
					...
					<option value="2" <? if($reqStatusJenis == '2') echo 'selected';?>>PNS Luar Prov Bali</option>
					<option value="3" <? if($reqStatusJenis == '3') echo 'selected';?>>Kalangan Umum</option>
				</select>
			</td>
    </tr>
    <tr>
        	<td width="20%">Satuan Kerja</td><td width="2%">:</td>
			<td colspan="4">
				<input style="width: 99%" type="text" id="reqSatuanKerjaNama" name="reqSatuanKerjaNama" value="<?=$reqSatuanKerjaNama?>" class="easyui-validatebox" />
				<input type="hidden" name="reqSatuanEksternalKerjaId" id="reqSatuanEksternalKerjaId" value="<?=$reqSatuanEksternalKerjaId?>" />
			</td>			
        </tr>
        <tr>
        	<td width="20%">Tempat Kerja</td><td width="2%">:</td>
			<td colspan="4">
        ...
        <tr>
        	<td>No KTP</td><td>:</td>
        	<td>
        		<input type="text" style="width:45%" id="reqKtp" name="reqKtp" value="<?=$reqKtp?>" class="required" title="Nama harus diisi" dixxxsabled="dixxxsabled" />
        	</td>
        	<td>Status Pegawai</td><td>:</td>
			<td>
				<select id="reqStatusPegawaiId" name="reqStatusPegawaiId">
					<option value="" <? if($reqStatusPegawaiId == "") echo "selected";?>>-</option>
		...
		<tr>      
			...
			<td colspan="4">
				<input type="text" style="width:100px" name="reqTempatLahir" value="<?=$reqTempatLahir?>" dixxxsabled="dixxxsabled" />
				Tanggal Lahir
				<input type="text" class="easyui-datebox" style="width:100px" name="reqTglLahir" id="reqTglLahir" dixxxsabled="dixxxsabled" maxlength="10" value="<?=$reqTglLahir?>" />
		...
		<tr>           
			...
			<td colspan="4">
				<select name="reqJenisKelamin" dixxxsabled="dixxxsabled" >
        ...
        <tr>
        	<td>Agama</td><td>:</td>
        	<td colspan="4">
        		<select dixxxsabled="dixxxsabled" name="reqAgama" id="reqAgama" class="form-control" <?=$disabled?> style="width:45%">
		...
		<tr>
			...
			<td colspan="4">
				<select name="reqStatusKawin" dixxxsabled="dixxxsabled" >
		...
		<tr>           
			<td>Alamat</td><td>:</td>			
			<td colspan="4">
                <textarea name="reqAlamat" style="width: 99%" rows="2"><?=$reqAlamat?></textarea>
			</td>
        </tr>
        <tr>
        	<td>Alamat Tempat Kerja</td><td>:</td>
        	<td colspan="4">
        		<textarea name="reqAlamatTempatKerja" style="width: 99%" rows="2"><?=$reqAlamatTempatKerja?></textarea>
        	</td>
        </tr>
        <tr>
        	<td>Alamat Email</td><td>:</td>
        	<td colspan="4">
        		<input type="text" name="reqEmail" id="reqEmail" <?=$read?> value="<?=$reqEmail?>" style="width:50%" class="form-control easyui-validatebox" dixxxsabled="dixxxsabled"  />
        	</td>
        </tr>
        <tr>
        	<td>Akun Sosial Media</td><td>:</td>
        	<td colspan="4">
        		<input type="text" name="reqSosmed" id="reqSosmed" <?=$read?> value="<?=$reqSosmed?>" style="width:50%" class="form-control easyui-validatebox" dixxxsabled="dixxxsabled"  />
        	</td>
        </tr>
        <tr>
        	<td>Kontak Pribadi (HP)</td><td>:</td>
        	<td colspan="4">
        		<input type="text" style="width:20%" name="reqHp" id="reqHp" <?=$read?> value="<?=$reqHp?>" class="form-control easyui-validatebox"  dixxxsabled="dixxxsabled" />
        	</td>
        </tr>
        <tr>
        	<td>Auto Anamnesa</td><td>:</td>
        	<td colspan="4">
        		<input type="text" style="width:99%" name="reqAutoAnamnesa" id="reqAutoAnamnesa" <?=$read?> value="<?=$reqAutoAnamnesa?>" class="form-control easyui-validatebox"  dixxxsabled="dixxxsabled" />
        	</td>
        </tr>	
		<tr style="display:none">
			<td>RT</td><td>:</td>			
			<td>
				<input type="text" style="width:50px" name="reqRT" dixxxsabled="dixxxsabled" value="<?=$reqRt?>" />
				RW
				<input type="text" style="width:50px" name="reqRW" dixxxsabled="dixxxsabled" value="<?=$reqRw?>" />
			</td>
        </tr>
		<tr style="display:none">
			<td>Telepon</td><td>:</td>			
			<td>
				<input type="text" style="width:100px" name="reqTelepon" dixxxsabled="dixxxsabled" value="<?=$reqTelepon?>" />
				Kode Pos
				<input type="text" style="width:100px" name="reqKodePos" dixxxsabled="dixxxsabled" value="<?=$reqKodePos?>" />
			</td>
        </tr>
		...
		<tr>           
			...
			<td>
				<input type="text" class="easyui-datebox" style="width:100px" name="reqPangkatTmt" id="reqPangkatTmt" dixxxsabled="dixxxsabled" maxlength="10" value="<?=$reqPangkatTmt?>" />
			</td>
        </tr>
		<tr>           
			...
			<td>
				<input type="text" class="easyui-datebox" style="width:100px" name="reqJabatanTmt" id="reqJabatanTmt" dixxxsabled="dixxxsabled" maxlength="10" value="<?=$reqJabatanTmt?>" />
			</td>		
        </tr>
        <tr>           
			<td>Pendidikan Terakhir</td><td>:</td>			
			<td colspan="4">
				<input type="text" name="reqPendidikanJurusan" id="reqPendidikanJurusan" <?=$read?> value="<?=$reqPendidikanJurusan?>" style="width:45%" class="form-control easyui-validatebox" dixxxsabled="dixxxsabled"  />
				<select name="reqPendidikanId">
				<?
