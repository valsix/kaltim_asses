...
$tempPegawaiInfoJadwalTesId= httpFilterGet("tempPegawaiInfoJadwalTesId");
$tempPegawaiInfoId= httpFilterGet("tempPegawaiInfoId");
//echo $tempPegawaiInfoJadwalTesId;exit;
$index_loop= 0;
$arrDataAtribut="";
...
$pegawai->selectByParamsMonitoringPegawai(array("A.PEGAWAI_ID" => $tempPegawaiInfoId)); 
$pegawai->firstRow();
...
$row = 2;
$col = 'A';	$objWorksheet->setCellValue($col.$row, $tempNama); $objWorksheet->mergeCells('A'.$row.':F'.$row.'');
...
for($index_atribut=0;$index_atribut < $jumlah_pegawai_atribut;$index_atribut++)
{
	...
	$tempTotalJumlah= round($tempTotalJumlah / $tempJumlahBagi);
	$kolom= getColoms(9);
