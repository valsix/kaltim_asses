...
$set->selectByParams(array(), -1, -1, $statement." AND A.STATUS_PENILAIAN = 0 AND A.PEGAWAI_ID = '".$reqId."' ", " ORDER BY A.ASPEK_ID ASC, A.PENILAIAN_ID ASC");
        	...
        	<td colspan="3" width="100%">
            	<table class="gradient-style" cellspacing="1" style="width:100%" id="link-table">
                    ...
                    <tr style="background-color:#FFF;cursor:pointer" <?php /*?>onmouseover="ChangeColor(this, true);"  onmouseout="ChangeColor(this, false);"<?php */?>>
                        <td><a href="potensi_add_penilaian.php?reqId=<?=$set->getField("PEGAWAI_ID")?>&reqTahun=<?=$reqTahun?>&reqRowId=<?=$set->getField("PENILAIAN_ID")?>&reqMode=view">link data</a></td>
                        <td><?=$set->getField("ASPEK_NAMA")?></td>
