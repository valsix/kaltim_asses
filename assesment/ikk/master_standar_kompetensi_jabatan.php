...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",
		"sAjaxSource": "../json-ikk/master_standar_kompetensi_jabatan_json.php?reqId=<?=$reqId?>&reqCari=<?=$reqCari?>",
		...
		/* Click event handler */
		  ...
		  $('#btnAdd').on('click', function () {
			  window.top.OpenDHTML('master_standar_kompetensi_jabatan_add.php?reqMode=insert', 'Aplikasi Indeks Kesenjangan Kompetensi', '880', '495');
		  });
		  ...
		  $('#btnEdit').on('click', function () {
			  ...
			  window.top.OpenDHTML('master_standar_kompetensi_jabatan_add.php?reqMode=update', 'Aplikasi Indeks Kesenjangan Kompetensi', '880', '495');
		  });
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <div id="header-tna">Data <span>Standar Kompetensi Jabatan</span></div>
    <div id="bluemenu" class="bluetabs" style="background:url(css/media/bluetab.gif)">    
    <ul>
          <li>
          	<a href="#" title="Tambah" id="btnAdd"><img src="../WEB/images/pegawai-add.png"/>&nbsp;Tambah</a>
          	<a href="#" title="Edit" id="btnEdit"><img src="../WEB/images/pegawai-edit.png"/>&nbsp;Ubah</a>
    ...
    <thead>
        <tr>
            ...
            <th width="120px">Jenis Kompetensi</th>
            <th width="220px">Kompetensi</th>         
            <th width="320px">Level</th> 
        </tr>
    </thead>
    </table>
