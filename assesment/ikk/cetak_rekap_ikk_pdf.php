...
for($index_loop=0; $index_loop < $index_tahun; $index_loop++)
{
	...
	<div style='margin-top:18px;' id='header'>
		<p style='text-decoration:underline; text-align:center; width:950px;'><strong>LAPORAN REKAPITULASI HASIL PENILAIAN POTENSI / KOMPETENSI TAHUN ".$arrTahun[$index_loop]["TAHUN"]."</strong></p>
	</div>
	<div id='detil'>
	...
	";
		...
		$statement.= " AND YEAR(D.TANGGAL_TES) = ".$arrTahun[$index_loop]["TAHUN"];
