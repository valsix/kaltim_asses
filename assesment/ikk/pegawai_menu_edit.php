...
if(varItem == 'idpegawai'){
	...
	<? if($reqStatusJenis == '2'){?>
		parent.mainFrame.location.href='identitas_edit_eksternal<?=$reqSource?>.php?reqPegawaiId=<?=$reqPegawaiId?>&reqIdOrganisasi=<?=$reqIdOrganisasi?>';
	<? } else {?>
...
<?php /*?>else if(varItem == 'penilaianLHKPN'){
	...
	parent.mainFrame.location.href='unsur_penilaian<?=$reqSource?>.php?reqPegawaiId=<?=$reqPegawaiId?>&reqIdOrganisasi=<?=$reqIdOrganisasi?>';
	parent.document.getElementById('trdetil').style.display = 'none';	
	//parent.mainFrameDetil.location.href='jabatan_detil<?=$reqSource?>.php?reqPegawaiId=<?=$reqPegawaiId?>&reqIdOrganisasi=<?=$reqIdOrganisasi?>';
	//parent.document.getElementById('trdetil').style.display = '';	
}
	...
	parent.mainFrame.location.href='../pengaturan/master_integrasi_data.php?reqId=<?=$reqPegawaiId?>&reqMode='+varItem;
	parent.document.getElementById('trdetil').style.display = 'none';
}
return true;
}
