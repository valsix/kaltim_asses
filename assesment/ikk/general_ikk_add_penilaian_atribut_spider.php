...
<script src="../WEB/lib/highcharts/exporting.js"></script>
        
<script>

$(function () {
	setModalAwal("chartContainer", "../json-ikk/general_ikk_add_penilaian_atribut_spider.php?reqRowId=<?=$reqRowId?>", "99");
});
...
function setModalAwal(target, link_url, infoId)
{
	...
	request.done(function(msg)
	{
		...
		else
		{
			...
			//if(infoId == 1)
			//setModalAwal("reqSudahMelaporId", "../json-index/sudah_melapor_json.php?reqTahun=<?=$reqTahun?>&reqSkpdId=<?=$reqSkpdId?>", "99");
		}
	});
    	...
    	<table class="table_list" cellspacing="1" width="100%">
            ...
            <tr>
			      <td colspan="6">
                        ...
                        <div id='chartContainer' style="width:100%; height: 342px; margin-top:-20px; margin-left:0px;" /></div>
                  </td>
            </tr>
        </table>
    </form>
