...
if($reqMode == "delete")
{
	...
	echo "parent.frames['mainFrame'].location.href = 'kompetensi_add_penilaian_monitoring.php?reqId=".$reqId."&reqMode=".$mode."';";
	echo '</script>';
	
	echo '<script language="javascript">';
	echo "parent.frames['mainFrameDetil'].location.href = 'kompetensi_add_penilaian.php?reqId=".$reqId."';";
	echo '</script>';
}
...
<link rel="stylesheet" type="text/css" href="../WEB/lib/easyui/themes/default/easyui.css">
	...
	<script type="text/javascript">
		...
		$(function(){
			$('#ff').form({
				url:'../json-ikk/kompetensi_add_penilaian.php',
				onSubmit:function(){
		...
		function setReload()
		{
			parent.frames['mainFrame'].location.href = 'kompetensi_add_penilaian_monitoring.php?reqId=<?=$reqId?>&reqMode=' + mode;
			parent.frames['mainFrameDetil'].location.href = 'kompetensi_add_penilaian.php?reqId=<?=$reqId?>';
		}
...
<div id="content" style="height:auto; margin-top:-4px; width:100%">
	...
	?>
		...
		?>
            <li style="display:none"><a href="kompetensi_add_penilaian.php?reqMode=tambah&reqId=<?=$tempId?>"><img src="../WEB/img/tambah.png" width="15" height="15"/> Tambah</a></li>
		...
		elseif($reqMode == 'view' || $reqMode == 'cancel')
		{
			$read = 'readonly'; $disabled = 'disabled';
		?>
        <li style="display:none"><a href="#" onclick="parent.setLoad('kompetensi_add_penilaian_atribut.php?reqId=<?=$tempId?>&reqRowId=<?=$reqRowId?>', 1);"><img src="../WEB/img/tambah.png" width="15" height="15"/> Penilaian</a></li>
        <li><a href="#" onclick="parent.setLoad('kompetensi_add_penilaian_atribut_view.php?reqId=<?=$tempId?>&reqRowId=<?=$reqRowId?>', 1);"><img src="../WEB/img/tambah.png" width="15" height="15"/> Lihat Nilai</a></li>
        <li style="display:none"><a href="kompetensi_add_penilaian.php?reqMode=tambah&reqId=<?=$tempId?>&reqRowId=<?=$reqRowId?>"><img src="../WEB/img/tambah.png" width="15" height="15"/> Tambah</a></li>
        <li style="display:none"><a href="kompetensi_add_penilaian.php?reqMode=edit&reqId=<?=$tempId?>&reqRowId=<?=$reqRowId?>"><img src="../WEB/img/edit.png" width="15" height="15"/> Edit</a></li>
        ...
        <li><a href="#" onclick="$('#ff').submit();"><img src="../WEB/img/save.png" width="15" height="15"/> Simpan</a></li>
			...
			?>
        <li><a href="kompetensi_add_penilaian.php?reqMode=cancel&reqId=<?=$tempId?>&reqRowId=<?=$reqRowId?>"><img src="../WEB/img/cancel.png" width="15" height="15"/> Batal</a></li>
        <? 
		}
