...
<div class="content" style="height:97%; width:100%;overflow:hidden; overflow:-x:hidden; overflow-y:auto; position:fixed;">
    <table class="table_list" cellspacing="1" width="100%">
        ...
        <tr>
        	<td>No KTP</td><td>:</td>
        	<td>
        		<input type="text" style="width:318px" name="reqKtp" value="<?=$tempKtp?>" class="required" title="Nama harus diisi" disabled="disabled" />
        	</td>
		<tr>          
            <td >Nama</td><td>:</td>
			<td>
				<input type="text" style="width:318px" name="reqNama" value="<?=$tempNama?>" class="required" title="Nama harus diisi" disabled="disabled" />
			</td>
        </tr>
		<tr>
        	<td width="5%">Status Pegawai</td><td width="2%">:</td>
			<td>
				<input type="text" style="width:100px" name="reqStatusPegawai" value="<?=$tempStatusPegawai?>" disabled="disabled" />
			</td>	
		</tr>
		<tr>      
			<td>Tempat Lahir</td><td>:</td>
				<td><input type="text" style="width:100px" name="reqTempatLahir" value="<?=$tempTempatLahir?>" disabled="disabled" />
				Tanggal Lahir
				<input type="text" style="width:80px" name="reqTanggalLahir" id="reqTanggalLahir" disabled="disabled" maxlength="10" onkeydown="return format_date(event,'reqTanggalLahir');" value="<?=$tempTanggalLahir?>" />
			</td>
        </tr>
		<tr>           
		...
		<tr>           
			<td>Alamat</td><td>:</td>			
				<td>
                <textarea style="display:none" name="reqAlamat" cols="35" <?php /*?>class="required" title="Alamat harus diisi"<?php */?> disabled="disabled" ><?=$tempAlamat?></textarea>
                <?=$tempAlamat?>
			</td>
        </tr>
        ...
        <tr>
        	...
        	<td>
        		<input type="text" name="reqEmail" id="reqEmail" <?=$read?> value="<?=$tempEmail?>" style="width:50%" class="form-control easyui-validatebox" disabled="disabled"  />
        	</td>
        </tr>
        <tr>
        ...
        <tr>
        	...
        	<td>
        		<input type="text" style="width:40%" name="reqHp" id="reqHp" <?=$read?> value="<?=$tempHp?>" class="form-control easyui-validatebox"  disabled="disabled" />
        	</td>
        </tr>
        <tr>
		...
		<tr>           
			...
			<td><?=$tempPangkatTerkahir?></td>
			<td>TMT Pangkat</td><td>:</td>			
			<td><?=$tempTMTPangkat?></td>		
        </tr>
		<tr>           
			<td>Jabatan Terakhir</td><td>:</td>			
			<td><?=$tempJabatanTerkahir?></td>
			<td>TMT Jabatan</td><td>:</td>			
			<td><?=$tempTMTJabatan?></td>		
        </tr><tr>           
