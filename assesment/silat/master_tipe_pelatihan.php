...
if($reqJenis == "1")
{
	...
	echo "window.location.href = 'master_tipe_pelatihan_add_absen.php?reqJenis=".$reqJenis."&reqId=".$reqJadwalTesId."';";
	echo '</script>';
}
?>
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",					  
		"sAjaxSource": "../json-silat/master_tipe_pelatihan_json.php",
		...
		/* Click event handler */
		  ...
		  $('#btnTambah,#btnUbahData').on('click', function () {
			  ...
			  opWidth = 880;
			  opHeight = 480;
			  opUrl= 'master_tipe_pelatihan_add.php?reqId='+anSelectedRowId;
			  window.top.OpenDHTML(opUrl, "Master Tipe Pelatihan", opWidth, opHeight);
		  });
			  ...
			  if(anSelectedData == "")
				...
				$.messager.confirm('Confirm','Apakah anda yakin ingin menghapus data terpilih ?',function(r){
					if (r){
						...
						var jqxhr = $.get( "../json-silat/delete.php?reqMode=master_tipe&id="+anSelectedRowId, function() {
						...
						.done(function() {
							...
							oTable.fnReloadAjax("../json-silat/master_tipe_pelatihan_json.php");
						})
						.fail(function() {
							alert( "error" );
							$.messager.progress('close');
...
<body id="index" class="grid_2_3" style="overflow:hidden">
	...
	<div id="header-tna">Master <span>Tipe Pelatihan</span></div>
    ...
    <thead>
        <tr>
            <th width="1px">id</th>
            <th width="250px">Kode Pelatihan</th>
            <th width="250px">Nama Pelatihan</th>                        
        </tr>
    </thead>
    </table>
