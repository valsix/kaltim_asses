...
else if(varItem == 'skppersonal'){
	parent.setShowHideMenu(2);
	$('#skppersonal').addClass("menuAktifDynamis");
	parent.mainFrame.location.href='pegawai_skp_nilai<?=$reqSource?>.php?reqPegawaiId=<?=$reqPegawaiId?>&reqIdOrganisasi=<?=$reqIdOrganisasi?>';
	parent.document.getElementById('trdetil').style.display = 'none';
}
...
<div id="content">
    ...
    <div style="float: left" id="my_menu" class="sdmenu">
      ...
      <div>
        <span>SKP</span>
        <a href="#" id="skppersonal" onclick="executeOnClick('skppersonal');">Personal</a>
      </div>
    </div>
    <!-- END SDMENU -->
