...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",					  
		"sAjaxSource": "../json-silat/master_kategori_pelatihan_json.php",
		...
		/* Click event handler */
		  ...
		  $('#btnTambah,#btnUbahData').on('click', function () {
			  ...
			  opWidth = 880;
			  opHeight = 480;
			  opUrl= 'master_kategori_pelatihan_add.php?reqId='+anSelectedRowId;
			  window.top.OpenDHTML(opUrl, "Master Kategori Pelatihan", opWidth, opHeight);
		  });
			  ...
			  if(anSelectedData == "")
				...
				$.messager.confirm('Confirm','Apakah anda yakin ingin menghapus data terpilih ?',function(r){
					if (r){
						...
						var jqxhr = $.get( "../json-silat/delete.php?reqMode=master_kategori&id="+anSelectedRowId, function() {
						...
						.done(function() {
							...
							oTable.fnReloadAjax("../json-silat/master_kategori_pelatihan_json.php");
						})
						.fail(function() {
							alert( "error" );
							$.messager.progress('close');
...
<body id="index" class="grid_2_3" style="overflow:hidden">
	...
	<div id="header-tna">Master <span>Kategori Pelatihan</span></div>
    ...
    <thead>
        <tr>
            <th width="1px">id</th>
            <th width="250px">Kode Kategori Pelatihan</th>
            <th width="250px">Nama Kategori Pelatihan</th>    
            <th width="250px">Kode Tipe Pelatihan</th>
            <th width="250px">Nama Tipe Pelatihan</th>                        
        </tr>
    </thead>
    </table>
