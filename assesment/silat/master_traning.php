...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",					  
		"sAjaxSource": "../json-silat/master_traning_json.php?reqTahun=<?=$reqTahun?>",
		...
		/* Click event handler */
		  ...
		  $('#btnTambah,#btnUbahData').on('click', function () {
			  ...
			  opUrl= 'master_traning_add.php?reqId='+anSelectedRowId;
		  ...
		  $('#btnDelete').on('click', function () {
			  if(anSelectedData == "")
				...
				if(reqTahun == "2015")
				{
					alert("Data 2015 tidak dapat dihapus, hub admin.");
				}
				else
				{
					$.messager.confirm('Confirm','Apakah anda yakin ingin menghapus data terpilih ?',function(r){
						if (r){
							...
							var jqxhr = $.get( "../json-silat/delete.php?reqMode=training&id="+anSelectedRowId+"&reqRowDetilId="+anSelectedRowDetilId, function() {
							...
							.done(function() {
								...
								reqTrainingId= $("#reqTrainingId").val();
								reqTahun= $("#reqTahun").val();
								oTable.fnReloadAjax("../json-silat/master_traning_json.php?reqTrainingId="+reqTrainingId+"&reqTahun="+reqTahun);
							})
							.fail(function() {
								alert( "error" );
								$.messager.progress('close');
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <div id="header-tna">Master <span>Training</span></div>
