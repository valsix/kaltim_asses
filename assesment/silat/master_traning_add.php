   	...
   	<tr> 
      		...
      		<table width="242" border="0" cellpadding="0" cellspacing="0" height="100%" id="menuFrame">
        		<tr> 
         			...
         			<td valign="top">
				  	...
				  	<!-- MENU -->
				  	<iframe src="master_traning_menu.php?reqId=<?=$reqId?>" name="menuFrame" width="100%" height="100%" scrolling="auto" frameborder="0"></iframe>		  
		  			</td>
        		</tr>
      		</table>
		</td>
    	...
    	<td valign="top" height="100%" width="100%">
            <div id="kontainer-atas" class="kontainer-atasFull">
                <iframe class="mainframe" id="idMainFrame" name="mainFrame" src="master_traning_add_data.php?reqId=<?=$reqId?>&reqConfirm=<?=$reqConfirm?>" style="width:100%; height:calc(100% - 5px); border:none;"></iframe>
            </div>
