...
else
{
	$statement_tahun = "";
	$reqMode = "update";	
	$set->selectByParams(array('TIPE_PELATIHAN_ID'=>$reqId), -1, -1, $statement_tahun);
	$set->firstRow();
	//echo $set->query;exit;
	$tempNamaPelatihan= $set->getField("NAMA_TIPE_PELATIHAN");
	$tempKodePelatihan= $set->getField("KODE_PELATIHAN");
}
...
<script type="text/javascript">	
	$(function(){
		$('#ff').form({
			url:'../json-silat/master_tipe_pelatihan_add_json.php',
			onSubmit:function(){
...
<div id="content" style="height:auto; margin-top:-4px; width:100%">
    	...
    	<table class="table_list" cellspacing="1" width="100%">
            <tr>
                <td colspan="6">
                <div id="header-tna-detil">Tipe <span>Pelatihan</span></div>
                </td>			
            </tr>
            <tr>
