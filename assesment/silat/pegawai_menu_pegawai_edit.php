...
else if(varItem == 'general_ikk_add'){
	parent.setShowHideMenu(1);
	$('#general_ikk_add').addClass("menuAktifDynamis");
	parent.mainFrame.location.href='../ikk/general_ikk_add_penilaian_monitoring<?=$reqSource?>.php?reqId=<?=$reqPegawaiId?>';
	parent.mainFrameDetil.location.href='../ikk/general_ikk_add_penilaian<?=$reqSource?>.php?reqId=<?=$reqPegawaiId?>';
	parent.document.getElementById('trdetil').style.display = '';	
}
else if(varItem == 'pegawai_add_karir_rencana_grafik'){
	parent.setShowHideMenu(2);
	$('#pegawai_add_karir_rencana_grafik').addClass("menuAktifDynamis");
	parent.mainFrame.location.href='../polakarir/pegawai_add_karir_rencana_grafik.php?reqId=<?=$reqPegawaiId?>';
	parent.document.getElementById('trdetil').style.display = 'none';
}
return true;
}
...
<div id="content">
    ...
    <div style="float: left" id="my_menu" class="sdmenu">
      ...
      <div> 
        ...
        <a href="#" id="general_ikk_add" onclick="executeOnClick('general_ikk_add');">General IKK</a>
      ...
      <div>
        <span>Analisa Diklat</span>
        <a href="#" id="penilaiankompetensianalisa" onclick="executeOnClick('penilaiankompetensianalisa');">Rekomendasi Diklat</a>
      </div>
    </div>
    <!-- END SDMENU -->
