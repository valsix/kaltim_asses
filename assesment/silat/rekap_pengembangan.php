...
$arrkolomdata= array(
    ...
    , array("label"=>"Kuadran", "width"=>"220px")
    , array("label"=>"Rekomendasi", "width"=>"")
    , array("label"=>"Jenis Pengembangan", "width"=>"120px")
    , array("label"=>"Jumlah Jp", "width"=>"150px")
);
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",
		"sAjaxSource": "../json-silat/rekap_pengembangan_json.php?reqId=<?=$reqId?>",
		...
		/* Click event handler */
		  ...
		  $('#btnCari').on('click', function () {
                ...
                oTable.fnReloadAjax("../json-silat/rekap_pengembangan_json.php?reqFormulaId="+reqFormulaId+"&reqId=<?=$reqId?>&sSearch="+reqPencarian);
		  });
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <div id="header-tna">Data <span>Pengembangan</span></div>
    <div id="bluemenu" class="bluetabs" style="background:url(css/media/bluetab.gif)">    
    	<ul>
    		<li>
    			...
    			<a href="#" title="Set Kelola" id="btnUbahData" ><img src="../WEB/images/pegawai-edit.png"/>&nbsp;Lihat Penilaian</a>
