   	...
   	<tr> 
    	...
    	<td valign="top" height="100%" width="100%">
            <div id="kontainer-atas" class="kontainer-atasFull">
                <? if($reqStatusJenis == '2'){?>
                <iframe class="mainframe" id="idMainFrame" name="mainFrame" src="../ikk/identitas_edit_eksternal.php?reqPegawaiId=<?=$reqId?>&reqIdOrganisasi=<?=$reqIdOrganisasi?>&reqConfirm=<?=$reqConfirm?>&reqStatusJenis=<?=$reqStatusJenis?>" style="width:100%; height:calc(100% - 5px); border:none;"></iframe>
                <? } else {?>
                <iframe class="mainframe" id="idMainFrame" name="mainFrame" src="../ikk/identitas_edit.php?reqPegawaiId=<?=$reqId?>&reqIdOrganisasi=<?=$reqIdOrganisasi?>&reqConfirm=<?=$reqConfirm?>&reqStatusJenis=<?=$reqStatusJenis?>" style="width:100%; height:calc(100% - 5px); border:none;"></iframe>
                <? }?>
            </div>
