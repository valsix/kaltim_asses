...
$url = 'https://api-simpeg.kaltimbkd.info/pns/semua-data-utama/'.$tempNipBaru.'/?api_token=f5a46b71f13fe1fd00f8747806f3b8fa';
...
if(varItem == 'idpegawai'){
	...
	<? if($reqStatusJenis == '2'){?>
		parent.mainFrame.location.href='../ikk/identitas_edit_eksternal<?=$reqSource?>.php?reqPegawaiId=<?=$reqPegawaiId?>&reqIdOrganisasi=<?=$reqIdOrganisasi?>';
	<? } else {?>
	parent.mainFrame.location.href='../ikk/identitas_edit<?=$reqSource?>.php?reqPegawaiId=<?=$reqPegawaiId?>&reqIdOrganisasi=<?=$reqIdOrganisasi?>';
	<? }?>
...
<div id="content">
    ...
    <div>
        <div style="margin-top:5px; width:230px; margin-left:5px; float:left; position:relative; text-align:left;">
            ...
            <div style="float:left; position:relative; width:170px;"> 
            	<div style="color:#000; font-size:14px; text-shadow:1px 1px 1px #FFF;"><?=$data['glr_depan']?> <?=$data['nama']?> <?=$data['glr_belakang']?></div>
    ...
    <div style="float: left" id="my_menu" class="sdmenu">
      <div> 
        ...
        <!--< a href="#" id="riwayatjabatan" onclick="executeOnClick('riwayatjabatan');">Riwayat Pekerjaan</a>	
