...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",
		"sAjaxSource": "../json-skp/kategori_json.php",
		...
		/* Click event handler */
		  ...
		  $('#btnAdd').on('click', function () {
			  opUrl    = 'kategori_add.php?reqMode=insert';
		  ...
		  $('#btnEdit').on('click', function () {
			  ...
			  opUrl    = 'kategori_add.php?reqMode=update&reqId='+anSelectedId;
			  window.top.OpenDHTML(opUrl, 'Administrasi Master Data', '880', '495');
		  });
			  ...
			  if(anSelectedData == "")
				...
				$.messager.confirm('Confirm','Apakah anda yakin ingin menghapus data terpilih ?',function(r){
					if (r){
						...
						var jqxhr = $.get( "delete.php?reqMode=kategori&id="+anSelectedId, function() {
							$.messager.progress('close');
						})
						.done(function() {
							$.messager.progress('close');
							oTable.fnReloadAjax("../json-skp/kategori_json.php?reqSearch=" + $("#reqStatus").val() + "&reqId=<?=$reqId?>");
						})
						.fail(function() {
							alert( "error" );
							$.messager.progress('close');
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <div id="header-tna">Data <span>Kategori</span></div>
