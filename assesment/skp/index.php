...
<?
$_GET["JUDUL"] = "| Modul";
$_GET["DESKRIPSI"] = "Evaluasi Kinerja";
                    	...
                    	<tr>
                            ...
                            <td>
                            	<div id="menu-2">
									...
									{
                                    ?>
                                    	<div id="menu-2-konten"><a href="#" data-flexmenu="flex-skp">SKP</a></div>
                                    <?
									}
									if(findWord($tempListInfo, "Kinerjaku dan SKP") == 1 || findWord($tempListInfo, "Formulir SKP") == 1
									...
									{
                                    ?>
                                    	<div id="menu-2-konten"><a href="#" data-flexmenu="flex-master">Master</a></div> 
                                    <?
									}
                                    ?>
                                    <!-- pindahan menu dari atas -->
                                    <?php /*?><div id="menu-2-konten"><a href="monitoring.php?reqMode=pegawai" target="mainFrame" onClick="menuHandler('pegawai')">Pegawai</a></div><?php */?>
                                ...
                                <ul id="flex-master" class="flexdropdownmenu" style="background-color:#385f0e;">
                                	<?
									if(findWord($tempListInfo, "Periode Penilaian") == 1 || $tempListInfo == "")
									{
                                    ?>
                                		<li><a href="monitoring.php?reqRowId=1&reqMode=periode_penilaian" target="mainFullFrame" onClick="menuHandler('validator')">Periode Penilaian</a></li>
                                	<?
									}
									if(findWord($tempListInfo, "Kategori") == 1 || $tempListInfo == "")
									{
                                    ?>
                                    	<li><a href="monitoring.php?reqRowId=1&reqMode=kategori" target="mainFullFrame" onClick="menuHandler('validator')">Kategori</a></li>
                                	<?
									}
									if(findWord($tempListInfo, "Pertanyaan") == 1 || $tempListInfo == "")
									{
                                    ?>
                                    	<li><a href="monitoring.php?reqRowId=1&reqMode=pertanyaan" target="mainFullFrame" onClick="menuHandler('validator')">Pertanyaan</a></li>
                                	<?
									}
									if(findWord($tempListInfo, "Pegawai Penilai") == 1 || $tempListInfo == "")
									{
                                    ?>
                                    	<li><a href="monitoring.php?reqRowId=1&reqMode=pegawai_penilai" target="mainFullFrame" onClick="menuHandler('validator')">Pegawai Penilai</a></li>
                                    <?
									}
                                    ?>
                                </ul>
                                ...
                                <!-- SKP -->
                                <ul id="flex-skp" class="flexdropdownmenu" style="background-color:#385f0e;">
                                	<?
									if(findWord($tempListInfo, "Kinerjaku dan SKP") == 1 || $tempListInfo == "")
									{
                                    ?>
                                		<li><a href="monitoring.php?reqRowId=1&reqMode=kinerjaku" target="mainFrame" onClick="menuHandler('pegawai')">Kinerjaku dan SKP</a></li>
                                	<?
									}
									?>
                                    	<li><a href="monitoring.php?reqRowId=1&reqMode=pegawai" target="mainFrame" onClick="menuHandler('pegawai')">SKP Personal</a></li>
                                    <?
									if(findWord($tempListInfo, "Formulir SKP") == 1 || $tempListInfo == "")
									{
                                    ?>
                                    	<li><a href="monitoring.php?reqRowId=1&reqMode=pelaporan_skp" target="mainFullFrame" onClick="menuHandler('validator')">Formulir SKP</a></li>
                                	<?
									}
									if(findWord($tempListInfo, "Pencapaian SKP") == 1 || $tempListInfo == "")
									{
                                    ?>
                                    	<li><a href="monitoring.php?reqRowId=1&reqMode=pelaporan_skp_realisasi" target="mainFullFrame" onClick="menuHandler('validator')">Pencapaian SKP</a></li>
                                	<?
									}
									if(findWord($tempListInfo, "Validasi Formulir SKP") == 1 || $tempListInfo == "")
									{
                                    ?>
                                    	<li><a href="monitoring.php?reqRowId=1&reqMode=daftar_skp" target="mainFullFrame" onClick="menuHandler('validator')">Validasi Formulir SKP</a></li>
                                	<?
									}
									if(findWord($tempListInfo, "Validasi Pencapaian SKP") == 1 || $tempListInfo == "")
									{
                                    ?>
                                    	<li><a href="monitoring.php?reqRowId=1&reqMode=daftar_skp_penilaian" target="mainFullFrame" onClick="menuHandler('validator')">Validasi Pencapaian SKP</a></li>
                                	<?
									}
									if(findWord($tempListInfo, "Penilaian SKP") == 1 || $tempListInfo == "")
									{
                                    ?>
                                    	<li><a href="monitoring.php?reqRowId=1&reqMode=perilaku_kerja_penilaian" target="mainFullFrame" onClick="menuHandler('validator')">Penilaian</a></li>
                                	<?
									}
									if(findWord($tempListInfo, "SKP dan Perilaku Kerja") == 1 || $tempListInfo == "")
									{
                                    ?>
                                    	<li><a href="monitoring.php?reqRowId=1&reqMode=daftar_skp_pelaporan" target="mainFullFrame" onClick="menuHandler('validator')">SKP & Perilaku Kerja</a></li>
                                    <?
									}
                                    ?>
                                </ul>
