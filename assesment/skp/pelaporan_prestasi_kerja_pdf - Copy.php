...
<div id='kop'>
	<table>
		  ...
		  <tr>
			<td width='300px' align='center'>KABUPATEN PROBOLINGGO</td>
			<td width='600px'>&nbsp;</td> 	
...
<div id='detil'>
	<table style='margin-bottom:30px;'>
		...
		<tr>
			<td align='right' width='40px'>e.</td>			
			<td>Unit Organisasi</td>
			<td colspan='3'>".$pegawai_penilai->getField("SATKER")." KAB. PROBOLINGGO</td>	
		</tr>
		<tr>
		...
		<tr>
			<td align='right' width='40px'>e.</td>			
			<td>Unit Organisasi</td>
			<td colspan='3'>".$pegawai_atasan->getField("SATKER")." KAB. PROBOLINGGO</td>	
		</tr>
	</table>
	...
	<table>
		...
		while($kategori->nextRow())
		{
			if($j == 1)
			{
				$html .= "
					<tr>
						<td align='right' width='40px' rowspan='".($jumlah_kategori+3)."' valign='top'>b.</td>
						<td rowspan='".($jumlah_kategori+3)."' valign='top'>Perilaku Kerja</td>
						<td>".$j.". ".$kategori->getField("KETERANGAN")."</td>
						<td>".$pegawai_dinilai->getField("PK".$kategori->getField("URUT"))."</td>
						<td>".nilai_huruf($pegawai_dinilai->getField("PK".$kategori->getField("URUT")))."</td>
						<td rowspan='".($jumlah_kategori+2)."'>&nbsp;</td>
					</tr>
					";
			}
			else
		...
		<tr>
			<td align='center'>".nilai_huruf(($nilai_skp + $nilai_pk))."</td>
		</tr>
		</table>
	</div>
	<div id='hal3'>
