...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",
		"sAjaxSource": "../json-skp/pegawai_penilai_json.php",
		...
		/* Click event handler */
		  ...
		  $('#btnProses').on('click', function () {
				  if(confirm("Proses pegawai penilaian? "))	
				  {		
				  		oTable.fnReloadAjax("../json-masterdata/pegawai_penilai_json.php?reqMode=proses");
				  }
			  });
		  ...
		  $('#btnLihat').on('click', function () {
			  if(anSelectedData == "")
				  return false;				
			   window.top.OpenDHTML('pegawai_penilai_lihat.php?reqPenilaiId='+anSelectedId, 'Administrasi Master Data');	
		  });
			  ...
			  if(anSelectedData == "")
				...
				$.messager.confirm('Confirm','Apakah anda yakin ingin menghapus data terpilih ?',function(r){
					if (r){
						...
						var jqxhr = $.get( "delete.php?reqMode=pegawai_penilai&id="+anSelectedId, function() {
							$.messager.progress('close');
						})
						.done(function() {
							$.messager.progress('close');
							oTable.fnReloadAjax("../json-skp/pegawai_penilai_json.php?reqSearch=" + $("#reqStatus").val() + "&reqId=<?=$reqId?>");
						})
						.fail(function() {
							alert( "error" );
							$.messager.progress('close');
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <div id="header-tna">Data <span>Pegawai Penilai</span></div>
