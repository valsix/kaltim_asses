...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",
		"sAjaxSource": "../json-skp/daftar_skp_penilaian_json.php",
		...
		/* Click event handler */
		  ...
		  $('#btnValidasi').on('click', function () {			  
			  alert("Klik tanda berwarna kuning untuk validasi pencapaian SKP.");			  
		  });
			  ...
			  if(anSelectedData == "")
				...
				$.messager.confirm('Confirm','Apakah anda yakin ingin menghapus data terpilih ?',function(r){
					if (r){
						...
						var jqxhr = $.get( "delete.php?reqMode=daftar_skp_penilaian&id="+anSelectedId, function() {
							$.messager.progress('close');
						})
						.done(function() {
							$.messager.progress('close');
							oTable.fnReloadAjax("../json-skp/daftar_skp_penilaian_json.php?reqSearch=" + $("#reqStatus").val() + "&reqId=<?=$reqId?>");
						})
						.fail(function() {
							alert( "error" );
							$.messager.progress('close');
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <div id="header-tna">Data <span>Validasi Pencapaian SKP Pegawai</span></div>
    ...
    <div class="filter-monitoring">
        ...
        <img src="../WEB/images/proses.png" width="15"> Entri Pencapaian&nbsp;&nbsp;
