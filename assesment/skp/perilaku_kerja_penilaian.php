...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",
		"sAjaxSource": "../json-skp/perilaku_kerja_penilaian_json.php",
		...
		/* Click event handler */
		  ...
		  $('#btnPenilaian').on('click', function () {			 
			  if(anSelectedData == "")
				  return false;							
			  window.top.OpenDHTML('perilaku_kerja_penilaian_add.php?reqId='+anSelectedId, 'Sasaran Kerja Pegawai');			  
		  });
			  ...
			  if(anSelectedData == "")
				...
				$.messager.confirm('Confirm','Apakah anda yakin ingin menghapus data terpilih ?',function(r){
					if (r){
						...
						var jqxhr = $.get( "delete.php?reqMode=perilaku_kerja_penilaian&id="+anSelectedId, function() {
							$.messager.progress('close');
						})
						.done(function() {
							$.messager.progress('close');
							oTable.fnReloadAjax("../json-skp/perilaku_kerja_penilaian_json.php?reqSearch=" + $("#reqStatus").val() + "&reqId=<?=$reqId?>");
						})
						.fail(function() {
							alert( "error" );
							$.messager.progress('close');
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <ul>
          <li>
			...
			?>
            	<a href="#" id="btnPenilaian" title="Penilaian"> Penilaian</a>
			<?
			}
			else{
			?>
