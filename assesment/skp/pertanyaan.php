...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",
		"sAjaxSource": "../json-skp/pertanyaan_json.php",
		...
		/* Click event handler */
		  ...
		  $('#btnAdd').on('click', function () {
			  opUrl    = 'pertanyaan_add.php?reqMode=insert';
			  window.top.OpenDHTML(opUrl, 'Administrasi Master Data', '880', '495');
		  });
		  ...
		  $('#btnEdit').on('click', function () {
			  ...
			  opUrl    = 'pertanyaan_add.php?reqMode=update&reqId='+anSelectedId;
			  window.top.OpenDHTML(opUrl, 'Administrasi Master Data', '880', '495');
		  });
			  ...
			  if(anSelectedData == "")
				...
				$.messager.confirm('Confirm','Apakah anda yakin ingin menghapus data terpilih ?',function(r){
					if (r){
						...
						var jqxhr = $.get( "delete.php?reqMode=pertanyaan&id="+anSelectedId, function() {
							$.messager.progress('close');
						})
						.done(function() {
							$.messager.progress('close');
							oTable.fnReloadAjax("../json-skp/pertanyaan_json.php?reqSearch=" + $("#reqStatus").val() + "&reqId=<?=$reqId?>");
						})
						.fail(function() {
							alert( "error" );
							$.messager.progress('close');
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <div id="header-tna">Data <span>Pertanyaan</span></div>
    <div id="bluemenu" class="bluetabs" style="background:url(css/media/bluetab.gif)">    
    <ul>
          <li>
          	<a href="#" title="Tambah Data" id="btnAdd"><img src="../WEB/images/icn_add.png" width="15" height="15"/>&nbsp;Tambah</a>
          	<a href="#" title="Ubah Data" id="btnEdit"><img src="../WEB/images/icn_edit.png" width="15" height="15"/>&nbsp;Ubah</a>
          	<a href="#" title="Hapus Data" id="btnDelete"><img src="../WEB/images/icn_delete.png" width="15" height="15"/>&nbsp;Hapus</a>
          </li>
    </ul>
    </div>
