...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",
		"sAjaxSource": "../json-skp/daftar_skp_json.php",
		...
		/* Click event handler */
		  ...
		  $('#btnValidasi').on('click', function () {			  
			  alert("Klik tanda berwarna kuning untuk validasi formulir SKP.");			  
		  });
			  ...
			  if(anSelectedData == "")
				...
				$.messager.confirm('Confirm','Apakah anda yakin ingin menghapus data terpilih ?',function(r){
					if (r){
						...
						var jqxhr = $.get( "delete.php?reqMode=daftar_skp&id="+anSelectedId, function() {
							$.messager.progress('close');
						})
						.done(function() {
							$.messager.progress('close');
							oTable.fnReloadAjax("../json-skp/daftar_skp_json.php?reqSearch=" + $("#reqStatus").val() + "&reqId=<?=$reqId?>");
						})
						.fail(function() {
							alert( "error" );
							$.messager.progress('close');
	...
	function openValidasi(pegawaiId, bulanValidasi, statusValidasi)
	{
		...
		if(statusValidasi == 'validasi')
			window.parent.createWindow('daftar_skp_add.php?reqId='+pegawaiId+'&reqBulan='+bulanValidasi+'&reqTahun=<?=date("Y")?>', 'Sasaran Kerja Pegawai');	
		else
		{
			if(statusValidasi == 'disetujui')
				alert("Formulir telah disetujui.");
			else if(statusValidasi == 'revisi')	
				alert("Formulir sedang direvisi.");
			else if(statusValidasi == 'belum')	
				alert("Formulir belum diisi / diposting.");
		}
	}
</script>
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <div id="header-tna">Data <span>Validasi Formulir SKP Pegawai</span></div>
    ...
    <div class="filter-monitoring">
    	<img src="../WEB/images/belum.png" width="15"> Belum Entri&nbsp;&nbsp;
        <img src="../WEB/images/validasi.png" width="15"> Validasi&nbsp;&nbsp;
        <img src="../WEB/images/revisi.png" width="15"> Revisi&nbsp;&nbsp;
        <img src="../WEB/images/setujui.png" width="15"> Disetujui&nbsp;&nbsp;
    </div>
    </div> 
    </div>  
    ...
    <thead>
        <tr>
            <th>Id</th>
            <th width="100px">NIP Lama</th> 
            <th width="100px">NIP Baru</th> 
            <th width="150px">Nama</th> 
            <th width="50px">Gol.&nbsp;Ruang</th> 
            <th width="50px">Eselon</th> 
