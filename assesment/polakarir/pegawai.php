...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		/* Click event handler */
		  ...
		  $('#btnUbahRencana').on('click', function () {
			  if(anSelectedData == "")
				  return false;
		  ...
		  $("#reqPencarian").keyup(function(e) {
			...
			if(code==13)
			{
			  var reqStatusPeg= sSearch= "";
			  sSearch= $("#reqPencarian").val();
			  reqStatusPeg= $("#reqStatusPeg").val();
			  oTable.fnReloadAjax("../json-silat/pegawai_json.php?reqStatusPeg="+reqStatusPeg+ "&reqId=<?=$reqId?>&sSearch="+sSearch);
			}
		  });
		  ...
		  $("#reqStatusPeg").change(function() { 
			  ...
			  reqStatusPeg= $("#reqStatusPeg").val();
			  oTable.fnReloadAjax("../json-silat/pegawai_json.php?reqStatusPeg="+reqStatusPeg+ "&reqId=<?=$reqId?>");
		  });
...
<body id="index" class="grid_2_3" style="overflow:hidden">
    ...
    <ul>
          <li>
            ...
            <a href="#" title="Perencanaan dan Pembinaan Karier" id="btnUbahRencana"><img src="../WEB/images/pegawai-edit.png"/>&nbsp;Perencanaan dan Pembinaan Karier</a>
    ...
    <div style="position: relative; margin-bottom:-30px; margin-top:8px; float:right; z-index:9999; font-size:12px;">
        Pencarian :
        <input type="text" id="reqPencarian" style="width:195px" />
    </div>
