...
<div id="content" style="height:auto">
    ...
    <tr>
    	<td></td>
        <td colspan="7">
            <div id="header-tna-detil">Data <span>Rencana Karir</span></div>
        </td>			
    </tr>
    <tr>
        <th>Rencana Karir</th>
        <?php /*?><th>Pangkat/Gol Ruang</th><?php */?>
        <th>Unit Kerja</th>
        <th>Nama Jabatan</th>
        <th>Usia</th>
        <th>Tahun Rencana</th>
	...
	?>
        <tr style="background-color:#FFF;cursor:pointer" onmouseover="ChangeColor(this, true);"  onmouseout="ChangeColor(this, false);">
        	<td><a href="pegawai_add_karir_rencana.php?reqId=<?=$reqId?>&reqRowId=<?=$pegawai_add_karir_rencana->getField("PERENCANAAN_DETIL_ID")?>">link data</a></td>
