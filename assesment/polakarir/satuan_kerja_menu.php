...
{
	$('#treeSatker').treegrid({
      	url:'../json-polakarir/satker_tree_json.php'
	});
}
...
$(document).ready( function () {
	$('#treeSatker').treegrid({
		  onClickRow: function(param){
			  parent.$("#idMainFrame").attr("src", "<?=$link?>?reqId=" + param.ID_TABLE);
		  }
	});
});
</script>
...
<body style="background-image:url(images/wall-kiri.jpg); background-attachment:fixed; width:240px;">
...
<!--<div id="content" style="margin-left:-16px; border:2px solid red;">-->
    ...
    <thead>
        <tr>
            <th field="NAMA_WARNA">
                <img src="../WEB/images/tree-satker.png"> <span>SATKER</span>
                <img src="../WEB/images/tree-subsatker.png"> <span>SUB SATKER</span>
            </th>
        </tr>
    </thead>
    </table>
