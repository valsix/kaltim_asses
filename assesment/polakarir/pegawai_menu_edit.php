...
if(varItem == 'idpegawai'){
	...
	parent.mainFrame.location.href='../silat/identitas_edit<?=$reqSource?>.php?reqPegawaiId=<?=$reqPegawaiId?>&reqIdOrganisasi=<?=$reqIdOrganisasi?>';
	...
	parent.mainFrame.location.href='../silat/jabatan<?=$reqSource?>.php?reqPegawaiId=<?=$reqPegawaiId?>&reqIdOrganisasi=<?=$reqIdOrganisasi?>';
	parent.document.getElementById('trdetil').style.display = 'none';	
	...
	parent.mainFrame.location.href='../silat/pangkat<?=$reqSource?>.php?reqPegawaiId=<?=$reqPegawaiId?>&reqIdOrganisasi=<?=$reqIdOrganisasi?>';
	parent.document.getElementById('trdetil').style.display = 'none';	
	...
	parent.mainFrame.location.href='../silat/pendidikan_umum<?=$reqSource?>.php?reqPegawaiId=<?=$reqPegawaiId?>&reqIdOrganisasi=<?=$reqIdOrganisasi?>';
	parent.document.getElementById('trdetil').style.display = 'none';	
...
else if(varItem == 'pegawai_add_karir_rencana'){
	$('#pegawai_add_karir_rencana').addClass("menuAktifDynamis");
	parent.mainFrame.location.href='pegawai_add_karir_rencana_monitoring.php?reqId=<?=$reqPegawaiId?>';
	parent.mainFrameDetil.location.href='pegawai_add_karir_rencana.php?reqId=<?=$reqPegawaiId?>';
	parent.document.getElementById('trdetil').style.display = '';	
}
else if(varItem == 'pegawai_add_karir_rencana_grafik'){
	$('#pegawai_add_karir_rencana_grafik').addClass("menuAktifDynamis");
	parent.mainFrame.location.href='pegawai_add_karir_rencana_grafik.php?reqId=<?=$reqPegawaiId?>';
	parent.document.getElementById('trdetil').style.display = 'none';
}
else if(varItem == 'pegawai_add_karir_pencapaian'){
	$('#pegawai_add_karir_pencapaian').addClass("menuAktifDynamis");
	parent.mainFrame.location.href='pegawai_add_karir_pencapaian.php?reqId=<?=$reqPegawaiId?>';
	parent.document.getElementById('trdetil').style.display = 'none';
}
...
<div id="content">
    ...
    <div style="float: left" id="my_menu" class="sdmenu">
      ...
      <div>
        <span>Karier</span>
        <a href="#" id="pegawai_add_karir_rencana" onclick="executeOnClick('pegawai_add_karir_rencana');">Rencana Karier</a>
        <a href="#" id="pegawai_add_karir_rencana_grafik" onclick="executeOnClick('pegawai_add_karir_rencana_grafik');">Grafik Rencana Karier</a>
        <a href="#" id="pegawai_add_karir_pencapaian" onclick="executeOnClick('pegawai_add_karir_pencapaian');">Pencapaian Karier</a>
      </div>
    </div>
    <!-- END SDMENU -->
