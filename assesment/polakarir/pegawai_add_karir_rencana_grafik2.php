...
<head>
	...
	* {
	...
	#kompak-area-Utama{ width:320px;background:#f79ca3;}
...
<div id="wadah">
    ...
    <div id="basicdiagram" style="width: -moz-calc(100% - 10px);
    width: -webkit-calc(100% - 10px);
    width: -o-calc(100% - 10px);
    width: calc(100% - 10px); height:500px; position:relative; z-index:999"></div>
