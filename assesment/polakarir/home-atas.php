...
$(document).ready(function() {
	zingchart.render({	
		...
		//width : 680,
		height : 340,
		dataurl : "../json-ikk/general_mapping_json.php"
	});
	...
	zingchart.render({	
		...
		//width : 680,
		height : 340,
		dataurl : "../json-ikk/general_mapping_ikk_json.php"
	});
	...
	zingchart.render({	
		...
		//width : 680,
		height : 340,
		dataurl : "../json-ikk/general_mapping_psycology_json.php"
	});
});				

zingchart.exec('zingchartGeneral', 'saveasimage', {
        format : 'png',
...
zingchart.exec('zingchartIkk', 'saveasimage', {
        format : 'png',
        callback : function(sImageData) {
            console.log(sImageData);
...
<div id="content" style="height:auto">
	<table width="100%">
    	<tr>
        	<td style="width:30%" id="zingchartGeneral"><div id="header-tna" style="background-image:none; width:89%">General Mapping (Rating)</div></td>
            <td style="width:30%" id="zingchartIkk"><div id="header-tna" style="background-image:none; width:89%"">Indeks Kesenjangan Kompetensi (Rating)</div></td>
            <td style="width:30%" id="zingchartPsycology"><div id="header-tna" style="background-image:none; width:89%"">Psychology Aspect (Rating)</div></td>
        </tr>
    </table>
	<?php /*?><div style="float:right;">
    	<div id="zingchartGeneral"></div>
        <div id="zingchartIkk"></div>
    	<img src="../WEB/images/logo-ikk.png" />
    </div><?php */?>
</div>
</div>
</body>
