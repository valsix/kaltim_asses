...
while($set->nextRow())
{
  $arrPenilaian[$index_loop]["PENILAIAN_ID"]= $set->getField("PENILAIAN_ID");
  ...
  $arrPenilaian[$index_loop]["CATATAN_WEAKNES"]= $set->getField("CATATAN_WEAKNES");
  $arrPenilaian[$index_loop]["KESIMPULAN"]= $set->getField("KESIMPULAN");
  $arrPenilaian[$index_loop]["SARAN_PENGEMBANGAN"]= $set->getField("SARAN_PENGEMBANGAN");
  $arrPenilaian[$index_loop]["SARAN_PENEMPATAN"]= $set->getField("SARAN_PENEMPATAN");
                ...
                <div class="col-md-12" style="height:100%;">
                    ...
                    <div id="example_0">
                      <ul role="tablist">
                        ...
                        ?>
                         <li role="tab" class="ui-tabs-active "><a href="#tabs-lain" role="presentation">Lain-Lain </a></li>
                      </ul>
                      <?
                      for($index_loop=0; $index_loop < $jumlah_asesor; $index_loop++)
                      {
                                  ...
                                  <tbody>
                                    ...
                                    else
                                    {
                                      ...
                                      for($index_detil=0; $index_detil < count($arrayKey); $index_detil++)
                                      {
                                        ...
                                        $reqPenilaianPotensiId= $arrPenilaian[$index_row]["PENILAIAN_ID"];
                                        ...
                                        $reqPenilaianPotensiDeskripsi= $arrPenilaian[$index_row]["BUKTI"];

                                        $reqPenilaianPotensiStrength= $arrPenilaian[$index_row]["CATATAN_STRENGTH"];
                                        $reqPenilaianPotensiWeaknes= $arrPenilaian[$index_row]["CATATAN_WEAKNES"];
                                        $reqPenilaianPotensiKesimpulan= $arrPenilaian[$index_row]["KESIMPULAN"];
                                        $reqPenilaianPotensiSaranPengembangan= $arrPenilaian[$index_row]["SARAN_PENGEMBANGAN"];
                                        $reqPenilaianPotensiSaranPenempatan= $arrPenilaian[$index_row]["SARAN_PENEMPATAN"];
                                    ...
                                    ?>
                                        ...
                                        ?>
                                          <tr class="">
                                            <td style="text-align:center; width: 1%" rowspan="2">No</td>
                                            <td style="text-align:center; width: 25%" rowspan="2">ATRIBUT & INDIKATOR</td>
                                        ...
                                        ?>
                                          <tr class="<?=$css?>">
                                            ...
                                            <td style="text-align:center">
                                              ...
                                              <input type="hidden" style="color:#000 !important" name="reqPenilaianPotensiId[]" id="reqPenilaianPotensiId<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>" value="<?=$reqPenilaianPotensiId?>" />
                                            ...
                                            <td align="center"><label id="reqPenilaianPotensiGapInfo<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>" style="width:50%"><?=$reqPenilaianPotensiGap?></label>&nbsp;</td>
                                            <td align="center" style="height:40px ;width:200px !important"><textarea name="reqPenilaianPotensiDeskripsi[]" id="reqPenilaianPotensiDeskripsi<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>" style="height:100px ;width:200px !important" rows="1" ><?=$reqPenilaianPotensiDeskripsi?></textarea></td> 
                                            <!--  <td align="center"><input name="reqBukti[]" id="reqBukti<?=$checkbox_index?>" style="height:40px ;width:200px !important" rows="1" ><?=$tempBukti?></td>  -->
                                          </tr>
                                ...
                                <table style="margin-bottom:60px;" class="profil">
                                  ...
                                  <tbody>
                                   <tr>
                                    <td colspan="5" >
                                      <fieldset>
                                        <legend style="font-size: 14px !important; border: medium none !important; margin-bottom: 10px; color: white !important;">Strength</legend>
                                        <textarea name="reqPenilaianPotensiStrength[]" id="reqPenilaianPotensiStrength<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>" style="width:95%" rows="1" ><?=$reqPenilaianPotensiStrength?></textarea>
                                      </fieldset>
                                      <fieldset>
                                        <legend style="font-size: 14px !important; border: medium none !important; margin-bottom: 10px; color: white !important;">Weakness</legend>
                                        <textarea name="reqPenilaianPotensiWeaknes[]" id="reqPenilaianPotensiWeaknes<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>" style="width:95%" rows="1" ><?=$reqPenilaianPotensiWeaknes?></textarea>
                                      </fieldset>
                                      <fieldset>
                                        <legend style="font-size: 14px !important; border: medium none !important; margin-bottom: 10px; color: white !important;">Kesimpulan</legend>
                                        <textarea name="reqPenilaianPotensiKesimpulan[]" id="reqPenilaianPotensiKesimpulan<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>" style="width:95%" rows="1" ><?=$reqPenilaianPotensiKesimpulan?></textarea>
                                      </fieldset>
                                      ...
                                      <fieldset>
                                        ...
                                        <textarea name="reqPenilaianPotensiSaranPengembangan[]" id="reqPenilaianPotensiSaranPengembangan<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>" style="width:95%" rows="1" ><?=$reqPenilaianPotensiSaranPengembangan?></textarea>
                                      </fieldset>
                                      <fieldset>
                                        ...
                                        <textarea name="reqPenilaianPotensiSaranPenempatan[]" id="reqPenilaianPotensiSaranPenempatan<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>" style="width:95%" rows="1" ><?=$reqPenilaianPotensiSaranPenempatan?></textarea>
                                      </fieldset>
                                      <input type="hidden" style="color:#000 !important" name="reqPenilaianPotensiId[]" id="reqPenilaianPotensiId<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>" value="<?=$reqPenilaianPotensiId?>" />
                                      <input type="hidden" style="color:#000 !important" name="reqPenilaianPotensiDetilId[]" id="reqPenilaianPotensiDetilId<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>" value="<?=$reqPenilaianPotensiDetilId?>" />
                                    </td>
                              ...
                              <form id="ff-" method="post" novalidate>
                                ...
                                <table style="margin-bottom:60px;" class="profil">
                                  ...
                                  <tbody>
                                    ...
                                    ?>
                                    <tr>
                                      <th colspan="<?=$tempsarancolspan?>">Saran Pengembangan</th>
...
<footer class="footer">
  © 2019 Pemprov Bali. All Rights Reserved. 
</footer>
