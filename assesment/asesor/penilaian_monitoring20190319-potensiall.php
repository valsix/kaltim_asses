                                    ...
                                    ?>
                                        ...
                                        ?>
                                          <tr class="<?=$css?>">
                                            ...
                                            <td rowspan="2"><?=$reqPenilaianPotensiAtributNama?></td>
                                          ...
                                          <tr>
                                            <td colspan="7">
                                              ...
                                              <fieldset>
                                                <legend style="font-size: 14px !important; border: medium none !important; margin-bottom: 10px; color: white !important;">Saran Pengembang</legend>
                                    ...
                                    ?>
                                        ...
                                        ?>
                                          <tr class="<?=$css?>">
                                            ...
                                            <td rowspan="2"><?=$reqPenilaianKompetensiAtributNama?></td>
                                            <?
                                            for($index_loop=0; $index_loop < $jumlah_pegawai_asesor; $index_loop++)
                                            {
                                              $reqInfoPenggalianKode= $arrPegawaiAsesor[$index_loop]["PENGGALIAN_KODE"];
