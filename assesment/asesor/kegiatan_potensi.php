...
$index_loop= 0;
$arrPenggalian="";
//$statement= " AND A.JADWAL_TES_ID = ".$reqJadwalTesId." AND (C.STATUS_PENILAIAN = '' OR C.STATUS_PENILAIAN IS NULL) AND B.ASESOR_ID = ".$tempAsesorId." AND B.JADWAL_ASESOR_POTENSI_ID = ".$reqJadwalAsesorId;
$statement= " AND A.JADWAL_TES_ID = ".$reqJadwalTesId." AND B.ASESOR_ID = ".$tempAsesorId." AND B.JADWAL_ASESOR_POTENSI_ID = ".$reqJadwalAsesorId;
...
$index_loop= 0;
$arrAsesorPegawai="";
//$statement= " AND A.JADWAL_TES_ID = ".$reqJadwalTesId." AND (E.STATUS_PENILAIAN = '' OR E.STATUS_PENILAIAN IS NULL) AND B.ASESOR_ID = ".$tempAsesorId." AND B.JADWAL_ASESOR_POTENSI_ID  = ".$reqJadwalAsesorId;
$statement= " AND A.JADWAL_TES_ID = ".$reqJadwalTesId." AND B.ASESOR_ID = ".$tempAsesorId." AND B.JADWAL_ASESOR_POTENSI_ID  = ".$reqJadwalAsesorId;
$set= new JadwalAsesorPotensi();
...
while($set->nextRow())
{
	...
	$arrAsesorPegawai[$index_loop]["PEGAWAI_ID"]= $set->getField("PEGAWAI_ID");
	$index_loop++;
}
                        	...
                        	<div class="area-table-assesor">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                        	<?=$tempAsesorNama?>
                                        	<?php /*?><?=$arrPenggalian[0]["ASESOR"]?><?php */?>
                                        	<?php /*?><ul>
                                            	<li>Magda</li>
                                                <li>Dira</li>
                                            </ul><?php */?>
                                ...
                                <tbody>
									...
									{
										$tempPegawaiInfoId= $arrAsesorPegawai[$checkbox_index]["PEGAWAI_ID"];
                                        $cekAspekId= 1;
                                        $set= new AsesorPenilaianDetil();
										$tempcheckinfo= "";
                                        if($cekAspekId == "1")
                                        {
                                            $statement= " AND A.JADWAL_ASESOR_POTENSI_ID = ".$reqJadwalAsesorId." AND A.PEGAWAI_ID = ".$tempPegawaiInfoId." AND B.ASESOR_ID = ".$tempAsesorId." AND F.ASPEK_ID = ".$cekAspekId;
                                            $set->selectByParamsMonitoringAspek1(array(), -1,-1, $statement);
											$tempquery= $set->query;
                                            $set->firstRow();
                                            $tempcheckinfo= $set->getField("ASESOR_PENILAIAN_DETIL_ID");
                                        }
                                        else
                                        {
                                            $statement= " AND A.JADWAL_ASESOR_ID = ".$reqJadwalAsesorId." AND A.PEGAWAI_ID = ".$tempPegawaiInfoId." AND B.ASESOR_ID = ".$tempAsesorId." AND F.ASPEK_ID = ".$cekAspekId;
                                	...
                                	<tr>
                                        ...
                                        <td style=" <?=$warna?>">
                                        Nip: <?=$arrAsesorPegawai[$checkbox_index]["NIP"]?>, Nama: <?=$arrAsesorPegawai[$checkbox_index]["NAMA"]?>
                                        </td>
                                        <td>
