...
(
  ...
  FROM
  (
  SELECT A.JADWAL_ASESOR_ID FROM jadwal_asesor A WHERE JADWAL_TES_ID = ".$reqJadwalTesId." AND A.ASESOR_ID = ".$tempAsesorId." LIMIT 1
  ) X WHERE A.JADWAL_ASESOR_ID = X.JADWAL_ASESOR_ID
)";
                                ...
                                <table style="margin-bottom:60px;" class="profil">
                                  <thead>
                                    ...
                                    <tr class="">
                                      ...
                                      for($index_loop=0; $index_loop < $jumlah_asesor; $index_loop++)
                                      {
                                        if($arrAsesor[$index_loop]["PENGGALIAN_ID"] == 0)
                                        {
                                          continue;
                                        }
                                        $reqInfoPenggalianKode= $arrAsesor[$index_loop]["PENGGALIAN_KODE"];
                                        ...
                                        ?>
                                          <tr class="<?=$css?>">
                                            ...
                                            for($index_loop=0; $index_loop < $jumlah_asesor; $index_loop++)
                                            {
                                              ...
                                              $tempCariDataDetilNilai= $arrAsesor[$index_loop]["PENGGALIAN_ID"]."-".$reqPenilaianKompetensiAtributId;
                                              $arrayDetilKey= in_array_column($tempCariDataDetilNilai, "PENGGALIAN_ATRIBUT", $arrPegawaiNilai);
                                              ...
                                              else
                                              {
                                                ...
                                                $tempInfoDataPenggalianAtributNilai= $arrPenilaian[$index_detil_row]["NILAI"];
                                              }
                                            ?>
