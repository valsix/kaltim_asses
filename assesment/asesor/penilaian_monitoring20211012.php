                                        ...
                                        ?>
                                          <tr class="<?=$css?>">
                                            ...
                                            <td align="center">
                                              ...
                                              {
                                              ?>
                                              <input type="radio" <?=$disabledatribut?> class="easyui-validatebox" <?=$arrChecked[1]?> name="reqPenilaianRadio<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>" id="reqPenilaianRadio<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>-2" value="2" />
                                              <?
                                              }
                                              ?>
                                            </td>
                                            <td align="center">
                                              ...
                                              {
                                              ?>
                                              <input type="radio" <?=$disabledatribut?> class="easyui-validatebox" <?=$arrChecked[2]?> name="reqPenilaianRadio<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>" id="reqPenilaianRadio<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>-3" value="3" />
                                              <?
                                              }
                                              ?>
                                            </td>
                                            <td align="center">
                                              ...
                                              {
                                              ?>
                                              <input type="radio" <?=$disabledatribut?> class="easyui-validatebox" <?=$arrChecked[3]?> name="reqPenilaianRadio<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>" id="reqPenilaianRadio<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>-4" value="4" />
                                              <?
                                              }
                                              ?>
                                            </td>
                                            <td align="center">
                                              ...
                                              {
                                              ?>
                                              <input type="radio" <?=$disabledatribut?> class="easyui-validatebox" <?=$arrChecked[4]?> name="reqPenilaianRadio<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>" id="reqPenilaianRadio<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>-5" value="5" />
                                              <?
                                              }
                                              ?>
                                            </td>
                                          ...
                                          <tr>
                                            <td colspan="8" style="color:black !important ;background-color: white !important;">
                                              <?
                                              if($disabledatribut == "")
                                              {
                                              ?>
                                  ...
                                  <tbody>
                                    ...
                                    ?>
                                      ...
                                      if($indexTr == $reqJadwalPegawaiJumlahLevel)
                                      {
                                        ...
                                        $arrChecked= "";
                                        if($reqDetilAtributNilai == ""||$reqDetilAtributNilai == "0"){}
                                        else
                                      ...
                                      ?>
                                        ...
                                        <td style="vertical-align:top; background-color:transparent; color:#000 !important">
                                           <table style="width:100%; border:none">
                                            <tr>
                                              <td style="text-align:center; <?if ($arrChecked[0] !== ""){?>background-color: orange !important;<?}?>">1</td>
                                              <td style="text-align:center <?if ($arrChecked[1] !== ""){?>background-color: orange !important;<?}?>">2</td>
                                              <td style="text-align:center <?if ($arrChecked[2] !== ""){?>background-color: orange !important;<?}?>">3</td>
                                              <td style="text-align:center <?if ($arrChecked[3] !== ""){?>background-color: orange !important;<?}?>">4</td>
                                              <td style="text-align:center" <?if ($arrChecked[4] !== ""){?>background-color: orange !important;<?}?>>5</td>
                                            </tr>
                                            <tr>
                                              <?
                                              $kondisilihatatribut="1";
                                              ...
                                              <td align="center">
                                                ...
                                                {
                                                ?>
                                                <input type="radio" <?=$disabledatribut?> class="easyui-validatebox" <?=$arrChecked[0]?> name="reqRadio<?=$index_detil?>-<?=$reqInfoPenggalianId?>" id="reqRadio<?=$index_detil?>-<?=$reqInfoPenggalianId?>-1" value="1" data-options="validType:'requireRadio[\'#ff-<?=$reqInfoPenggalianId?> input[name=reqRadio<?=$index_detil?>-<?=$reqInfoPenggalianId?>]\', \'Pilih nilai\']'"/>
                                                <?
                                                }
                                                ?>
                                              </td>
                                              <td align="center">
                                                ...
                                                {
                                                ?>
                                                <input type="radio" <?=$disabledatribut?> class="easyui-validatebox" <?=$arrChecked[1]?> name="reqRadio<?=$index_detil?>-<?=$reqInfoPenggalianId?>" id="reqRadio<?=$index_detil?>-<?=$reqInfoPenggalianId?>-2" value="2" />
                                                <?
                                                }
                                                ?>
                                              </td>
                                              <td align="center">
                                                ...
                                                {
                                                ?>
                                                <input type="radio" <?=$disabledatribut?> class="easyui-validatebox" <?=$arrChecked[2]?> name="reqRadio<?=$index_detil?>-<?=$reqInfoPenggalianId?>" id="reqRadio<?=$index_detil?>-<?=$reqInfoPenggalianId?>-3" value="3" />
                                                <?
                                                }
                                                ?>
                                              </td>
                                              <td align="center">
                                                ...
                                                {
                                                ?>
                                                <input type="radio" <?=$disabledatribut?> class="easyui-validatebox" <?=$arrChecked[3]?> name="reqRadio<?=$index_detil?>-<?=$reqInfoPenggalianId?>" id="reqRadio<?=$index_detil?>-<?=$reqInfoPenggalianId?>-4" value="4" />
                                                <?
                                                }
                                                ?>
                                              </td>
                                              <td align="center">
                                                ...
                                                {
                                                ?>
                                                <input type="radio" <?=$disabledatribut?> class="easyui-validatebox" <?=$arrChecked[4]?> name="reqRadio<?=$index_detil?>-<?=$reqInfoPenggalianId?>" id="reqRadio<?=$index_detil?>-<?=$reqInfoPenggalianId?>-5" value="5" />
                                                <?
                                                }
                                                ?>
                                              </td>
                                  ...
                                  <tbody>
                                    ...
                                    ?>
                                        ...
                                        ?>
                                          ...
                                          <tr>
                                            <td style="text-align:center; width: 5%; <?if ($arrChecked[0] !== ""){?>background-color: orange !important;<?}?>">1</td>
                                            <td style="text-align:center; width: 5%; <?if ($arrChecked[1] !== ""){?>background-color: orange !important;<?}?>">2</td>
                                            <td style="text-align:center; width: 5%; <?if ($arrChecked[2] !== ""){?>background-color: orange !important;<?}?>">3</td>
                                            <td style="text-align:center; width: 5%; <?if ($arrChecked[3] !== ""){?>background-color: orange !important;<?}?>">4</td>
                                            <td style="text-align:center; width: 5%; <?if ($arrChecked[4] !== ""){?>background-color: orange !important;<?}?>">5</td>
                                          </tr>
                                          <tr class="<?=$css?>">
                                            ...
                                            for($index_loop=0; $index_loop < $jumlah_pegawai_asesor; $index_loop++)
                                            {
                                              ...
                                              $tempCariDataDetilNilai= $reqPenilaianKompetensiAtributId."-".$tempAsesorId."-15";
                                              $arrayDetilKey= "";
                                            ...
                                            <td align="center">
                                              ...
                                              {
                                              ?>
                                              <input type="radio" <?=$disabledatribut?> class="easyui-validatebox" <?=$arrChecked[1]?> name="reqPenilaianKompetensiRadio<?=$reqPenilaianKompetensiAspekId?>-<?=$index_detil?>" id="reqPenilaianKompetensiRadio<?=$reqPenilaianKompetensiAspekId?>-<?=$index_detil?>-2" value="2" />
                                              <?
                                              }
                                              ?>
                                            </td>
                                            <td align="center">
                                              ...
                                              {
                                              ?>
                                              <input type="radio" <?=$disabledatribut?> class="easyui-validatebox" <?=$arrChecked[2]?> name="reqPenilaianKompetensiRadio<?=$reqPenilaianKompetensiAspekId?>-<?=$index_detil?>" id="reqPenilaianKompetensiRadio<?=$reqPenilaianKompetensiAspekId?>-<?=$index_detil?>-3" value="3" />
                                              <?
                                              }
                                              ?>
                                            </td>
                                            <td align="center">
                                              ...
                                              {
                                              ?>
                                              <input type="radio" <?=$disabledatribut?> class="easyui-validatebox" <?=$arrChecked[3]?> name="reqPenilaianKompetensiRadio<?=$reqPenilaianKompetensiAspekId?>-<?=$index_detil?>" id="reqPenilaianKompetensiRadio<?=$reqPenilaianKompetensiAspekId?>-<?=$index_detil?>-4" value="4" />
                                              <?
                                              }
                                              ?>
                                            </td>
                                            <td align="center">
                                              ...
                                              {
                                              ?>
                                              <input type="radio" <?=$disabledatribut?> class="easyui-validatebox" <?=$arrChecked[4]?> name="reqPenilaianKompetensiRadio<?=$reqPenilaianKompetensiAspekId?>-<?=$index_detil?>" id="reqPenilaianKompetensiRadio<?=$reqPenilaianKompetensiAspekId?>-<?=$index_detil?>-5" value="5" />
                                              <?
                                              }
                                              ?>
                                            </td>
                                    ...
                                    <tr>
                                      <td colspan="5"  style="background-color:white !important; color:black;">
                                        ...
                                        ?>
                                          <div id ="<?=$moderekomendasi?>">
                                            <fieldset>
                                              <legend style="font-size: 14px !important; border: medium none !important; margin-bottom: 10px; ">Profil Kepribadian
                                                <a style="cursor:pointer; display: inline !important" title="Tambah" onClick="createRow('<?=$moderekomendasi?>')"><img src="../WEB/images/icn_add.gif" /></a>
                                              </legend>
                                              <!-- <textarea name="reqPenilaianPotensiProfilKepribadian" id="reqPenilaianPotensiProfilKepribadian" style="width:95%" rows="1" ><?=$reqPenilaianPotensiProfilKepribadian?></textarea> -->
                                              <?
                                              ...
                                              ?>
                                               <!--  <input style="margin: 4px auto; width:97%; color:#06345f;" type="text" name="reqPenilaianKeteranganKepribadian[]" value="<?=$reqinfocatatan?>" /> <a style="cursor:pointer; text-align: left; display: inline" onclick="$(this).prev('input').remove(); $(this).remove();"><img src="../WEB/images/delete-icon.png"></a> -->
                                               <p>
                                                <textarea rows="1" style="margin: 4px auto; width:100%; color:#06345f;" name="reqPenilaianKeteranganKepribadian[]"><?=$reqinfocatatan?></textarea>
                                                <?
                                                if($index_catatan > 0)
                                                {
                                                ?>
                                              ...
                                              {
                                              ?>
                                                <!-- <input style="margin: 4px auto; width:97%; color:#06345f;" type="text" name="reqPenilaianKeteranganKepribadian[]" /> <a style="cursor:pointer; text-align: left; display: inline" onclick="$(this).prev('input').remove(); $(this).remove();"><img src="../WEB/images/delete-icon.png"></a> -->
                                                <p>
                                                <textarea rows="1" style="margin: 4px auto; width:100%; color:#06345f;" name="reqPenilaianKeteranganKepribadian[]"></textarea>
                                              </p>
                                              <?
                                              }
                                              ?>
                                        ...
                                        ?>
                                        <fieldset style="border: 1px solid; padding: 10px !important">
                                          <legend style="font-size: 14px !important; border: medium none !important; margin-bottom: 10px; ">Profil Kepribadian</legend>
                                          <!-- <input type="hidden" name="reqPenilaianKeteranganKepribadian" value="<?=$reqPenilaianPotensiSaranPenempatan?>" /><?=$reqPenilaianPotensiSaranPenempatan?> -->
                                          <?
                                          for($index_catatan=0; $index_catatan<$jumlahPenilaianPotensiProfilKepribadian; $index_catatan++)
                                          {
                                            $reqinfocatatan= $arrPenilaianPotensiProfilKepribadian[$index_catatan]["KETERANGAN"];
...
<script type="text/javascript">
  function resetpenilaiancbi(x,y){
   ...
   $('#reqDetilAtributNilai'+x+'-'+y).val('0');
   $('#reqDetilAtributGap'+x+'-'+y).val('0');
    // return false;
  } 
