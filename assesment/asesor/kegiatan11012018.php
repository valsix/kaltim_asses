                        	...
                        	<div class="area-table-assesor">
                                ...
                                <tbody>
                                	...
                                	<tr>
                                        ...
                                        <a href="perbandingan_penilaian_pegawai.php?reqJadwalAsesorId=<?=$reqJadwalAsesorId?>&reqJadwalPegawaiId=<?=$arrAsesorPegawai[$checkbox_index]["JADWAL_PEGAWAI_ID"]?>">Asesor Meeting <i class="fa fa-chevron-circle-right"></i></a>
                                        <a href="penilaian_pegawai.php?reqJadwalAsesorId=<?=$reqJadwalAsesorId?>&reqJadwalPegawaiId=<?=$arrAsesorPegawai[$checkbox_index]["JADWAL_PEGAWAI_ID"]?>">Lihat Data Peserta <i class="fa fa-chevron-circle-right"></i></a>
                                        </td>
                                    </tr>
                                    <?
									}
