...
$index_loop= 0;
$arrAsesor="";
$statement= " AND A.ASESOR_ID = ".$tempAsesorId." AND A.JADWAL_TES_ID = ".$reqJadwalTesId."
                                    ...
                                    ?>
                                        ...
                                        ?>
                                          <tr class="<?=$css?>">
                                            ...
                                            <th colspan="10"><b><?=$reqPenilaianPotensiAtributNama?></b></th>
                                          </tr>
                                        <?
                                        }
                                        else
                                        ...
                                        ?>
                                          <tr class="<?=$css?>">
                                            ...
                                            <td align="center"><input type="radio" class="easyui-validatebox" <?=$arrChecked[0]?> name="reqPenilaianRadio<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>" id="reqPenilaianRadio<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>" value="1" data-options="validType:'requireRadio[\'#ff-<?=$reqInfoPenggalianId?> input[name=reqPenilaianRadio<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>]\', \'Pilih nilai\']'"/></td>
                                            <td align="center"><input type="radio" class="easyui-validatebox" <?=$arrChecked[1]?> name="reqPenilaianRadio<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>" id="reqPenilaianRadio<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>" value="2" /></td>
                                            <td align="center"><input type="radio" class="easyui-validatebox" <?=$arrChecked[2]?> name="reqPenilaianRadio<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>" id="reqPenilaianRadio<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>" value="3" /></td>
                                            <td align="center"><input type="radio" class="easyui-validatebox" <?=$arrChecked[3]?> name="reqPenilaianRadio<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>" id="reqPenilaianRadio<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>" value="4" /></td>
                                            <td align="center"><input type="radio" class="easyui-validatebox" <?=$arrChecked[4]?> name="reqPenilaianRadio<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>" id="reqPenilaianRadio<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>" value="5" /></td>
                                            ...
                                            <td><textarea name="reqPenilaianPotensiBukti[]" id="reqPenilaianPotensiBukti<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>" style="width:95%" rows="1" ><?=$reqPenilaianPotensiBukti?></textarea></td>
                                            <td><textarea name="reqPenilaianPotensiCatatan[]" id="reqPenilaianPotensiCatatan<?=$reqPenilaianPotensiAspekId?>-<?=$index_detil?>" style="width:95%" rows="1" ><?=$reqPenilaianPotensiCatatan?></textarea></td>
                                          </tr>
                                        <?
                                        }
                                        ?>
                                    ...
                                    ?>
                                      ...
                                      <tr>
                                        <td style="vertical-align:top; width:51%">
                                          ...
                                          <div class="rbtn">
                                            <ul>
                                              <li style="width:100%; text-align:left" id="rbtn-<?=$index_detil?>-<?=$reqJadwalPegawaiIndikatorId?>-<?=$reqJadwalPegawaiLevelId?>-<?=$reqInfoPenggalianId?>" class=" <?=$cssIndikator?>">
                                        ...
                                        {
                                        ?>
                                            <br/><li style="width:100%; text-align:left" id="rbtn-<?=$index_detil?>-<?=$reqJadwalPegawaiIndikatorId?>-<?=$reqJadwalPegawaiLevelId?>-<?=$reqInfoPenggalianId?>" class=" <?=$cssIndikator?>">
                                              <input type="hidden" id="reqJadwalPegawaiDetilId<?=$reqJadwalPegawaiIndikatorId?>" style="color:#000 !important" name="reqJadwalPegawaiDetilId[]" value="<?=$reqJadwalPegawaiDetilId?>" />
                                              <input type="hidden" style="color:#000 !important" name="reqJadwalPegawaiTesId[]" value="<?=$reqJadwalTesId?>" />
                                              <input type="hidden" style="color:#000 !important" name="reqJadwalPegawaiPenggalianId[]" value="<?=$reqInfoPenggalianId?>" />
                                              <input type="hidden" id="reqJadwalPegawaiLevelDataId<?=$reqJadwalPegawaiIndikatorId?>-<?=$reqInfoPenggalianId?>" style="color:#000 !important" name="reqJadwalPegawaiLevelDataId[]" value="<?=$reqJadwalPegawaiLevelDataId?>" />
                                        ...
                                        <td style="vertical-align:top; background-color:transparent; color:#000 !important">
                                           <table style="width:100%; border:none">
                                            ...
                                            <tr>
                                              ...
                                              <td align="center"><input type="radio" class="easyui-validatebox" <?=$arrChecked[0]?> name="reqRadio<?=$index_detil?>-<?=$reqInfoPenggalianId?>" id="reqRadio<?=$index_detil?>-<?=$reqInfoPenggalianId?>" value="1" data-options="validType:'requireRadio[\'#ff-<?=$reqInfoPenggalianId?> input[name=reqRadio<?=$index_detil?>-<?=$reqInfoPenggalianId?>]\', \'Pilih nilai\']'"/></td>
                                              <td align="center"><input type="radio" class="easyui-validatebox" <?=$arrChecked[1]?> name="reqRadio<?=$index_detil?>-<?=$reqInfoPenggalianId?>" id="reqRadio<?=$index_detil?>-<?=$reqInfoPenggalianId?>" value="2" /></td>
                                              <td align="center"><input type="radio" class="easyui-validatebox" <?=$arrChecked[2]?> name="reqRadio<?=$index_detil?>-<?=$reqInfoPenggalianId?>" id="reqRadio<?=$index_detil?>-<?=$reqInfoPenggalianId?>" value="3" /></td>
                                              <td align="center"><input type="radio" class="easyui-validatebox" <?=$arrChecked[3]?> name="reqRadio<?=$index_detil?>-<?=$reqInfoPenggalianId?>" id="reqRadio<?=$index_detil?>-<?=$reqInfoPenggalianId?>" value="4" /></td>
                                              <td align="center"><input type="radio" class="easyui-validatebox" <?=$arrChecked[4]?> name="reqRadio<?=$index_detil?>-<?=$reqInfoPenggalianId?>" id="reqRadio<?=$index_detil?>-<?=$reqInfoPenggalianId?>" value="5" /></td>
                                  ...
                                  <tbody>
                                    ...
                                    else
                                    {
                                      ...
                                      for($index_detil=0; $index_detil < count($arrayKey); $index_detil++)
                                      {
                                        ...
                                        $reqPenilaianKompetensiCatatan= $arrPenilaian[$index_row]["CATATAN"];
                                        $reqPenilaianKompetensiBukti= $arrPenilaian[$index_row]["BUKTI"];
                                    ...
                                    ?>
                                        ...
                                        if($reqPenilaianKompetensiAtributIdParent == "0")
                                        {
                                          ...
                                          $tempcolspan= 10 + ($jumlah_pegawai_asesor);
                                        ?>
                                          <tr class="<?=$css?>">
                                            <th style="text-align:center"><b><?=romanicNumber($index_atribut_parent)?></b></th>
                                        ...
                                        ?>
                                          <tr class="<?=$css?>">
                                            ...
                                            <td align="center"><input type="radio" class="easyui-validatebox" <?=$arrChecked[0]?> name="reqPenilaianKompetensiRadio<?=$reqPenilaianKompetensiAspekId?>-<?=$index_detil?>" id="reqPenilaianKompetensiRadio<?=$reqPenilaianKompetensiAspekId?>-<?=$index_detil?>" value="1" data-options="validType:'requireRadio[\'#ff- input[name=reqPenilaianKompetensiRadio<?=$reqPenilaianKompetensiAspekId?>-<?=$index_detil?>]\', \'Pilih nilai\']'"/></td>
                                            <td align="center"><input type="radio" class="easyui-validatebox" <?=$arrChecked[1]?> name="reqPenilaianKompetensiRadio<?=$reqPenilaianKompetensiAspekId?>-<?=$index_detil?>" id="reqPenilaianKompetensiRadio<?=$reqPenilaianKompetensiAspekId?>-<?=$index_detil?>" value="2" /></td>
                                            <td align="center"><input type="radio" class="easyui-validatebox" <?=$arrChecked[2]?> name="reqPenilaianKompetensiRadio<?=$reqPenilaianKompetensiAspekId?>-<?=$index_detil?>" id="reqPenilaianKompetensiRadio<?=$reqPenilaianKompetensiAspekId?>-<?=$index_detil?>" value="3" /></td>
                                            <td align="center"><input type="radio" class="easyui-validatebox" <?=$arrChecked[3]?> name="reqPenilaianKompetensiRadio<?=$reqPenilaianKompetensiAspekId?>-<?=$index_detil?>" id="reqPenilaianKompetensiRadio<?=$reqPenilaianKompetensiAspekId?>-<?=$index_detil?>" value="4" /></td>
                                            <td align="center"><input type="radio" class="easyui-validatebox" <?=$arrChecked[4]?> name="reqPenilaianKompetensiRadio<?=$reqPenilaianKompetensiAspekId?>-<?=$index_detil?>" id="reqPenilaianKompetensiRadio<?=$reqPenilaianKompetensiAspekId?>-<?=$index_detil?>" value="5" /></td>
                                            ...
                                            <td><textarea name="reqPenilaianKompetensiBukti[]" id="reqPenilaianKompetensiBukti<?=$reqPenilaianKompetensiAspekId?>-<?=$index_detil?>" style="width:95%" rows="1" ><?=$reqPenilaianKompetensiBukti?></textarea></td>
                                            <td><textarea name="reqPenilaianKompetensiCatatan[]" id="reqPenilaianKompetensiCatatan<?=$reqPenilaianKompetensiAspekId?>-<?=$index_detil?>" style="width:95%" rows="1" ><?=$reqPenilaianKompetensiCatatan?></textarea></td>
                                          </tr>
                                        <?
                                        }
                                        ?>
