...
window.TileBuilders = {
	...
	ikk: function (uniqueId) {
        return {
            ...
            //label: "<div class='app-last-login-icon' ><img src='../WEB/images/app-master-data.jpg'></div>",
            iconSrc: '../WEB/images/app-ikk.png',
	...
	silat: function (uniqueId) {
        return {
            ...
            color: "bg-color-white",
            //label: "<div class='app-last-login-icon' ><img src='../WEB/images/app-master-data.jpg'></div>",
            iconSrc: '../WEB/images/app-silat.png',
            //appUrl: 'gaji/index.php'
	...
	polakarir: function (uniqueId) {
        return {
            ...
            color: "bg-color-white",
            //label: "<div class='app-last-login-icon' ><img src='../WEB/images/app-master-data.jpg'></div>",
            iconSrc: '../WEB/images/app-polakarir.png',
            //appUrl: 'gaji/index.php'
	...
	kinerja: function (uniqueId) {
        return {
            ...
            color: "bg-color-white",
            //label: "<div class='app-last-login-icon' ><img src='../WEB/images/app-master-data.jpg'></div>",
            iconSrc: '../WEB/images/app-kinerja.png',
            //appUrl: 'gaji/index.php'
	...
	tugasbelajar: function (uniqueId) {
        return {
            ...
            color: "bg-color-white",
            //label: "<div class='app-last-login-icon' ><img src='../WEB/images/app-master-data.jpg'></div>",
            iconSrc: '../WEB/images/app-tugasbelajar.png',
            //appUrl: 'gaji/index.php'
	...
	pengaturan: function (uniqueId) {
        return {
            ...
            color: "bg-color-white",
            //label: "<div class='app-last-login-icon' ><img src='../WEB/images/app-master-data.jpg'></div>",
            iconSrc: '../WEB/images/app-pengaturan.png',
            //appUrl: 'gaji/index.php'
	...
	skp: function (uniqueId) {
        return {
            ...
            color: "bg-color-white",
            //label: "<div class='app-last-login-icon' ><img src='../WEB/images/app-master-data.jpg'></div>",
            iconSrc: '../WEB/images/app-skp.png',
            //appUrl: 'gaji/index.php'
			appUrl: "javascript:top.document.location.href='../skp/index.php'"
        };
    },
