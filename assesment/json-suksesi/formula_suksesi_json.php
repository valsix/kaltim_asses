...
$aColumns= array('TAHUN', "FORMULA", "KETERANGAN", 'FORMULA_ID');
...
if ( isset( $_GET['iSortCol_0'] ) )
{
	...
	if ( trim($sOrder) == "ORDER BY TAHUN asc" )
	{
		/*
		...
		*/
		$sOrder = " ORDER BY TAHUN ASC, FORMULA";
...
$searchJson= " AND (UPPER(FORMULA) LIKE '%".strtoupper($_GET['sSearch'])."%') ";
