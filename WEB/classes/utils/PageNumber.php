...
class PageNumber
{
	...
	function drawPageFlexParse($reqId)
	{
		$shownav = 7; //berapa banyak navigasi halaman yg ditampilkan (kalo bisa jangan lebih kecil ato sama dgn jumpnav)
		$jumpnav = floor($shownav / 2); //banyak loncatan halaman
		...
		*/
		...
		{ 
			echo "
				<a href='".$this->fileName."&reqPage=1&reqFlag=".$this->anyflag."&reqId=".$reqId."'>First</a>
				&nbsp;<a href='".$this->fileName."&reqPage=".($this->page-1)."&reqFlag=".$this->anyflag."&reqId=".$reqId."'>&lt;</a>&nbsp;
			";
		} 
		else 
		{ 
		...
		*/
		...
		if($awal !== 1)
			echo "
							<a href='".$this->fileName."&reqPage=1&reqFlag=".$this->anyflag."&reqId=".$reqId."'>1...</a>
			";
		...
		for ($i = $awal; $i <= $showHal; $i++)
		{
			...
			if($this->page == $i)
				...
				echo"<a href='".$this->fileName."&reqPage=$i&reqFlag=".$this->anyflag."&reqId=".$reqId."'>$i</a>&nbsp;";
			echo "";
		}
				
		if ($i <= $this->numPage)
			echo "
							<a href='".$this->fileName."&reqPage=".$this->numPage."&reqFlag=".$this->anyflag."&reqId=".$reqId."'>...".$this->numPage."</a>
			";
		//------------------------------------------//
		...
		*/
		...
		{ 
			echo "
				&nbsp;<a href='".$this->fileName."&reqPage=".($this->page + 1)."&reqFlag=".$this->anyflag."&reqId=".$reqId."'>&gt;</a>&nbsp;
				<a href='".$this->fileName."&reqPage=".$this->numPage."&reqFlag=".$this->anyflag."&reqId=".$reqId."'>Last</a>
			";
		} 
		else 
		{ 
