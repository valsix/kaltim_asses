  ...
  class PelamarKegiatanSosial extends Entity{ 
    ...
    **/
	...
	function insert()
	{
		...
		$this->setField("PELAMAR_KEGIATAN_SOSIAL_ID", $this->getNextId("PELAMAR_KEGIATAN_SOSIAL_ID","PELAMAR_KEGIATAN_SOSIAL")); 
    ...
    **/ 
	...
	{
		$str = "SELECT PELAMAR_KEGIATAN_SOSIAL_ID, md5(CAST(PELAMAR_ID as TEXT)) PELAMAR_ID_ENKRIP, PELAMAR_ID, JABATAN, TAHUN, NAMA, TANGGAL
