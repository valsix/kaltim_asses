...
***************************************************************************************************** */
  ...
  /***
  * Entity-base class untuk mengimplementasikan tabel pds_rekrutmen.FAQ.
  * 
  ***/
  ...
  class Faq extends Entity{ 
    ...
    **/
	...
	function insert()
	{
		...
		$this->setField("FAQ_ID", $this->getNextId("FAQ_ID","pds_rekrutmen.FAQ"));

		$str = "
				INSERT INTO pds_rekrutmen.FAQ (
	...
	function delete()
	{
        $str = "DELETE FROM pds_rekrutmen.FAQ
                WHERE 
    ...
    **/ 
    function selectByParams($paramsArray=array(),$limit=-1,$from=-1, $statement="", $order="ORDER BY NO_URUT ASC")
	{
		$str = "
					...
					FROM pds_rekrutmen.FAQ A WHERE FAQ_ID IS NOT NULL
				"; 
    ...
    **/ 
	...
	{
		$str = "SELECT COUNT(FAQ_ID) AS ROWCOUNT FROM pds_rekrutmen.FAQ
