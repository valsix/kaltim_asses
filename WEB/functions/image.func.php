...
function createThumbnailFit($fileSource, $fileDestination, $thumbMaxSize = 80, $fitSizeMode = "FIT_WIDTH")
{
	// Get new sizes
	list($width, $height) = getimagesize($fileSource);
...
function createThumbnailFix($fileSource, $fileDestination, $newWidth = 50, $newHeight = 50)
{
	// Get new sizes
	list($width, $height) = getimagesize($fileSource);
