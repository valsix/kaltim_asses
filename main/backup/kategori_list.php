...
$allRecord = $lowongan->getCountByParams(array("A.STATUS" => 1, "A.CABANG_P3_ID" => $reqId, "STATUS_SELESAI"=>0));
$pageNumber->initialize($allRecord, $showRecord, $reqPage, $pageView);
$lowongan->selectByParams(array("A.STATUS" => 1, "A.CABANG_P3_ID" => $reqId, "STATUS_SELESAI"=>0), $pageNumber->limit, $pageNumber->from, "ORDER BY TANGGAL DESC");
    ...
    <div style="clear:both; padding-bottom:20px">
        <div class="pagesLL">
          <div class="pagesLL-margin">
            <?=$pageNumber->drawPageFlexParse($reqId)?>
          </div>
        </div>
    </div> 
