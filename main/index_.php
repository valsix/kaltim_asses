...
?>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="background-color:transparent; border-bottom:none !important;">
        <div class="container-fluid" style="padding-left:0px; padding-right:0px; background:#2c1b6d;">
        
        	<div class="row area-atas" >
            
            	<div class="container atas">
                    <div class="col-md-6 career-nama">
						<div style="height: 110px; background: #fff; display: flex; justify-content: center; align-items: center; ">
							<img src="../../WEB/images/logo-eoffice.png">
						</div>
                        <!--
            ...
            <div class="container atas">
            	<div class="navbar-header" style="">
                    ...
                    <a class="navbar-brand" href="index.php">BPSDM KEMENDAGRI</a>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="http://bpsdm.kemendagri.go.id/" target="_blank">Website Utama</a></li>
    	...
    	<div class="row">
        	<div class="col-lg-12" style="padding-left:0px; padding-right:0px;">
            	<div class="full-width-div">
                    <ul class="rslides" id="slider1" style="width:100% height:20% !important;">
                    	<?
						for($index_loop=0; $index_loop < $jumlah_image; $index_loop++)
						{	
							$tempKeterangan= $arrImage[$index_loop]["KETERANGAN"];
							$tempPath= $arrImage[$index_loop]["PATH"];

							if($tempPath == "")
								continue;
							$tempPath= $urldashboard.$tempPath;
						?>
                        <li><img src="<?=$tempPath?>" alt=""></li>
                        <?
						}
                        ?>
                    </ul>                    
            ...
            <div class="col-md-4 sisi-kanan" style="background:#FFF;">
                ...
                <div>
                    ...
                    <div class="login-area">
                        ...
                        <div class="form">
                            <input type="text" name="reqUser" id="reqUser" class="easyui-validatebox" required placeholder="Nip Anda"/>
					...
					<div class="login-area-inner">
                    	<div class="data-login">
                        	<table style="width: 100%">
                                ...
                                <tr>
                                	<td><i class="fa fa-arrow-circle-right"></i>NIP</td>
                                    <td>:</td>
        	...
        	<div class="container">
            	<div class="row">
                    <div class="col-lg-8 text-left">
                        <span class="logo-footer"><img src="../WEB/images/logo-aps-rekrutmen.png"></span><p>Copyright &copy; 2019. BPSDM Kementerian Dalam Negeri Republik Indonesia<br>All Right Reserved.</p>
                    </div>
