...
$statement= " AND TO_DATE(TO_CHAR(A.TANGGAL_TES, 'YYYY-MM-DD'),'YYYY/MM/DD') < CURRENT_DATE";
$pelamar_lowongan->selectByParamsDaftarLowongan($tempUserPelamarId, array(), -1, -1, $statement, "ORDER BY A.TANGGAL_TES DESC");
