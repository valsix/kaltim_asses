		...
		?>
            ...
            <div class="col-md-4 sisi-kanan" style="background:#FFF;">
				...
				<div class="glossymenu">
                    ...
                    <a class="menuitem submenuheader" href="#" style="background: seagreen;"><?=$arrayJudul["index"]["isianformulir"]?></a>
					<div class="submenu">
						<ul>
                        <?
                        ...
                        {
                        	$imgdrh = "icon-belum";
                        	// echo $atasan."-".$riwayatpendidikan."-".$riwayatjabatan."-".$bidangpek."-".$datapek."-".$kondisikerja."-".$minharap."-".$kekuatan;
                        }
					...
					<a class="menuitem submenuheader" href="#" style="background: seagreen;"><?=$arrayJudul["index"]["formulir"]?></a>
					<?
					$sudah = new Formulir();
