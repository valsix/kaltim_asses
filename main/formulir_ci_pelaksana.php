...
$set= new FormulirCritical();
$statement= "AND A.FORMULIR_SOAL_CRITICAL_HEADER_ID > 2 AND A.PEGAWAI_ID = ".$tempUserPelamarId." ";
...
$statement= " AND B.PEGAWAI_ID = ".$reqPegawaiId." AND A.FORMULIR_SOAL_CRITICAL_HEADER_ID = 3 ";
$set= new FormulirCritical();
...
$statement= " AND A.FORMULIR_SOAL_CRITICAL_HEADER_ID = 4 ";
$set= new FormulirCritical();
$set->selectByParamsJawabanCriticalSoal(array(), -1,-1, $statement, $sOrder);
     // echo $set->query;exit;
while($set->nextRow())
...
$statement= " AND B.PEGAWAI_ID = ".$reqPegawaiId." AND A.FORMULIR_SOAL_CRITICAL_HEADER_ID = 4 ";
$set= new FormulirCritical();
$set->selectByParamsJawabanCritical(array(), -1,-1, $statement, $sOrder);
     // echo $set->query;exit;
while($set->nextRow())
...
$(function(){
	$('#ff').form({
		url:'../json/formulir_ci_pelaksana.php',
		onSubmit:function(){
...
<div class="col-lg-8">
    <div id="judul-halaman"><?=$arrayJudul["index"]["formulir_ci_pelaksana"]?></div>
    ...
    <div id="pendaftaran">
        ...
        <div class="judul-halaman2"><img src="../WEB/images/icon-input.png" width="28px">  Pertanyaan</div>
         <table style="width: 100%">
            ...
            ?>
            <td style="vertical-align: middle !important;"><label>Pada form ini Anda diminta untuk <u>menceritakan</u> kejadian yang pernah anda alami dalam kurun waktu 2 tahun terakhir.</label> </td>
             <tr>
