    ...
    <div id="pendaftaran">
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="reqJabatan" id="reqJabatan" <?=$read?> value="<?=$dataApi['jabatan']?>" style="width:50%" class="form-control easyui-validatebox" readonly />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td> -->
                    ...
                    <div style="margin-top: 30px">
                        <label style="margin-left: 10px;">2.  Pendidikan Informal ( Kursus atau Training ) </label><br>
...
<script type="text/javascript">
    function add_pendidikan(array) {
        ...
        totaljabatan=<?=$totalpekerjaan?>;
        console.log(totaljabatan);
         function add_jabatan(array) {
            if(totaljabatan>=5){
                $.messager.alert('Info', 'Max Riwayat Jabatan Hanya 5', 'info');
            }
            else{
                ...
                totaljabatan=totaljabatan+1;
            }
        }
        // function add_saudara(array) {
        //     // console.log("masuk");
        //     test = "<tr><td><input $disabled class='easyui-validatebox textbox form-control' type='text' name='reqKeluargaSaudara[]' id='reqKeluargaSaudara' value='' data-options='' style='width:100%' ></td><td><select style='width:100%' name='reqKeluargaSaudaraStatus[]' id='reqKeluargaSaudaraStatus'><option value='ayah'>Ayah</option><option value='ibu'>Ibu</option><option value='anak'>Anak</option><option value='suami'>suami</option><option value='istri'>Istri</option></select></select></td></select></td></td></select></td><td><select style='width:100%' name='reqKeluargaSaudaraJenisKelamin[]' id='reqKeluargaSaudaraJenisKelamin'><option value='L'>L</option><option value='P'>P</option></select></td><td><input $disabled  type='text' name='reqKeluargaTempat[]' id='reqKeluargaTempat' style='width:45%' value='' data-options=''><input style='width:45%' type='date' name='reqKeluargaTgllahir[]' id='reqKeluargaTgllahir' value='' data-options=''> </td><td><input class='easyui-validatebox textbox form-control' type='text' name='reqKeluargaPendidikan[]' id='reqKeluargaPendidikan' value='' data-options='' style='width:100%'  ></td><td><input class='easyui-validatebox textbox form-control' type='text' name='reqKeluargaPekerjaan[]' id='reqKeluargaPekerjaan' value='' data-options='' style='width:100%'  ></td><td><button class='btn btn-outline-secondary border--Green' type='button' id='license-category-search' onclick='Hapussparepart(this)' style='background-color: red; color: white;'><i class='fa fa-trash fa-lg' ></i></button></td></tr>";
